...
struct A_WaterMeshBlueprintMaster_C : AActor {
	...
	void Construction(); // Function _WaterMeshBlueprintMaster._WaterMeshBlueprintMaster_C.Construction // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void Find Placement on water mesh surfaces(struct FTransform& Traced Transform, struct FVector& VelocityVector, bool& Trace Hit); // Function _WaterMeshBlueprintMaster._WaterMeshBlueprintMaster_C.Find Placement on water mesh surfaces // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void SetupMeshCollisionVolumes(struct UStaticMeshComponent* StaticMeshComponent, int32_t Target Int); // Function _WaterMeshBlueprintMaster._WaterMeshBlueprintMaster_C.SetupMeshCollisionVolumes // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void UserConstructionScript(); // Function _WaterMeshBlueprintMaster._WaterMeshBlueprintMaster_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void BndEvt__CollisionMesh3_K2Node_ComponentBoundEvent_190_ComponentBeginOverlapSignature__DelegateSignature(struct UPrimitiveComponent* OverlappedComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult); // Function _WaterMeshBlueprintMaster._WaterMeshBlueprintMaster_C.BndEvt__CollisionMesh3_K2Node_ComponentBoundEvent_190_ComponentBeginOverlapSignature__DelegateSignature // (HasOutParms|BlueprintEvent) // @ game+0xda05cc
	...
	void Construct(); // Function _WaterMeshBlueprintMaster._WaterMeshBlueprintMaster_C.Construct // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ReceiveBeginPlay(); // Function _WaterMeshBlueprintMaster._WaterMeshBlueprintMaster_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph__WaterMeshBlueprintMaster(int32_t EntryPoint); // Function _WaterMeshBlueprintMaster._WaterMeshBlueprintMaster_C.ExecuteUbergraph__WaterMeshBlueprintMaster // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
