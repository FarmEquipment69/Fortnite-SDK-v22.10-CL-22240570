...
struct UCosmeticLoadoutScreen_C : UFortCosmeticLoadoutScreen {
	...
	void BP_OnActivated(); // Function CosmeticLoadoutScreen.CosmeticLoadoutScreen_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnPreviewTile(enum class EFortLoadoutCardType CardType); // Function CosmeticLoadoutScreen.CosmeticLoadoutScreen_C.OnPreviewTile // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnFlavorForScreenMode(enum class EFortCosmeticLoadoutScreenMode NewMode); // Function CosmeticLoadoutScreen.CosmeticLoadoutScreen_C.OnFlavorForScreenMode // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_CosmeticLoadoutScreen(int32_t EntryPoint); // Function CosmeticLoadoutScreen.CosmeticLoadoutScreen_C.ExecuteUbergraph_CosmeticLoadoutScreen // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
