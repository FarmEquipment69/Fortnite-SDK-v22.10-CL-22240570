...
struct UGCN_CollisionEffects_Water_C : UGCN_CollisionEffects_Parent_C {
	...
	void OnBurst(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UParticleSystemComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents, struct UMatineeCameraShake* BurstCameraShakeInstance, struct ADecalActor* BurstDecalInstance); // Function GCN_CollisionEffects_Water.GCN_CollisionEffects_Water_C.OnBurst // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const) // @ game+0xda05cc
	void GetObjectSizeParam(struct AActor* PhysicsObject, int32_t& Size); // Function GCN_CollisionEffects_Water.GCN_CollisionEffects_Water_C.GetObjectSizeParam // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0xda05cc
};
