...
struct USidebarUserSearchResultListEntry_XS_C : UFortUserSearchResultListEntry {
	...
	void BP_OnUnhovered(); // Function SidebarUserSearchResultListEntry_XS.SidebarUserSearchResultListEntry_XS_C.BP_OnUnhovered // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	...
	void BP_OnHovered(); // Function SidebarUserSearchResultListEntry_XS.SidebarUserSearchResultListEntry_XS_C.BP_OnHovered // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_SidebarUserSearchResultListEntry_XS(int32_t EntryPoint); // Function SidebarUserSearchResultListEntry_XS.SidebarUserSearchResultListEntry_XS_C.ExecuteUbergraph_SidebarUserSearchResultListEntry_XS // (Final|UbergraphFunction) // @ game+0xda05cc
};
