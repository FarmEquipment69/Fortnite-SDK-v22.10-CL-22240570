...
struct UGCN_Irwin_ExitWater_C : UFortGameplayCueNotify_Burst {
	...
	void OnBurstGeneric(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UFXSystemComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents, struct UMatineeCameraShake* BurstCameraShakeInstance, struct ADecalActor* BurstDecalInstance); // Function GCN_Irwin_ExitWater.GCN_Irwin_ExitWater_C.OnBurstGeneric // (Event|Public|HasOutParms|BlueprintEvent|Const) // @ game+0xda05cc
	void ExecuteUbergraph_GCN_Irwin_ExitWater(int32_t EntryPoint); // Function GCN_Irwin_ExitWater.GCN_Irwin_ExitWater_C.ExecuteUbergraph_GCN_Irwin_ExitWater // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
