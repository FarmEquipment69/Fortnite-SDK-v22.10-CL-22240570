...
struct UIKRigComponent : UActorComponent {
	...
	void SetIKRigGoalTransform(struct FName GoalName, struct FTransform Transform, float PositionAlpha, float RotationAlpha); // Function IKRig.IKRigComponent.SetIKRigGoalTransform // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x6f5bf10
	void SetIKRigGoalPositionAndRotation(struct FName GoalName, struct FVector Position, struct FQuat Rotation, float PositionAlpha, float RotationAlpha); // Function IKRig.IKRigComponent.SetIKRigGoalPositionAndRotation // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x6f5bd68
	void SetIKRigGoal(struct FIKRigGoal& Goal); // Function IKRig.IKRigComponent.SetIKRigGoal // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x6f5bccc
	void ClearAllGoals(); // Function IKRig.IKRigComponent.ClearAllGoals // (Final|Native|Public|BlueprintCallable) // @ game+0x6f5bc9c
};
...
struct UIKGoalCreatorInterface : UInterface {
	...
	void AddIKGoals(struct TMap<struct FName, struct FIKRigGoal>& OutGoals); // Function IKRig.IKGoalCreatorInterface.AddIKGoals // (Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x6f5bb80
};
