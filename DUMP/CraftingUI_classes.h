...
struct UAthenaCraftingQuickBarButton : UAthenaQuickBarSlotButtonBase {
	...
	void OnIsCraftableItemChanged(bool bIsCraftableItem); // Function CraftingUI.AthenaCraftingQuickBarButton.OnIsCraftableItemChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnCanCraftNowChanged(bool bCanCraftNow); // Function CraftingUI.AthenaCraftingQuickBarButton.OnCanCraftNowChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UAthenaEquippedItemCraftingIndicator : UCommonUserWidget {
	...
	void OnIsCraftableItemChanged(bool bIsCraftableItem); // Function CraftingUI.AthenaEquippedItemCraftingIndicator.OnIsCraftableItemChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnCanCraftNowChanged(bool bCanCraftNow); // Function CraftingUI.AthenaEquippedItemCraftingIndicator.OnCanCraftNowChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void HandleWeaponEquipped(struct AFortWeapon* NewWeapon, struct AFortWeapon* PrevWeapon); // Function CraftingUI.AthenaEquippedItemCraftingIndicator.HandleWeaponEquipped // (Final|Native|Private) // @ game+0x67cc22c
};
...
struct UAthenaInventoryItemInfoCraftingIndicator : UCommonUserWidget {
	...
	void OnIsCraftableItemChanged(bool bIsCraftableItem); // Function CraftingUI.AthenaInventoryItemInfoCraftingIndicator.OnIsCraftableItemChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnCanCraftNowChanged(bool bCanCraftNow); // Function CraftingUI.AthenaInventoryItemInfoCraftingIndicator.OnCanCraftNowChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void HandleInventoryItemSelected(struct UFortItem* SelectedItem); // Function CraftingUI.AthenaInventoryItemInfoCraftingIndicator.HandleInventoryItemSelected // (Final|Native|Private) // @ game+0x67cc12c
};
...
struct UAthenaQuickBarSlotCraftingIndicator : UAthenaQuickBarSlotExtensionWidgetBase {
	...
	void OnIsCraftableItemChanged(bool bIsCraftableItem); // Function CraftingUI.AthenaQuickBarSlotCraftingIndicator.OnIsCraftableItemChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnIngredientChanged(bool bCanCraftNow); // Function CraftingUI.AthenaQuickBarSlotCraftingIndicator.OnIngredientChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnCanCraftNowChanged(bool bCanCraftNow); // Function CraftingUI.AthenaQuickBarSlotCraftingIndicator.OnCanCraftNowChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void HandleWeaponEquipped(struct AFortWeapon* NewWeapon, struct AFortWeapon* PrevWeapon); // Function CraftingUI.AthenaQuickBarSlotCraftingIndicator.HandleWeaponEquipped // (Final|Native|Private) // @ game+0x67cc2f0
};
...
struct UFortCraftingIngredientWidget : UCommonUserWidget {
	...
	void OnIngredientWidgetUpdated(int32_t NumAvailable, int32_t NumRequired, bool bIsPrimaryIngredient, bool bIsLastIngredient); // Function CraftingUI.FortCraftingIngredientWidget.OnIngredientWidgetUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortCraftingItemInfoWidget : UCommonActivatableWidget {
	...
	void OnItemRaritySet(enum class EFortRarity Rarity, struct FFortRarityItemData RarityItemData); // Function CraftingUI.FortCraftingItemInfoWidget.OnItemRaritySet // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortCraftingListEntry : UCommonButtonLegacy {
	...
	struct UAthenaItemIcon* ItemIcon; // 0x1078(0x08)
	bool bCanCraftItem; // 0x1080(0x01)
	char pad_1081[0xf]; // 0x1081(0x0f)

	void OnCraftingListItemSet(); // Function CraftingUI.FortCraftingListEntry.OnCraftingListItemSet // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortCraftingTab : UCommonActivatableWidget {
	...
	void OnFormulaListUpdated(int32_t NumFormulas); // Function CraftingUI.FortCraftingTab.OnFormulaListUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void HandleInventoryItemSelected(struct UFortItem* Item); // Function CraftingUI.FortCraftingTab.HandleInventoryItemSelected // (Final|Native|Private) // @ game+0x67cc1ac
};
...
struct UFortPotContentsPopup : UUserWidget {
	...
	void SetOwningCraftingObject(struct ACraftingObjectBGA* InCraftingObject); // Function CraftingUI.FortPotContentsPopup.SetOwningCraftingObject // (Final|Native|Public|BlueprintCallable) // @ game+0x67cc3ac
};
...
struct UFortPotContentsTile : UCommonButtonLegacy {
	char pad_1070[0x8]; // 0x1070(0x08)
	struct UCommonLazyImage* Image_Item; // 0x1078(0x08)
};
