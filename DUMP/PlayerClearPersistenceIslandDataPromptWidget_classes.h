...
struct UPlayerClearPersistenceIslandDataPromptWidget_C : UFortActivatablePanel {
	...
	void SetDescription(struct FText InDescription); // Function PlayerClearPersistenceIslandDataPromptWidget.PlayerClearPersistenceIslandDataPromptWidget_C.SetDescription // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void BndEvt__ApplyButton_K2Node_ComponentBoundEvent_59_CommonButtonClicked__DelegateSignature(struct UCommonButtonLegacy* Button); // Function PlayerClearPersistenceIslandDataPromptWidget.PlayerClearPersistenceIslandDataPromptWidget_C.BndEvt__ApplyButton_K2Node_ComponentBoundEvent_59_CommonButtonClicked__DelegateSignature // (BlueprintEvent) // @ game+0xda05cc
	void BndEvt__CancelButton_K2Node_ComponentBoundEvent_76_CommonButtonClicked__DelegateSignature(struct UCommonButtonLegacy* Button); // Function PlayerClearPersistenceIslandDataPromptWidget.PlayerClearPersistenceIslandDataPromptWidget_C.BndEvt__CancelButton_K2Node_ComponentBoundEvent_76_CommonButtonClicked__DelegateSignature // (BlueprintEvent) // @ game+0xda05cc
	...
	void ExecuteUbergraph_PlayerClearPersistenceIslandDataPromptWidget(int32_t EntryPoint); // Function PlayerClearPersistenceIslandDataPromptWidget.PlayerClearPersistenceIslandDataPromptWidget_C.ExecuteUbergraph_PlayerClearPersistenceIslandDataPromptWidget // (Final|UbergraphFunction) // @ game+0xda05cc
};
