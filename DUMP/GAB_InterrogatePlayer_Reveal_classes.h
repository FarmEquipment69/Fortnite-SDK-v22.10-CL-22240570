...
struct UGAB_InterrogatePlayer_Reveal_C : UFortGameplayAbility {
	...
	struct TArray<struct AFortPlayerStateAthena*> GetTeamMembers(struct APawn* Target, bool bIncludeSelf); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.GetTeamMembers // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void GAB_InterrogatePlayer_Reveal_AutoGenFunc(struct AActor* IndicatedActor); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.GAB_InterrogatePlayer_Reveal_AutoGenFunc // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ToggleReticleVisibility(bool Hide); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.ToggleReticleVisibility // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Reveal(); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.Reveal // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void EndAbilityCleanup(); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.EndAbilityCleanup // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void InitAbility(); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.InitAbility // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Completed_23F3C2DB411862D627ACFCA8233F7B33(struct FGameplayAbilityTargetDataHandle& TargetData, struct FGameplayTag ApplicationTag); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.Completed_23F3C2DB411862D627ACFCA8233F7B33 // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Cancelled_23F3C2DB411862D627ACFCA8233F7B33(struct FGameplayAbilityTargetDataHandle& TargetData, struct FGameplayTag ApplicationTag); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.Cancelled_23F3C2DB411862D627ACFCA8233F7B33 // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Triggered_23F3C2DB411862D627ACFCA8233F7B33(struct FGameplayAbilityTargetDataHandle& TargetData, struct FGameplayTag ApplicationTag); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.Triggered_23F3C2DB411862D627ACFCA8233F7B33 // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Completed_3C2C8C224B62B00BDEEAF5AF38A401C1(struct FGameplayAbilityTargetDataHandle& TargetData, struct FGameplayTag ApplicationTag); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.Completed_3C2C8C224B62B00BDEEAF5AF38A401C1 // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Cancelled_3C2C8C224B62B00BDEEAF5AF38A401C1(struct FGameplayAbilityTargetDataHandle& TargetData, struct FGameplayTag ApplicationTag); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.Cancelled_3C2C8C224B62B00BDEEAF5AF38A401C1 // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void OnFinish_68B3C6D14B44CCD3170ABDA038C1203E(); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.OnFinish_68B3C6D14B44CCD3170ABDA038C1203E // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void K2_OnEndAbility(bool bWasCancelled); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.K2_OnEndAbility // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	...
	void EndInterrogation(); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.EndInterrogation // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void K2_ActivateAbilityFromEvent(struct FGameplayEventData& EventData); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.K2_ActivateAbilityFromEvent // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_GAB_InterrogatePlayer_Reveal(int32_t EntryPoint); // Function GAB_InterrogatePlayer_Reveal.GAB_InterrogatePlayer_Reveal_C.ExecuteUbergraph_GAB_InterrogatePlayer_Reveal // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
