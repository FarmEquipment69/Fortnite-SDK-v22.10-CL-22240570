...
struct UFortAIFaunaAnimInstance : UFortAIAnimInstance {
	...
	void UpdateTurnAngleStored(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateTurnAngleStored // (Native|Event|Public|BlueprintEvent) // @ game+0x65b0580
	void UpdateSwimmingYaw(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateSwimmingYaw // (Native|Event|Public|BlueprintEvent) // @ game+0x65b0568
	void UpdateRidingMovePlayRate(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateRidingMovePlayRate // (Native|Event|Public|BlueprintEvent) // @ game+0x65b0494
	void UpdatePlayLandAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdatePlayLandAdditive // (Native|Event|Public|BlueprintEvent) // @ game+0x65b047c
	void UpdateFootPhaseStop(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateFootPhaseStop // (Native|Event|Public|BlueprintEvent) // @ game+0x60eb624
	void UpdateBoostPlayRate(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateBoostPlayRate // (Native|Event|Public|BlueprintEvent) // @ game+0x65b02dc
	void UpdateBodyRoll(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateBodyRoll // (Native|Event|Public|BlueprintEvent) // @ game+0x65b02c4
	void UpdateBackwardVelocity(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateBackwardVelocity // (Native|Event|Public|BlueprintEvent) // @ game+0x65b0268
	void UpdateBackwardsPlayRate(); // Function IrwinRuntime.FortAIFaunaAnimInstance.UpdateBackwardsPlayRate // (Native|Event|Public|BlueprintEvent) // @ game+0x65b0280
	void FinishFootPhaseStopUpdate(); // Function IrwinRuntime.FortAIFaunaAnimInstance.FinishFootPhaseStopUpdate // (Native|Event|Public|BlueprintEvent) // @ game+0x65b0250
	void CalculateLookAtAlpha(bool bForceDisableLookAt, float DeltaSeconds); // Function IrwinRuntime.FortAIFaunaAnimInstance.CalculateLookAtAlpha // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0054
};
...
struct UFortAIFaunaAnimInstance_Grandma : UFortAIFaunaAnimInstance {
	...
	void UpdateStateVariables(bool bAccelerating); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateStateVariables // (Final|Native|Public|BlueprintCallable) // @ game+0x65b04d4
	void UpdateShouldPlayFullBodyInPlace(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateShouldPlayFullBodyInPlace // (Final|Native|Public|BlueprintCallable) // @ game+0x65b04ac
	void UpdateMovingRates(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateMovingRates // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0454
	void UpdateMeshScale(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateMeshScale // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0430
	void UpdateLocomotionPoseAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateLocomotionPoseAlpha // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0404
	void UpdateIdleStartTurn(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateIdleStartTurn // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0360
	void UpdateEnableSniffAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateEnableSniffAdditive // (Final|Native|Public|BlueprintCallable) // @ game+0x65b033c
	void UpdateEnableAlertAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateEnableAlertAdditive // (Final|Native|Public|BlueprintCallable) // @ game+0x65b02f4
	void UpdateBlinkAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.UpdateBlinkAlpha // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0298
	bool DetermineShouldPlayFullBodyInPlace(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineShouldPlayFullBodyInPlace // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b022c
	bool DetermineIdleStartTurn(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineIdleStartTurn // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b01c0
	bool DetermineEnableSniffAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineEnableSniffAdditive // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b01a0
	bool DetermineEnableAlertAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.DetermineEnableAlertAdditive // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b0160
	float CalculateWalkRunPlayRate(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateWalkRunPlayRate // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b013c
	float CalculateMeshScale(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateMeshScale // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b011c
	float CalculateLocomotionPoseAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateLocomotionPoseAlpha // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b002c
	float CalculateBlinkAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Grandma.CalculateBlinkAlpha // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65affdc
};
...
struct UFortAIFaunaAnimInstance_Robert : UFortAIFaunaAnimInstance {
	...
	void UpdateStateVariables(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateStateVariables // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0554
	void UpdateLocomotionPoseAdditiveAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateLocomotionPoseAdditiveAlpha // (Final|Native|Public|BlueprintCallable) // @ game+0x65b03d8
	void UpdateIsFullBodyInPlace(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateIsFullBodyInPlace // (Final|Native|Public|BlueprintCallable) // @ game+0x65b03b0
	void UpdateIdleStartTurn(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateIdleStartTurn // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0388
	void UpdateEnableHeadTiltDownAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.UpdateEnableHeadTiltDownAdditive // (Final|Native|Public|BlueprintCallable) // @ game+0x65b0318
	bool DetermineIsFullBodyInPlace(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.DetermineIsFullBodyInPlace // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b0208
	bool DetermineIdleStartTurn(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.DetermineIdleStartTurn // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b01e4
	bool DetermineEnableHeadTiltDownAdditive(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.DetermineEnableHeadTiltDownAdditive // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b0180
	float CalculateLocomotionPoseAdditiveAlpha(); // Function IrwinRuntime.FortAIFaunaAnimInstance_Robert.CalculateLocomotionPoseAdditiveAlpha // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65b0004
};
