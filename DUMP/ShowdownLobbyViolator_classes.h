...
struct UShowdownLobbyViolator_C : UFortShowdownDetailView {
	...
	void RefreshDataBP(); // Function ShowdownLobbyViolator.ShowdownLobbyViolator_C.RefreshDataBP // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_ShowdownLobbyViolator(int32_t EntryPoint); // Function ShowdownLobbyViolator.ShowdownLobbyViolator_C.ExecuteUbergraph_ShowdownLobbyViolator // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
