...
struct USidebarPanelExit_C : UFortSidebarPanelExit {
	...
	void DialogResult_72E03FD949433FCC7FD537BE143F3FA1(enum class EFortDialogResult Result, struct FName ResultName); // Function SidebarPanelExit.SidebarPanelExit_C.DialogResult_72E03FD949433FCC7FD537BE143F3FA1 // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void DialogResult_D6C37C7D45574B8D0C2F22B5DE53C01B(enum class EFortDialogResult Result, struct FName ResultName); // Function SidebarPanelExit.SidebarPanelExit_C.DialogResult_D6C37C7D45574B8D0C2F22B5DE53C01B // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void UpdateNoEnabledButtonsText(bool bAllowLogout, bool bAllowQuit); // Function SidebarPanelExit.SidebarPanelExit_C.UpdateNoEnabledButtonsText // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_SidebarPanelExit(int32_t EntryPoint); // Function SidebarPanelExit.SidebarPanelExit_C.ExecuteUbergraph_SidebarPanelExit // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
