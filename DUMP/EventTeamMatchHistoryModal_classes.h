...
struct UEventTeamMatchHistoryModal_C : UFortEventTeamMatchHistoryModal {
	...
	void Set Up Match History Style(struct FFortTournamentDisplayInfo Tournament Display Info); // Function EventTeamMatchHistoryModal.EventTeamMatchHistoryModal_C.Set Up Match History Style // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void BP_OnActivated(); // Function EventTeamMatchHistoryModal.EventTeamMatchHistoryModal_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnSetupMatchHistory(struct FString TournamentId, struct FString EventWindowId); // Function EventTeamMatchHistoryModal.EventTeamMatchHistoryModal_C.OnSetupMatchHistory // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_EventTeamMatchHistoryModal(int32_t EntryPoint); // Function EventTeamMatchHistoryModal.EventTeamMatchHistoryModal_C.ExecuteUbergraph_EventTeamMatchHistoryModal // (Final|UbergraphFunction) // @ game+0xda05cc
};
