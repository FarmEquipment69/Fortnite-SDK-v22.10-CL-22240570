...
struct USplashScreenWidget_C : UFortSplashScreenWidget {
	...
	void BP_OnActivated(); // Function SplashScreenWidget.SplashScreenWidget_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnInputMethodChanged(enum class ECommonInputType InputType); // Function SplashScreenWidget.SplashScreenWidget_C.OnInputMethodChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_SplashScreenWidget(int32_t EntryPoint); // Function SplashScreenWidget.SplashScreenWidget_C.ExecuteUbergraph_SplashScreenWidget // (Final|UbergraphFunction) // @ game+0xda05cc
};
