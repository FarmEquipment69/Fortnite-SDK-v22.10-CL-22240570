...
struct UButterCakeUnstuckComponent : UActorComponent {
	...
	void ResetUnstuckLocationSamples(); // Function ButterCakeRuntime.ButterCakeUnstuckComponent.ResetUnstuckLocationSamples // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x65bbc0c
	void HandleAthenaGamePhaseChanged(enum class EAthenaGamePhase GamePhase); // Function ButterCakeRuntime.ButterCakeUnstuckComponent.HandleAthenaGamePhaseChanged // (Final|Native|Private) // @ game+0x65bb920
};
...
struct UFortAIAnimInstance_ButterCake : UFortAIAnimInstance {
	...
	void SetFootPhaseMembers(); // Function ButterCakeRuntime.FortAIAnimInstance_ButterCake.SetFootPhaseMembers // (Final|Native|Public|BlueprintCallable) // @ game+0x65bbc20
	float ComputeLeanAngleByVelocity(); // Function ButterCakeRuntime.FortAIAnimInstance_ButterCake.ComputeLeanAngleByVelocity // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65bb7b8
	enum class EFortButterCakeFootPhase ComputeFootPhase(); // Function ButterCakeRuntime.FortAIAnimInstance_ButterCake.ComputeFootPhase // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x65bb794
};
...
struct UFortButterCakeComponent_Telemetry : UFortAIComponent_Telemetry {
	...
	void OnLured(); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnLured // (Final|Native|Public|BlueprintCallable) // @ game+0x65bbbf8
	void OnItemsSneezed(int32_t ItemsCount); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnItemsSneezed // (Final|Native|Public|BlueprintCallable) // @ game+0x65bbb74
	void OnItemsEaten(int32_t ItemsCount); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnItemsEaten // (Final|Native|Public|BlueprintCallable) // @ game+0x65bbaf8
	void OnEnterBerserk(struct AController* Instigator); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnEnterBerserk // (Final|Native|Public|BlueprintCallable) // @ game+0x65bba18
	void OnBlowHoleUsed(); // Function ButterCakeRuntime.FortButterCakeComponent_Telemetry.OnBlowHoleUsed // (Final|Native|Public|BlueprintCallable) // @ game+0x65bba04
};

// Class ButterCakeRuntime.FortButterCakeControlRig
// Size: 0x608 (Inherited: 0x540)
struct UFortButterCakeControlRig : UControlRig {
	struct FName PBIKRootBoneName; // 0x540(0x04)
	char pad_544[0x4]; // 0x544(0x04)
	struct FRigElementKeyCollection FootCurveCollection; // 0x548(0x10)
	struct FRigElementKeyCollection FootEffectorBoneCollection; // 0x558(0x10)
	struct FRigElementKeyCollection FootEffectorControlCollection; // 0x568(0x10)
	struct FRigElementKeyCollection FootExcludedBoneCollection; // 0x578(0x10)
	struct FRigElementKeyCollection ChinEffectorBoneCollection; // 0x588(0x10)
	struct FRigElementKeyCollection ChinExcludedBoneCollection; // 0x598(0x10)
	struct FRigElementKeyCollection TailEffectorBoneCollection; // 0x5a8(0x10)
	struct FRigElementKey TailBaseBoneKey; // 0x5b8(0x08)
	struct FRigElementKey TailTipBoneKey; // 0x5c0(0x08)
	struct FRigElementKey UpperLipBoneKey; // 0x5c8(0x08)
	struct FRigElementKeyCollection GroundHitBoneCollection; // 0x5d0(0x10)
	struct TArray<struct FVector> GroundHitLocationList; // 0x5e0(0x10)
	struct TArray<struct FVector> GroundHitNormalList; // 0x5f0(0x10)
	int32_t Counter; // 0x600(0x04)
	char pad_604[0x4]; // 0x604(0x04)

	struct FVector GetGroundHitNormalAt(int32_t Index); // Function ButterCakeRuntime.FortButterCakeControlRig.GetGroundHitNormalAt // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x65bb880
	struct FVector GetGroundHitLocationAt(int32_t Index); // Function ButterCakeRuntime.FortButterCakeControlRig.GetGroundHitLocationAt // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x65bb7e0
};
