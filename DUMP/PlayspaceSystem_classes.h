...
struct AGameplayVolume : AActor {
	...
	void UpdateSize(struct FVector& NewScale); // Function PlayspaceSystem.GameplayVolume.UpdateSize // (Final|Native|Public|HasOutParms|HasDefaults) // @ game+0x63e7458
	void InitializeBoundsComponent(struct UOverlapComponent* NewBoundsComponent); // Function PlayspaceSystem.GameplayVolume.InitializeBoundsComponent // (Final|Native|Private|BlueprintCallable) // @ game+0x63e6e28
	struct APlayspace* GetPlayspace(); // Function PlayspaceSystem.GameplayVolume.GetPlayspace // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x20b6f84
};
...
struct UOverlapComponent : UStaticMeshComponent {
	...
	void OnEndActorOverlap(struct UPrimitiveComponent* OverlappedComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // Function PlayspaceSystem.OverlapComponent.OnEndActorOverlap // (Native|Protected) // @ game+0x63e709c
	void OnBeginActorOverlap(struct UPrimitiveComponent* OverlappedComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult); // Function PlayspaceSystem.OverlapComponent.OnBeginActorOverlap // (Native|Protected|HasOutParms) // @ game+0x63e6eac
};
...
struct APlayspace : AInfo {
	...
	void OnRep_PlayspaceUsers(); // Function PlayspaceSystem.Playspace.OnRep_PlayspaceUsers // (Final|Native|Protected) // @ game+0x1a257fc
	void OnRep_MatchStartTime(); // Function PlayspaceSystem.Playspace.OnRep_MatchStartTime // (Native|Protected) // @ game+0x16500ec
	void OnRep_bMatchHasEnded(); // Function PlayspaceSystem.Playspace.OnRep_bMatchHasEnded // (Final|Native|Protected) // @ game+0x1650104
	void OnRep_bIsInitialized(); // Function PlayspaceSystem.Playspace.OnRep_bIsInitialized // (Final|Native|Protected) // @ game+0x61314e4
};
...
struct UPlayspaceControllerComponent_PlayerSpawning : UControllerComponent {
	...
	void ServerMarkReadyForSpawning(); // Function PlayspaceSystem.PlayspaceControllerComponent_PlayerSpawning.ServerMarkReadyForSpawning // (Net|NetReliableNative|Event|Public|NetServer|NetValidate) // @ game+0x63e740c
	void OnRep_ReplicatedSpawnInfo(); // Function PlayspaceSystem.PlayspaceControllerComponent_PlayerSpawning.OnRep_ReplicatedSpawnInfo // (Final|Native|Private) // @ game+0x63e7364
	struct FReplicatedSpawnInfo GetSpawnInfo(); // Function PlayspaceSystem.PlayspaceControllerComponent_PlayerSpawning.GetSpawnInfo // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x63e6dd0
};
...
struct UPlayspaceLibrary : UBlueprintFunctionLibrary {
	...
	void DestroyPlayspace(struct APlayspace* PlayspaceToDestroy); // Function PlayspaceSystem.PlayspaceLibrary.DestroyPlayspace // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x63e6af0
};
...
struct APlayspaceLogic : AActor {
	...
	void OnRep_MatchStartTime(); // Function PlayspaceSystem.PlayspaceLogic.OnRep_MatchStartTime // (Native|Protected) // @ game+0x24c3a78
	void OnRep_bMatchHasEnded(); // Function PlayspaceSystem.PlayspaceLogic.OnRep_bMatchHasEnded // (Final|Native|Private) // @ game+0x1651d1c
};
...
struct UPlayspaceManagerComponent : UGameStateComponent {
	...
	bool ProcessOverlapEvents(float DeltaTime); // Function PlayspaceSystem.PlayspaceManagerComponent.ProcessOverlapEvents // (Final|Native|Private) // @ game+0x63e7378
	void OnRep_RootPlayspace(); // Function PlayspaceSystem.PlayspaceManagerComponent.OnRep_RootPlayspace // (Final|Native|Private) // @ game+0x2973dd8
	void OnPlayerEndOverlapGameplayVolume(struct APlayerState* PlayerState, struct AGameplayVolume* Volume); // Function PlayspaceSystem.PlayspaceManagerComponent.OnPlayerEndOverlapGameplayVolume // (Final|Native|Private) // @ game+0x63e72a0
	void OnPlayerBeginOverlapGameplayVolume(struct APlayerState* PlayerState, struct AGameplayVolume* Volume); // Function PlayspaceSystem.PlayspaceManagerComponent.OnPlayerBeginOverlapGameplayVolume // (Final|Native|Private) // @ game+0x63e71dc
};
