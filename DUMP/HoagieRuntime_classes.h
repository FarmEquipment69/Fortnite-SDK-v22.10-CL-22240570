...
struct AFortHoagieAudioController : AActor {
	...
	void Update(); // Function HoagieRuntime.FortHoagieAudioController.Update // (Final|Native|Public|BlueprintCallable) // @ game+0x65831bc
	void CacheHoagieVehicle(struct AFortHoagieVehicle* InVehicle); // Function HoagieRuntime.FortHoagieAudioController.CacheHoagieVehicle // (Final|Native|Public|BlueprintCallable) // @ game+0x6582be4
	void CacheAudioComponents(struct UFortLayeredAudioComponent* InEngine, struct UFortLayeredAudioComponent* InRotor); // Function HoagieRuntime.FortHoagieAudioController.CacheAudioComponents // (Final|Native|Public|BlueprintCallable) // @ game+0x6582b18
};
...
struct AFortHoagieVehicle : AFortAthenaSKVehicle {
	...
	void UpdateHoagieAnimBP(); // Function HoagieRuntime.FortHoagieVehicle.UpdateHoagieAnimBP // (Native|Event|Protected|BlueprintCallable|BlueprintEvent) // @ game+0x6583254
	void UpdateDamageStateNative(float Damage); // Function HoagieRuntime.FortHoagieVehicle.UpdateDamageStateNative // (Final|Native|Protected|BlueprintCallable) // @ game+0x65831d0
	void ShowCooldownCue(struct AFortPlayerPawn* Pawn, float Duration); // Function HoagieRuntime.FortHoagieVehicle.ShowCooldownCue // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void SetTailRotorRotation(float Degrees); // Function HoagieRuntime.FortHoagieVehicle.SetTailRotorRotation // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void SetRotorWashActive(bool bActive); // Function HoagieRuntime.FortHoagieVehicle.SetRotorWashActive // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void SetMainRotorRotation(float Degrees); // Function HoagieRuntime.FortHoagieVehicle.SetMainRotorRotation // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ServerUpdateControlState(struct FReplicatedHeliControlState InControlState); // Function HoagieRuntime.FortHoagieVehicle.ServerUpdateControlState // (Final|Net|Native|Event|Private|NetServer) // @ game+0x6583118
	void OnTickRotors(float RotorAngleDegrees); // Function HoagieRuntime.FortHoagieVehicle.OnTickRotors // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnStartupEnd(); // Function HoagieRuntime.FortHoagieVehicle.OnStartupEnd // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnStartupBegin(); // Function HoagieRuntime.FortHoagieVehicle.OnStartupBegin // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnRotorsStop(); // Function HoagieRuntime.FortHoagieVehicle.OnRotorsStop // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnRotorDamagePlayer(struct FHitResult& Impact); // Function HoagieRuntime.FortHoagieVehicle.OnRotorDamagePlayer // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnRotorDamageDealtOuter(struct FHitResult& Impact); // Function HoagieRuntime.FortHoagieVehicle.OnRotorDamageDealtOuter // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnRotorDamageDealtInner(struct FHitResult& Impact); // Function HoagieRuntime.FortHoagieVehicle.OnRotorDamageDealtInner // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnRotorDamageDealt(struct FHitResult& Impact, bool bInner); // Function HoagieRuntime.FortHoagieVehicle.OnRotorDamageDealt // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnRep_HoagieState(); // Function HoagieRuntime.FortHoagieVehicle.OnRep_HoagieState // (Final|Native|Protected) // @ game+0x6583104
	void OnRep_ControlState(); // Function HoagieRuntime.FortHoagieVehicle.OnRep_ControlState // (Final|Native|Private) // @ game+0x21ce104
	void OnRefueledFromEmpty(); // Function HoagieRuntime.FortHoagieVehicle.OnRefueledFromEmpty // (Final|Native|Protected) // @ game+0x65830f0
	void OnImpactWhileCritical(); // Function HoagieRuntime.FortHoagieVehicle.OnImpactWhileCritical // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnImpactOtherHoagie(struct FVector& HitLocation, struct FVector& NormalImpulse); // Function HoagieRuntime.FortHoagieVehicle.OnImpactOtherHoagie // (Event|Protected|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0xda05cc
	void OnCritRotor(float Damage, struct FVector& ImpactLocation, struct AController* DamageInstigator, struct AActor* DamageCauser, bool bMainRotor); // Function HoagieRuntime.FortHoagieVehicle.OnCritRotor // (Event|Protected|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0xda05cc
	void OnBoostStarted(); // Function HoagieRuntime.FortHoagieVehicle.OnBoostStarted // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnBoostReady(); // Function HoagieRuntime.FortHoagieVehicle.OnBoostReady // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnBoostFinished(); // Function HoagieRuntime.FortHoagieVehicle.OnBoostFinished // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnBoostFailed(); // Function HoagieRuntime.FortHoagieVehicle.OnBoostFailed // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void MulticastRotorImpulse(struct FHitResult RotorHit); // Function HoagieRuntime.FortHoagieVehicle.MulticastRotorImpulse // (Net|NetReliableNative|Event|NetMulticast|Protected|BlueprintCallable) // @ game+0x6583060
	bool IsStartingUp(); // Function HoagieRuntime.FortHoagieVehicle.IsStartingUp // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6583044
	bool IsShuttingDown(); // Function HoagieRuntime.FortHoagieVehicle.IsShuttingDown // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6583024
	bool IsScrapingBottom(); // Function HoagieRuntime.FortHoagieVehicle.IsScrapingBottom // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6583000
	float GetVerticalSpeedKmh(); // Function HoagieRuntime.FortHoagieVehicle.GetVerticalSpeedKmh // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582fd8
	struct FVector GetThrustDirection(bool bWorldSpace); // Function HoagieRuntime.FortHoagieVehicle.GetThrustDirection // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582f34
	float GetStrafeAlpha(); // Function HoagieRuntime.FortHoagieVehicle.GetStrafeAlpha // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582d9c
	float GetSteerAlpha(); // Function HoagieRuntime.FortHoagieVehicle.GetSteerAlpha // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582f00
	float GetShutdownTimeLeft(); // Function HoagieRuntime.FortHoagieVehicle.GetShutdownTimeLeft // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582ee8
	float GetRotorSpeedPercent(); // Function HoagieRuntime.FortHoagieVehicle.GetRotorSpeedPercent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582ec8
	float GetRotorSpeed(); // Function HoagieRuntime.FortHoagieVehicle.GetRotorSpeed // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582eb0
	struct FVector GetRotorCenterPosition(); // Function HoagieRuntime.FortHoagieVehicle.GetRotorCenterPosition // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582e78
	float GetRotorAngleDegrees(); // Function HoagieRuntime.FortHoagieVehicle.GetRotorAngleDegrees // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582e60
	float GetMaxBoostCooldown(); // Function HoagieRuntime.FortHoagieVehicle.GetMaxBoostCooldown // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582e40
	float GetMaxAltitude(); // Function HoagieRuntime.FortHoagieVehicle.GetMaxAltitude // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582e20
	float GetLiftAlpha(); // Function HoagieRuntime.FortHoagieVehicle.GetLiftAlpha // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582dec
	bool GetIsEngineOn(); // Function HoagieRuntime.FortHoagieVehicle.GetIsEngineOn // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582dcc
	float GetForwardAlpha(); // Function HoagieRuntime.FortHoagieVehicle.GetForwardAlpha // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582d9c
	float GetDistanceToGround(); // Function HoagieRuntime.FortHoagieVehicle.GetDistanceToGround // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582d84
	float GetBoostTimeLeft(); // Function HoagieRuntime.FortHoagieVehicle.GetBoostTimeLeft // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582d6c
	float GetBoostDuration(); // Function HoagieRuntime.FortHoagieVehicle.GetBoostDuration // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582d4c
	struct FVector GetBoostDirection(); // Function HoagieRuntime.FortHoagieVehicle.GetBoostDirection // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582d24
	float GetBoostCooldown(); // Function HoagieRuntime.FortHoagieVehicle.GetBoostCooldown // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582d0c
	float GetAltitude(); // Function HoagieRuntime.FortHoagieVehicle.GetAltitude // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6582cec
};
