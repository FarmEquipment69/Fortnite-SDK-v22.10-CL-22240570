...
struct UBP_SidebarCollectionScreenContainerEditTags_C : UFortSidebarCollectionScreenContainerEditTags {
	...
	void BP_OnShowTabsSet(bool bShowTabs); // Function BP_SidebarCollectionScreenContainerEditTags.BP_SidebarCollectionScreenContainerEditTags_C.BP_OnShowTabsSet // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	...
	void BP_OnWhatAreTagsDeactivated(); // Function BP_SidebarCollectionScreenContainerEditTags.BP_SidebarCollectionScreenContainerEditTags_C.BP_OnWhatAreTagsDeactivated // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void BP_OnWhatAreTagsActivated(); // Function BP_SidebarCollectionScreenContainerEditTags.BP_SidebarCollectionScreenContainerEditTags_C.BP_OnWhatAreTagsActivated // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ToggleTagsInfoTooltip(); // Function BP_SidebarCollectionScreenContainerEditTags.BP_SidebarCollectionScreenContainerEditTags_C.ToggleTagsInfoTooltip // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	...
	void BP_OnCollectionTabTitleChange(enum class ESocialTagCategory& TagCategory); // Function BP_SidebarCollectionScreenContainerEditTags.BP_SidebarCollectionScreenContainerEditTags_C.BP_OnCollectionTabTitleChange // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void PreConstruct(bool IsDesignTime); // Function BP_SidebarCollectionScreenContainerEditTags.BP_SidebarCollectionScreenContainerEditTags_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void Construct(); // Function BP_SidebarCollectionScreenContainerEditTags.BP_SidebarCollectionScreenContainerEditTags_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_BP_SidebarCollectionScreenContainerEditTags(int32_t EntryPoint); // Function BP_SidebarCollectionScreenContainerEditTags.BP_SidebarCollectionScreenContainerEditTags_C.ExecuteUbergraph_BP_SidebarCollectionScreenContainerEditTags // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
