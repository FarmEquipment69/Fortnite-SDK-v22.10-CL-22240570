...
struct UNetworkPredictionComponent : UActorComponent {
	...
	void ServerReceiveClientInput(struct FServerReplicationRPCParameter ProxyParameter); // Function NetworkPrediction.NetworkPredictionComponent.ServerReceiveClientInput // (Net|Native|Event|Protected|NetServer|NetValidate) // @ game+0x64025d4
};
