...
struct AGCNL_EnvCampFire_Stoke_C : AFortGameplayCueNotify_Loop {
	...
	void ExecuteUbergraph_GCNL_EnvCampFire_Stoke(int32_t EntryPoint); // Function GCNL_EnvCampFire_Stoke.GCNL_EnvCampFire_Stoke_C.ExecuteUbergraph_GCNL_EnvCampFire_Stoke // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
