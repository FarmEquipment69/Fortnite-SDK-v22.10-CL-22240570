...
struct UEventLeaderboardSummary_C : UFortShowdownDetailView {
	...
	void BndEvt__Button_ViewAll_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature(struct UCommonButtonLegacy* Button); // Function EventLeaderboardSummary.EventLeaderboardSummary_C.BndEvt__Button_ViewAll_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature // (BlueprintEvent) // @ game+0xda05cc
	void EventColorize(struct FFortTournamentDisplayInfo TournamentDisplayInfo); // Function EventLeaderboardSummary.EventLeaderboardSummary_C.EventColorize // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void RefreshDataBP(); // Function EventLeaderboardSummary.EventLeaderboardSummary_C.RefreshDataBP // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_EventLeaderboardSummary(int32_t EntryPoint); // Function EventLeaderboardSummary.EventLeaderboardSummary_C.ExecuteUbergraph_EventLeaderboardSummary // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
	void EventViewFullLeaderboard__DelegateSignature(struct FString TournamentId, struct FString EventId); // Function EventLeaderboardSummary.EventLeaderboardSummary_C.EventViewFullLeaderboard__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
