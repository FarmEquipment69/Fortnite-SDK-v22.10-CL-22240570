...
struct UBP_Shotgun_SG_BFPA_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function BP_Shotgun_SG_BFPA.BP_Shotgun_SG_BFPA_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_BP_Shotgun_SG_BFPA(int32_t EntryPoint); // Function BP_Shotgun_SG_BFPA.BP_Shotgun_SG_BFPA_C.ExecuteUbergraph_BP_Shotgun_SG_BFPA // (Final|UbergraphFunction) // @ game+0xda05cc
};
