...
struct UFortSoundCueTemplateDefaultSettings : UDataAsset {
	...
	struct UFortSoundCueTemplateDefaults* GetSettingsForTemplateType(struct UFortSoundCueTemplateBase* TemplateType); // Function FortSoundCueTemplates.FortSoundCueTemplateDefaultSettings.GetSettingsForTemplateType // (Final|Native|Public) // @ game+0x70b8f1c
};
...
struct UFortSoundCueTemplateSettings : UDeveloperSettings {
	...
	struct UFortSoundCueTemplateDefaults* GetDefaultSettingsForTemplateType(struct UFortSoundCueTemplateBase* TemplateType); // Function FortSoundCueTemplates.FortSoundCueTemplateSettings.GetDefaultSettingsForTemplateType // (Final|Native|Public|Const) // @ game+0x70b8e8c
};
