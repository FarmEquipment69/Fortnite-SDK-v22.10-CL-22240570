...
struct UUserActionMenu_C : UFortSocialInteractionMenu {
	...
	void OnToggleConfirmation(bool bIsVisible); // Function UserActionMenu.UserActionMenu_C.OnToggleConfirmation // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnOpened(); // Function UserActionMenu.UserActionMenu_C.OnOpened // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_UserActionMenu(int32_t EntryPoint); // Function UserActionMenu.UserActionMenu_C.ExecuteUbergraph_UserActionMenu // (Final|UbergraphFunction) // @ game+0xda05cc
};
