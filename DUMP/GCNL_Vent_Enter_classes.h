...
struct AGCNL_Vent_Enter_C : AFortGameplayCueNotify_Loop {
	...
	struct UMatineeCameraShake* CameraShakeClass; // 0x980(0x08)
	struct UMatineeCameraShake* CameraShake; // 0x988(0x08)
	bool UsePP; // 0x990(0x01)

	void FadePPVol__FinishedFunc(); // Function GCNL_Vent_Enter.GCNL_Vent_Enter_C.FadePPVol__FinishedFunc // (BlueprintEvent) // @ game+0xda05cc
	void FadePPVol__UpdateFunc(); // Function GCNL_Vent_Enter.GCNL_Vent_Enter_C.FadePPVol__UpdateFunc // (BlueprintEvent) // @ game+0xda05cc
	void OnLoopingStart(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UParticleSystemComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents); // Function GCNL_Vent_Enter.GCNL_Vent_Enter_C.OnLoopingStart // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnRemoval(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UParticleSystemComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents, struct UMatineeCameraShake* BurstCameraShakeInstance, struct ADecalActor* BurstDecalInstance); // Function GCNL_Vent_Enter.GCNL_Vent_Enter_C.OnRemoval // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_GCNL_Vent_Enter(int32_t EntryPoint); // Function GCNL_Vent_Enter.GCNL_Vent_Enter_C.ExecuteUbergraph_GCNL_Vent_Enter // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
