...
struct UAccountPinLinkingWindow_C : UFortAccountPinLinkingWindow {
	...
	struct UImage* ; // 0x6b0(0x08)
	struct UImage* ; // 0x6b8(0x08)
	struct USafeZone* ; // 0x6c0(0x08)
	...
	void ExecuteUbergraph_AccountPinLinkingWindow(int32_t EntryPoint); // Function AccountPinLinkingWindow.AccountPinLinkingWindow_C.ExecuteUbergraph_AccountPinLinkingWindow // (Final|UbergraphFunction) // @ game+0xda05cc
};
