...
struct USidebarRecentPlayerListEntry_C : UFortConnectionsUserListEntry {
	...
	struct UCommonActivatableWidgetSwitcher* Switcher_LastInteraction; // 0x1138(0x08)
	...
	void BP_OnUnhovered(); // Function SidebarRecentPlayerListEntry.SidebarRecentPlayerListEntry_C.BP_OnUnhovered // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	...
	void BP_OnHovered(); // Function SidebarRecentPlayerListEntry.SidebarRecentPlayerListEntry_C.BP_OnHovered // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnFocusLost(struct FFocusEvent InFocusEvent); // Function SidebarRecentPlayerListEntry.SidebarRecentPlayerListEntry_C.OnFocusLost // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_SidebarRecentPlayerListEntry(int32_t EntryPoint); // Function SidebarRecentPlayerListEntry.SidebarRecentPlayerListEntry_C.ExecuteUbergraph_SidebarRecentPlayerListEntry // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
