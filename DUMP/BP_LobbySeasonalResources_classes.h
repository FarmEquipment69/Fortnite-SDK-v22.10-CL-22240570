...
struct UBP_LobbySeasonalResources_C : UFortBattlePassResourcesWidgetBase {
	...
	void BndEvt__MoreInfo_Ressources_Button_67_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature(struct UCommonButtonBase* Button); // Function BP_LobbySeasonalResources.BP_LobbySeasonalResources_C.BndEvt__MoreInfo_Ressources_Button_67_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature // (BlueprintEvent) // @ game+0xda05cc
	...
	void Construct(); // Function BP_LobbySeasonalResources.BP_LobbySeasonalResources_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnShowMoreInfo(bool bShouldShowMoreInfo); // Function BP_LobbySeasonalResources.BP_LobbySeasonalResources_C.OnShowMoreInfo // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_BP_LobbySeasonalResources(int32_t EntryPoint); // Function BP_LobbySeasonalResources.BP_LobbySeasonalResources_C.ExecuteUbergraph_BP_LobbySeasonalResources // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
