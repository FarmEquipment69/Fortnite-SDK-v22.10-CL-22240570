...
struct UGravityGunTargetTrackingComponent : UActorComponent {
	...
	bool IsValidTarget(struct AActor* OwningPlayer, struct AActor* PotentialTarget, struct FGameplayTagContainer& ReasonForFailure); // Function MotherGameplayRuntime.GravityGunTargetTrackingComponent.IsValidTarget // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x67b47d0
	bool FindTargetProjectile(struct AActor* OwningPlayer, struct FVector& TraceStart, struct FVector& TraceEnd, float TargetingRadius); // Function MotherGameplayRuntime.GravityGunTargetTrackingComponent.FindTargetProjectile // (Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x67b3d40
	void FindTargetActor(struct AActor* OwningPlayer, struct FVector& TraceStart, struct FVector& TraceEnd); // Function MotherGameplayRuntime.GravityGunTargetTrackingComponent.FindTargetActor // (Final|Native|Protected|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x67b33a0
};
...
struct AReactorGradeGameplayCue_ChargeUp : AFortGameplayCueNotify_Loop {
	...
	void UpdateAimEndPoint(); // Function MotherGameplayRuntime.ReactorGradeGameplayCue_ChargeUp.UpdateAimEndPoint // (Final|Native|Public|BlueprintCallable) // @ game+0x67b4c00
	void OnEndPointUpdated(struct FVector& FoundPoint); // Function MotherGameplayRuntime.ReactorGradeGameplayCue_ChargeUp.OnEndPointUpdated // (Event|Public|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0xda05cc
	struct FVector GetFoundEndPoint(); // Function MotherGameplayRuntime.ReactorGradeGameplayCue_ChargeUp.GetFoundEndPoint // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x67b47a8
};
