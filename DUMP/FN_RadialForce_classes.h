...
struct AFN_RadialForce_C : AFieldSystemActor {
	...
	struct FTransform (double Roll, double Scale); // Function FN_RadialForce.FN_RadialForce_C. // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0xda05cc
	void Timeline_0__FinishedFunc(); // Function FN_RadialForce.FN_RadialForce_C.Timeline_0__FinishedFunc // (BlueprintEvent) // @ game+0xda05cc
	void Timeline_0__UpdateFunc(); // Function FN_RadialForce.FN_RadialForce_C.Timeline_0__UpdateFunc // (BlueprintEvent) // @ game+0xda05cc
	void ReceiveBeginPlay(); // Function FN_RadialForce.FN_RadialForce_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_FN_RadialForce(int32_t EntryPoint); // Function FN_RadialForce.FN_RadialForce_C.ExecuteUbergraph_FN_RadialForce // (Final|UbergraphFunction) // @ game+0xda05cc
};
