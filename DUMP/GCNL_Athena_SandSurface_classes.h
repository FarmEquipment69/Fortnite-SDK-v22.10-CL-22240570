...
struct AGCNL_Athena_SandSurface_C : AGCNL_Athena_Surface_Parent_C {
	...
	void OnPlayerFootstep(); // Function GCNL_Athena_SandSurface.GCNL_Athena_SandSurface_C.OnPlayerFootstep // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnLoopingStartNiagara(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UNiagaraComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents); // Function GCNL_Athena_SandSurface.GCNL_Athena_SandSurface_C.OnLoopingStartNiagara // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_GCNL_Athena_SandSurface(int32_t EntryPoint); // Function GCNL_Athena_SandSurface.GCNL_Athena_SandSurface_C.ExecuteUbergraph_GCNL_Athena_SandSurface // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
