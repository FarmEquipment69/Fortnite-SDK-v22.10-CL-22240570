...
struct USocialBanModal_C : UFortSocialBanModal {
	...
	void OnDisplayModeSet(bool bIsBanned); // Function SocialBanModal.SocialBanModal_C.OnDisplayModeSet // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_SocialBanModal(int32_t EntryPoint); // Function SocialBanModal.SocialBanModal_C.ExecuteUbergraph_SocialBanModal // (Final|UbergraphFunction) // @ game+0xda05cc
	void OnCloseSucceeded__DelegateSignature(); // Function SocialBanModal.SocialBanModal_C.OnCloseSucceeded__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
