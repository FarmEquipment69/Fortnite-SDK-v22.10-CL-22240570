...
struct UAnimNotify_Irwin_FootTurns_C : UFN_NiagaraNotify_C {
	...
	bool Received_Notify(struct USkeletalMeshComponent* MeshComp, struct UAnimSequenceBase* Animation, struct FAnimNotifyEventReference& EventReference); // Function AnimNotify_Irwin_FootTurns.AnimNotify_Irwin_FootTurns_C.Received_Notify // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // @ game+0xda05cc
};
