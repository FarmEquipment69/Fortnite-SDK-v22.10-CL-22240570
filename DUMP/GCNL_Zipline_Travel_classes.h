...
struct AGCNL_Zipline_Travel_C : AFortGameplayCueNotifyLoop_ZiplineTravel {
	...
	void ExecuteUbergraph_GCNL_Zipline_Travel(int32_t EntryPoint); // Function GCNL_Zipline_Travel.GCNL_Zipline_Travel_C.ExecuteUbergraph_GCNL_Zipline_Travel // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
