...
struct UStoreSelectionPopup_C : UFortMtxStoreSelectionPopup {
	...
	void BP_OnActivated(); // Function StoreSelectionPopup.StoreSelectionPopup_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_StoreSelectionPopup(int32_t EntryPoint); // Function StoreSelectionPopup.StoreSelectionPopup_C.ExecuteUbergraph_StoreSelectionPopup // (Final|UbergraphFunction) // @ game+0xda05cc
};
