...
struct UFortCheatManager_Tempest : UChildCheatManager {
	...
	void EndTempestStorm(struct FString StormName); // Function TempestRuntime.FortCheatManager_Tempest.EndTempestStorm // (Final|BlueprintAuthorityOnly|Exec|Native|Public) // @ game+0x5d0b628
};
...
struct UTempestMovementComponent : UGameFrameworkComponent {
	...
	void OnRep_MovementData(); // Function TempestRuntime.TempestMovementComponent.OnRep_MovementData // (Final|Native|Private|Const) // @ game+0x68e3b74
};
...
struct UTempestStateMachineComponent : UGameFrameworkComponent {
	...
	void OnRep_CurrentStateInfo(); // Function TempestRuntime.TempestStateMachineComponent.OnRep_CurrentStateInfo // (Final|Native|Private) // @ game+0x68e3b34
	struct FTempestStateInfo GetCurrentStateInfo(); // Function TempestRuntime.TempestStateMachineComponent.GetCurrentStateInfo // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x68e3b0c
	float GetCurrentStateCompletionPercentage(); // Function TempestRuntime.TempestStateMachineComponent.GetCurrentStateCompletionPercentage // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x68e3ae4
	enum class ETempestState GetCurrentState(); // Function TempestRuntime.TempestStateMachineComponent.GetCurrentState // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x68e3acc
	void ForceDissipate(struct FString InDissipationReason); // Function TempestRuntime.TempestStateMachineComponent.ForceDissipate // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x68e3918
};
