...
struct AGCNL_Status_DanceStunned_C : AFortGameplayCueNotify_Loop {
	...
	void ExecuteUbergraph_GCNL_Status_DanceStunned(int32_t EntryPoint); // Function GCNL_Status_DanceStunned.GCNL_Status_DanceStunned_C.ExecuteUbergraph_GCNL_Status_DanceStunned // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
