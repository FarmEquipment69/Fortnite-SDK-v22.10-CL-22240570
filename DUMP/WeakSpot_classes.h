...
struct AWeakSpot_C : ABuildingWeakSpot {
	...
	void UserConstructionScript(); // Function WeakSpot.WeakSpot_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ScaleDownParticleTL__FinishedFunc(); // Function WeakSpot.WeakSpot_C.ScaleDownParticleTL__FinishedFunc // (BlueprintEvent) // @ game+0xda05cc
	void ScaleDownParticleTL__UpdateFunc(); // Function WeakSpot.WeakSpot_C.ScaleDownParticleTL__UpdateFunc // (BlueprintEvent) // @ game+0xda05cc
	void OnFadeOut(); // Function WeakSpot.WeakSpot_C.OnFadeOut // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnStartDirectionEffect(); // Function WeakSpot.WeakSpot_C.OnStartDirectionEffect // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnHit(); // Function WeakSpot.WeakSpot_C.OnHit // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void HideMesh(); // Function WeakSpot.WeakSpot_C.HideMesh // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_WeakSpot(int32_t EntryPoint); // Function WeakSpot.WeakSpot_C.ExecuteUbergraph_WeakSpot // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
