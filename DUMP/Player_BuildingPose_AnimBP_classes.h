...
struct UPlayer_BuildingPose_AnimBP_C : UFortPlayerBuildingAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function Player_BuildingPose_AnimBP.Player_BuildingPose_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_Player_BuildingPose_AnimBP(int32_t EntryPoint); // Function Player_BuildingPose_AnimBP.Player_BuildingPose_AnimBP_C.ExecuteUbergraph_Player_BuildingPose_AnimBP // (Final|UbergraphFunction) // @ game+0xda05cc
};
