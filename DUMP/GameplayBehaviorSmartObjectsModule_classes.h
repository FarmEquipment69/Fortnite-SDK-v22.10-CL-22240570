...
struct UAITask_UseGameplayBehaviorSmartObject : UAITask {
	...
	struct UAITask_UseGameplayBehaviorSmartObject* UseGameplayBehaviorSmartObject(struct AAIController* Controller, struct AActor* SmartObjectActor, struct USmartObjectComponent* SmartObjectComponent, bool bLockAILogic); // Function GameplayBehaviorSmartObjectsModule.AITask_UseGameplayBehaviorSmartObject.UseGameplayBehaviorSmartObject // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x71f0198
	struct UAITask_UseGameplayBehaviorSmartObject* UseClaimedGameplayBehaviorSmartObject(struct AAIController* Controller, struct FSmartObjectClaimHandle ClaimHandle, bool bLockAILogic); // Function GameplayBehaviorSmartObjectsModule.AITask_UseGameplayBehaviorSmartObject.UseClaimedGameplayBehaviorSmartObject // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x71eff4c
};
...
struct UGameplayBehaviorSmartObjectsBlueprintFunctionLibrary : UBlueprintFunctionLibrary {
	...
	bool UseGameplayBehaviorSmartObject(struct AActor* Avatar, struct AActor* SmartObject); // Function GameplayBehaviorSmartObjectsModule.GameplayBehaviorSmartObjectsBlueprintFunctionLibrary.UseGameplayBehaviorSmartObject // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x71f032c
};
