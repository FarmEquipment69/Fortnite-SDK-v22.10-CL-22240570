...
struct Ulog_channel : UObject {
	...
	void $InitInstance(); // Function UnrealEngineExperimental.log_channel.$InitInstance // (None) // @ game+0xda05cc
	void $InitCDO(); // Function UnrealEngineExperimental.log_channel.$InitCDO // (None) // @ game+0xda05cc
};
