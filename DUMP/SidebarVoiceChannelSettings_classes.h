...
struct USidebarVoiceChannelSettings_C : UFortVoiceSettingsDisplay {
	...
	struct UCommonRichTextBlock* InputDevice; // 0x3c0(0x08)
	struct UCommonRichTextBlock* OutputDevice; // 0x3c8(0x08)
	struct UKeybindWidget_C* PTTKeybindWidget; // 0x3d0(0x08)
	struct UCommonRichTextBlock* PushToTalk; // 0x3d8(0x08)
	struct UCommonTextBlock* Text_LowPowerMode; // 0x3e0(0x08)
	struct UImage* VoiceDisabledIcon; // 0x3e8(0x08)
	struct UCommonRichTextBlock* VoiceDisabledText; // 0x3f0(0x08)
	...
	void ExecuteUbergraph_SidebarVoiceChannelSettings(int32_t EntryPoint); // Function SidebarVoiceChannelSettings.SidebarVoiceChannelSettings_C.ExecuteUbergraph_SidebarVoiceChannelSettings // (Final|UbergraphFunction) // @ game+0xda05cc
};
