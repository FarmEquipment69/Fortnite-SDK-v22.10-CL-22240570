...
struct UTournamentEventWindowDetails_C : UFortShowdownDetailView {
	...
	void RefreshDataBP(); // Function TournamentEventWindowDetails.TournamentEventWindowDetails_C.RefreshDataBP // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void EventColorize(); // Function TournamentEventWindowDetails.TournamentEventWindowDetails_C.EventColorize // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void BndEvt__Button_Payout_K2Node_ComponentBoundEvent_4_CommonButtonClicked__DelegateSignature(struct UCommonButtonLegacy* Button); // Function TournamentEventWindowDetails.TournamentEventWindowDetails_C.BndEvt__Button_Payout_K2Node_ComponentBoundEvent_4_CommonButtonClicked__DelegateSignature // (BlueprintEvent) // @ game+0xda05cc
	...
	void ExecuteUbergraph_TournamentEventWindowDetails(int32_t EntryPoint); // Function TournamentEventWindowDetails.TournamentEventWindowDetails_C.ExecuteUbergraph_TournamentEventWindowDetails // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
	void ViewPayouts__DelegateSignature(struct FString EventWindowId, struct FString EventId); // Function TournamentEventWindowDetails.TournamentEventWindowDetails_C.ViewPayouts__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ViewLeaderboard__DelegateSignature(struct FString TournamentId, struct FString EventId); // Function TournamentEventWindowDetails.TournamentEventWindowDetails_C.ViewLeaderboard__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
