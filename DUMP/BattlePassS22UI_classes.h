...
struct UBattlePassLandingPageS22 : UBattlePassLandingPageBase {
	...
	void OnBattlePassSubscriptionAllowed(bool bSubscriptionAllowed); // Function BattlePassS22UI.BattlePassLandingPageS22.OnBattlePassSubscriptionAllowed // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnBattlePassOwned(); // Function BattlePassS22UI.BattlePassLandingPageS22.OnBattlePassOwned // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnBattlePassGiftingAllowed(bool bGiftingAllowed); // Function BattlePassS22UI.BattlePassLandingPageS22.OnBattlePassGiftingAllowed // (Event|Public|BlueprintEvent) // @ game+0xda05cc
};
...
struct UBattlePassRewardPageS22 : UBattlePassRewardPageBase {
	...
	void OnPageChanged(int32_t PageNumber); // Function BattlePassS22UI.BattlePassRewardPageS22.OnPageChanged // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnInputMethodChanged(enum class ECommonInputType InputType); // Function BattlePassS22UI.BattlePassRewardPageS22.OnInputMethodChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnInitForPageType(enum class ERewardPageType InRewardPageType); // Function BattlePassS22UI.BattlePassRewardPageS22.OnInitForPageType // (Event|Public|BlueprintEvent) // @ game+0xda05cc
};
...
struct UBattlePassScreenS22 : UBattlePassScreenBase {
	...
	void OverviewShowAnimationFinished(); // Function BattlePassS22UI.BattlePassScreenS22.OverviewShowAnimationFinished // (Final|Native|Public|BlueprintCallable) // @ game+0x21ce104
	void OnTransitionItemDetails(bool bTransitionForward); // Function BattlePassS22UI.BattlePassScreenS22.OnTransitionItemDetails // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnSetResourcePrice(int32_t Cost, struct UFortPersistentResourceItemDefinition* PersistentResource); // Function BattlePassS22UI.BattlePassScreenS22.OnSetResourcePrice // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnSetPrerequisiteInfo(struct FText& Description, int32_t OwnedRewards, int32_t NeededRewards, bool bShowPrerequisiteLock); // Function BattlePassS22UI.BattlePassScreenS22.OnSetPrerequisiteInfo // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnSetItemPrice(int32_t Cost, enum class EBattlePassCurrencyType CurrencyType); // Function BattlePassS22UI.BattlePassScreenS22.OnSetItemPrice // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnSetDynamicInput(enum class EBattlePassInputs InputType, struct UBattlePassInputData* InputData); // Function BattlePassS22UI.BattlePassScreenS22.OnSetDynamicInput // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnSetClaimedRewardInfo(int32_t OwnedRewards, int32_t TotalRewards); // Function BattlePassS22UI.BattlePassScreenS22.OnSetClaimedRewardInfo // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnLevelChanged(int32_t Level); // Function BattlePassS22UI.BattlePassScreenS22.OnLevelChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnItemDelayed(struct FTimespan Delay); // Function BattlePassS22UI.BattlePassScreenS22.OnItemDelayed // (Event|Protected|HasDefaults|BlueprintEvent) // @ game+0xda05cc
	void OnInsufficientResource(struct UFortPersistentResourceItemDefinition* PersistentResource); // Function BattlePassS22UI.BattlePassScreenS22.OnInsufficientResource // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnInsufficientFunds(enum class EBattlePassCurrencyType CurrencyType); // Function BattlePassS22UI.BattlePassScreenS22.OnInsufficientFunds // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnBattlePassOwned(); // Function BattlePassS22UI.BattlePassScreenS22.OnBattlePassOwned // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	bool IsSeasonalCustomizationItemOwned(); // Function BattlePassS22UI.BattlePassScreenS22.IsSeasonalCustomizationItemOwned // (Final|Native|Protected|BlueprintCallable|BlueprintPure|Const) // @ game+0x6551584
	void HandleSwitcherVisibilityShown(); // Function BattlePassS22UI.BattlePassScreenS22.HandleSwitcherVisibilityShown // (Final|Native|Public|BlueprintCallable) // @ game+0x655155c
	void HandleClaimRewardComplete(bool bSuccess, struct TArray<struct FString>& OfferTemplateIdList); // Function BattlePassS22UI.BattlePassScreenS22.HandleClaimRewardComplete // (Final|Native|Private|HasOutParms) // @ game+0x6551470
	struct FTimespan GetQuestPageDelay(); // Function BattlePassS22UI.BattlePassScreenS22.GetQuestPageDelay // (Final|Native|Protected|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x6551444
};
...
struct UFortBattlePassResourcesWidgetS22 : UFortBattlePassResourcesWidgetBase {
	...
	void OnStylePointsRewardsSet(int32_t Rewards); // Function BattlePassS22UI.FortBattlePassResourcesWidgetS22.OnStylePointsRewardsSet // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnBattleStarRewardsSet(int32_t Rewards); // Function BattlePassS22UI.FortBattlePassResourcesWidgetS22.OnBattleStarRewardsSet // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortBattlePassTutorialTooltipS22 : UCommonUserWidget {
	...
	void ShowTooltip(); // Function BattlePassS22UI.FortBattlePassTutorialTooltipS22.ShowTooltip // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void SetText(struct FText Text); // Function BattlePassS22UI.FortBattlePassTutorialTooltipS22.SetText // (Final|Native|Public|BlueprintCallable) // @ game+0x6542508
	void HideTooltip(); // Function BattlePassS22UI.FortBattlePassTutorialTooltipS22.HideTooltip // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct URebootRallyQuestPanel : UUserWidget {
	...
	void OnRebootRallyEligibilityUpdated(bool bEligible); // Function BattlePassS22UI.RebootRallyQuestPanel.OnRebootRallyEligibilityUpdated // (Event|Public|BlueprintEvent) // @ game+0xda05cc
};
