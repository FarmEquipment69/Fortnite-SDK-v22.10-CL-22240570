...
struct UGAB_ApplyFullBodyHit_NonParticipant_C : UGAB_GenericApplyFullBodyHit_C {
	...
	void PickFullBodyHitMontageSection(); // Function GAB_ApplyFullBodyHit_NonParticipant.GAB_ApplyFullBodyHit_NonParticipant_C.PickFullBodyHitMontageSection // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
