...
struct UBuoyancyComponent : UActorComponent {
	...
	void OnPontoonExitedWater(struct FSphericalPontoon& Pontoon); // Function Water.BuoyancyComponent.OnPontoonExitedWater // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x6472bd4
	void OnPontoonEnteredWater(struct FSphericalPontoon& Pontoon); // Function Water.BuoyancyComponent.OnPontoonEnteredWater // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x6472ad8
	bool IsOverlappingWaterBody(); // Function Water.BuoyancyComponent.IsOverlappingWaterBody // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x283b9e8
	bool IsInWaterBody(); // Function Water.BuoyancyComponent.IsInWaterBody // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6472abc
	void GetLastWaterSurfaceInfo(struct FVector& OutWaterPlaneLocation, struct FVector& OutWaterPlaneNormal, struct FVector& OutWaterSurfacePosition, float& OutWaterDepth, int32_t& OutWaterBodyIdx, struct FVector& OutWaterVelocity); // Function Water.BuoyancyComponent.GetLastWaterSurfaceInfo // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x64721a4
	struct TArray<struct UWaterBodyComponent*> GetCurrentWaterBodyComponents(); // Function Water.BuoyancyComponent.GetCurrentWaterBodyComponents // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6471ef4
};
...
struct ABuoyancyManager : AActor {
	...
	bool GetBuoyancyComponentManager(struct UObject* WorldContextObject, struct ABuoyancyManager*& Manager); // Function Water.BuoyancyManager.GetBuoyancyComponentManager // (Final|Native|Static|Public|HasOutParms) // @ game+0x6471d20
};
...
struct UGerstnerWaterWaveGeneratorBase : UObject {
	...
	void GenerateGerstnerWaves(struct TArray<struct FGerstnerWave>& OutWaves); // Function Water.GerstnerWaterWaveGeneratorBase.GenerateGerstnerWaves // (Native|Event|Public|HasOutParms|BlueprintEvent|Const) // @ game+0x6471be4
};
...
struct UNiagaraWaterFunctionLibrary : UBlueprintFunctionLibrary {
	...
	void SetWaterBodyComponent(struct UNiagaraComponent* NiagaraSystem, struct FString OverrideName, struct UWaterBodyComponent* WaterBodyComponent); // Function Water.NiagaraWaterFunctionLibrary.SetWaterBodyComponent // (Final|Native|Static|Private|BlueprintCallable) // @ game+0x64730ec
	void SetWaterBody(struct UNiagaraComponent* NiagaraSystem, struct FString OverrideName, struct AWaterBody* WaterBody); // Function Water.NiagaraWaterFunctionLibrary.SetWaterBody // (Final|Native|Static|Private|BlueprintCallable) // @ game+0x6472f38
};
...
struct AWaterBody : AActor {
	...
	void SetWaterWaves(struct UWaterWavesBase* InWaterWaves); // Function Water.WaterBody.SetWaterWaves // (Final|Native|Public|BlueprintCallable) // @ game+0x6473340
	void SetWaterMaterial(struct UMaterialInterface* InMaterial); // Function Water.WaterBody.SetWaterMaterial // (Final|Native|Public|BlueprintCallable) // @ game+0x64732b0
	void OnWaterBodyChanged(bool bShapeOrPositionChanged, bool bWeightmapSettingsChanged); // Function Water.WaterBody.OnWaterBodyChanged // (Final|Native|Public|BlueprintCallable) // @ game+0x6472cd0
	struct FVector GetWaterVelocityVectorAtSplineInputKey(float InKey); // Function Water.WaterBody.GetWaterVelocityVectorAtSplineInputKey // (Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x64729e8
	float GetWaterVelocityAtSplineInputKey(float InKey); // Function Water.WaterBody.GetWaterVelocityAtSplineInputKey // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x64728b0
	struct UWaterSplineComponent* GetWaterSpline(); // Function Water.WaterBody.GetWaterSpline // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6472650
	struct UMaterialInstanceDynamic* GetWaterMaterialInstance(); // Function Water.WaterBody.GetWaterMaterialInstance // (Final|Native|Public|BlueprintCallable) // @ game+0x64725d0
	enum class EWaterBodyType GetWaterBodyType(); // Function Water.WaterBody.GetWaterBodyType // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6472558
	struct UWaterBodyComponent* GetWaterBodyComponent(); // Function Water.WaterBody.GetWaterBodyComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2293070
	struct UMaterialInstanceDynamic* GetRiverToOceanTransitionMaterialInstance(); // Function Water.WaterBody.GetRiverToOceanTransitionMaterialInstance // (Final|Native|Public|BlueprintCallable) // @ game+0x6472450
	struct UMaterialInstanceDynamic* GetRiverToLakeTransitionMaterialInstance(); // Function Water.WaterBody.GetRiverToLakeTransitionMaterialInstance // (Final|Native|Public|BlueprintCallable) // @ game+0x64723f8
	struct TArray<struct AWaterBodyIsland*> GetIslands(); // Function Water.WaterBody.GetIslands // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6471ff4
	struct TArray<struct AWaterBodyExclusionVolume*> GetExclusionVolumes(); // Function Water.WaterBody.GetExclusionVolumes // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6471f10
	float GetAudioIntensityAtSplineInputKey(float InKey); // Function Water.WaterBody.GetAudioIntensityAtSplineInputKey // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6471c84
};
...
struct UWaterBodyComponent : UPrimitiveComponent {
	...
	void SetWaterAndUnderWaterPostProcessMaterial(struct UMaterialInterface* InWaterMaterial, struct UMaterialInterface* InUnderWaterPostProcessMaterial); // Function Water.WaterBodyComponent.SetWaterAndUnderWaterPostProcessMaterial // (Final|Native|Public|BlueprintCallable) // @ game+0x6472e4c
	void OnWaterBodyChanged(bool bShapeOrPositionChanged, bool bWeightmapSettingsChanged); // Function Water.WaterBodyComponent.OnWaterBodyChanged // (Final|Native|Public|BlueprintCallable) // @ game+0x6472d90
	struct UWaterWavesBase* GetWaterWaves(); // Function Water.WaterBodyComponent.GetWaterWaves // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6472a94
	float GetWaterVelocityAtSplineInputKey(float InKey); // Function Water.WaterBodyComponent.GetWaterVelocityAtSplineInputKey // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x647294c
	void GetWaterSurfaceInfoAtLocation(struct FVector& InLocation, struct FVector& OutWaterSurfaceLocation, struct FVector& OutWaterSurfaceNormal, struct FVector& OutWaterVelocity, float& OutWaterDepth, bool bIncludeDepth); // Function Water.WaterBodyComponent.GetWaterSurfaceInfoAtLocation // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x6472690
	struct UWaterSplineComponent* GetWaterSpline(); // Function Water.WaterBodyComponent.GetWaterSpline // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6472668
	struct UMaterialInstanceDynamic* GetWaterMaterialInstance(); // Function Water.WaterBodyComponent.GetWaterMaterialInstance // (Final|Native|Public|BlueprintCallable) // @ game+0x6472614
	struct UMaterialInterface* GetWaterMaterial(); // Function Water.WaterBodyComponent.GetWaterMaterial // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x64725b8
	struct UMaterialInstanceDynamic* GetWaterLODMaterialInstance(); // Function Water.WaterBodyComponent.GetWaterLODMaterialInstance // (Final|Native|Public|BlueprintCallable) // @ game+0x4c533e0
	struct UMaterialInstanceDynamic* GetWaterInfoMaterialInstance(); // Function Water.WaterBodyComponent.GetWaterInfoMaterialInstance // (Final|Native|Public|BlueprintCallable) // @ game+0x6472580
	struct AWaterBody* GetWaterBodyActor(); // Function Water.WaterBodyComponent.GetWaterBodyActor // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x1dd3dec
	struct UMaterialInstanceDynamic* GetUnderwaterPostProcessMaterialInstance(); // Function Water.WaterBodyComponent.GetUnderwaterPostProcessMaterialInstance // (Final|Native|Public|BlueprintCallable) // @ game+0x6472520
	struct TArray<struct UPrimitiveComponent*> GetStandardRenderableComponents(); // Function Water.WaterBodyComponent.GetStandardRenderableComponents // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x64724a8
	struct UMaterialInstanceDynamic* GetRiverToOceanTransitionMaterialInstance(); // Function Water.WaterBodyComponent.GetRiverToOceanTransitionMaterialInstance // (Native|Public|BlueprintCallable) // @ game+0x6472480
	struct UMaterialInstanceDynamic* GetRiverToLakeTransitionMaterialInstance(); // Function Water.WaterBodyComponent.GetRiverToLakeTransitionMaterialInstance // (Native|Public|BlueprintCallable) // @ game+0x6472428
	float GetMaxWaveHeight(); // Function Water.WaterBodyComponent.GetMaxWaveHeight // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x64723d0
	struct TArray<struct AWaterBodyIsland*> GetIslands(); // Function Water.WaterBodyComponent.GetIslands // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6472130
	struct TArray<struct AWaterBodyExclusionVolume*> GetExclusionVolumes(); // Function Water.WaterBodyComponent.GetExclusionVolumes // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6471f80
	struct TArray<struct UPrimitiveComponent*> GetCollisionComponents(bool bInOnlyEnabledComponents); // Function Water.WaterBodyComponent.GetCollisionComponents // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6471e20
};
...
struct AWaterBodyIsland : AActor {
	...
	struct UWaterSplineComponent* GetWaterSpline(); // Function Water.WaterBodyIsland.GetWaterSpline // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6472650
};
...
struct UWaterMeshComponent : UMeshComponent {
	...
	bool IsEnabled(); // Function Water.WaterMeshComponent.IsEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x64736a8
};
...
struct UWaterSubsystem : UTickableWorldSubsystem {
	...
	void SetOceanFloodHeight(float InFloodHeight); // Function Water.WaterSubsystem.SetOceanFloodHeight // (Final|Native|Public|BlueprintCallable) // @ game+0x64738c8
	void PrintToWaterLog(struct FString message, bool bWarning); // Function Water.WaterSubsystem.PrintToWaterLog // (Final|Native|Public|BlueprintCallable) // @ game+0x64736fc
	bool IsWaterRenderingEnabled(); // Function Water.WaterSubsystem.IsWaterRenderingEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x64736dc
	bool IsUnderwaterPostProcessEnabled(); // Function Water.WaterSubsystem.IsUnderwaterPostProcessEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x64736c0
	bool IsShallowWaterSimulationEnabled(); // Function Water.WaterSubsystem.IsShallowWaterSimulationEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x283b98c
	float GetWaterTimeSeconds(); // Function Water.WaterSubsystem.GetWaterTimeSeconds // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6473680
	float GetSmoothedWorldTimeSeconds(); // Function Water.WaterSubsystem.GetSmoothedWorldTimeSeconds // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6473650
	int32_t GetShallowWaterSimulationRenderTargetSize(); // Function Water.WaterSubsystem.GetShallowWaterSimulationRenderTargetSize // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x6473638
	int32_t GetShallowWaterMaxImpulseForces(); // Function Water.WaterSubsystem.GetShallowWaterMaxImpulseForces // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x6473620
	int32_t GetShallowWaterMaxDynamicForces(); // Function Water.WaterSubsystem.GetShallowWaterMaxDynamicForces // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x6473608
	float GetOceanTotalHeight(); // Function Water.WaterSubsystem.GetOceanTotalHeight // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x64735cc
	float GetOceanFloodHeight(); // Function Water.WaterSubsystem.GetOceanFloodHeight // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x64735b4
	float GetOceanBaseHeight(); // Function Water.WaterSubsystem.GetOceanBaseHeight // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x647358c
	float GetCameraUnderwaterDepth(); // Function Water.WaterSubsystem.GetCameraUnderwaterDepth // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6473574
};
