...
struct Ubasic_player_manager : UObject {
	...
	int64_t _L_2fEpicGames_2ecom_2fTemporary_2fVerseBasicGameplay_2fPlayerManager_2fbasic__player__manager_N_RGetPlayerCount(struct Ftuple_L_R __verse_0xB2CDDD72_Argument); // Function VerseBasicGameplay.basic_player_manager._L_2fEpicGames_2ecom_2fTemporary_2fVerseBasicGameplay_2fPlayerManager_2fbasic__player__manager_N_RGetPlayerCount // (Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0xda05cc
	void $InitInstance(); // Function VerseBasicGameplay.basic_player_manager.$InitInstance // (None) // @ game+0xda05cc
	void $InitCDO(); // Function VerseBasicGameplay.basic_player_manager.$InitCDO // (None) // @ game+0xda05cc
};
...
struct Ubasic_player_manager_impl : Ubasic_player_manager {
	...
	struct Utask(:type)* BeginWaitingForEvents(struct Utask(:type)* __verse_0xC1E81372_CallingTask, int64_t __verse_0xA3A00DDB_CallerResumeState, int64_t __verse_0x2AC0E4D8_CallerCancelState, struct Ftuple_L_R __verse_0xB2CDDD72_Argument); // Function VerseBasicGameplay.basic_player_manager_impl.BeginWaitingForEvents // (Public|HasOutParms|BlueprintCallable) // @ game+0xda05cc
	void $InitInstance(); // Function VerseBasicGameplay.basic_player_manager_impl.$InitInstance // (None) // @ game+0xda05cc
	void $InitCDO(); // Function VerseBasicGameplay.basic_player_manager_impl.$InitCDO // (HasDefaults) // @ game+0xda05cc
};
...
struct UPlayerManager : UObject {
	...
	OptionProperty _L_2fEpicGames_2ecom_2fTemporary_2fVerseBasicGameplay_2fPlayerManager_N_RGetPlayerManagerForLocation_L_Nvector3_R(struct Fvector3 __verse_0xB2CDDD72_Argument); // Function VerseBasicGameplay.PlayerManager._L_2fEpicGames_2ecom_2fTemporary_2fVerseBasicGameplay_2fPlayerManager_N_RGetPlayerManagerForLocation_L_Nvector3_R // (Final|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0xda05cc
	void $InitCDO(); // Function VerseBasicGameplay.PlayerManager.$InitCDO // (None) // @ game+0xda05cc
};
...
struct Utask_basic_player_manager_impl$BeginWaitingForEvents : Utask(:type) {
	...
	int64_t Update(); // Function VerseBasicGameplay.task_basic_player_manager_impl$BeginWaitingForEvents.Update // (Public|HasOutParms) // @ game+0xda05cc
};
