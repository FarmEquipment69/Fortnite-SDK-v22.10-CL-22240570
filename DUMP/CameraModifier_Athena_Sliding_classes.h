...
struct UCameraModifier_Athena_Sliding_C : UCameraModifier {
	...
	void BlendOut(); // Function CameraModifier_Athena_Sliding.CameraModifier_Athena_Sliding_C.BlendOut // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_CameraModifier_Athena_Sliding(int32_t EntryPoint); // Function CameraModifier_Athena_Sliding.CameraModifier_Athena_Sliding_C.ExecuteUbergraph_CameraModifier_Athena_Sliding // (Final|UbergraphFunction) // @ game+0xda05cc
};
