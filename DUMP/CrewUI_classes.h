...
struct UBattlePassCrewPurchaseButton : UFortHoldableButton {
	enum class EBattlePassPurchaseButtonCurrencyType CurrencyType; // 0x10b0(0x01)
	char pad_10B1[0x7]; // 0x10b1(0x07)
	struct UCommonTextBlock* Text_Label; // 0x10b8(0x08)
	struct UCommonTextBlock* Text_SecondaryLabel; // 0x10c0(0x08)
	struct UCommonTextBlock* Text_FinalCost; // 0x10c8(0x08)
	struct UWidget* Container_SecondaryLabel; // 0x10d0(0x08)
	char pad_10D8[0x8]; // 0x10d8(0x08)

	void OnCurrencyUpdated(); // Function CrewUI.BattlePassCrewPurchaseButton.OnCurrencyUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UBattlePassCrewPurchaseContainer : UCommonActivatableWidget {
	...
	void OnTriggerIntroAnimation(bool bCanClaimRewards); // Function CrewUI.BattlePassCrewPurchaseContainer.OnTriggerIntroAnimation // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnContentStateUpdated(enum class EBattlePassCrewContentState InState, bool bInScreenOpened); // Function CrewUI.BattlePassCrewPurchaseContainer.OnContentStateUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UBattlePassPurchaseScreen : UCMSBackgroundWidget {
	...
	void OnShowNavButtonNotification(bool bShowNotification); // Function CrewUI.BattlePassPurchaseScreen.OnShowNavButtonNotification // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnSetScreenInteractable(bool bInteractable); // Function CrewUI.BattlePassPurchaseScreen.OnSetScreenInteractable // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnSetNavButtonNotificationText(struct FText& NotificationText); // Function CrewUI.BattlePassPurchaseScreen.OnSetNavButtonNotificationText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnPurchaseStateChanged(enum class EBattlePassPurchaseState InCurrentState); // Function CrewUI.BattlePassPurchaseScreen.OnPurchaseStateChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnPurchaseConfirmed(); // Function CrewUI.BattlePassPurchaseScreen.OnPurchaseConfirmed // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UCrewMultiSubscriptionAlertModal : UCommonActivatableWidget {
	...
	void OnSetHowToCancelURL(struct FString MoreInfoUrl); // Function CrewUI.CrewMultiSubscriptionAlertModal.OnSetHowToCancelURL // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UCrewPriceChangeAcknowledgeModal : UCommonActivatableWidget {
	...
	void OnSetPriceChangeAcknowledgeTitle(struct FText& Title); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeTitle // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnSetPriceChangeAcknowledgeMoreInfoUrl(struct FText& MoreInfoUrl); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeMoreInfoUrl // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnSetPriceChangeAcknowledgeMoreInfoText(struct FText& ConfirmButtonText); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeMoreInfoText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnSetPriceChangeAcknowledgeConfirmButtonText(struct FText& ConfirmButtonText); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeConfirmButtonText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnSetPriceChangeAcknowledgeCheckboxText(struct FText& CheckboxText); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeCheckboxText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnSetPriceChangeAcknowledgeCancelSubscriptionButtonText(struct FText& CancelSubscriptionButtonText); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeCancelSubscriptionButtonText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnSetPriceChangeAcknowledgeBodyText(struct FText& BodyText); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeBodyText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnSetPriceChangeAcknowledgeBodyTable(struct TArray<struct FCrewTableRow>& PriceChangeByRegionRows); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeBodyTable // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnModalBackout(); // Function CrewUI.CrewPriceChangeAcknowledgeModal.OnModalBackout // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExitModal(); // Function CrewUI.CrewPriceChangeAcknowledgeModal.ExitModal // (Final|Native|Protected|BlueprintCallable) // @ game+0x5cb6be8
};
...
struct UCrewPurchaseScreen : UCMSBackgroundWidget {
	...
	void OnUserInformationTextsUpdated(struct FText& UserInformationText1, struct FText& UserInformationText2, enum class EMcpSubscriptionState SubscriptionState); // Function CrewUI.CrewPurchaseScreen.OnUserInformationTextsUpdated // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnUpdateVBuckRefundVisibility(bool bVisible); // Function CrewUI.CrewPurchaseScreen.OnUpdateVBuckRefundVisibility // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnUpdatePurchaseButtonState(enum class ECrewPurchaseButtonState ButtonState); // Function CrewUI.CrewPurchaseScreen.OnUpdatePurchaseButtonState // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnShowNavButtonNotification(bool bShowNotification); // Function CrewUI.CrewPurchaseScreen.OnShowNavButtonNotification // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnSetNavButtonNotificationText(struct FText& NotificationText); // Function CrewUI.CrewPurchaseScreen.OnSetNavButtonNotificationText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnContainerTabVisibilityUpdated(bool bTabsVisible, float SpacingAdjustmentForTabs); // Function CrewUI.CrewPurchaseScreen.OnContainerTabVisibilityUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void EndProgress(); // Function CrewUI.CrewPurchaseScreen.EndProgress // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void BeginProgress(struct FText& ProgressLabel); // Function CrewUI.CrewPurchaseScreen.BeginProgress // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
};

// Class CrewUI.CrewRewardTile
// Size: 0x1080 (Inherited: 0x1020)
struct UCrewRewardTile : UCommonButtonBase {
	char pad_1020[0x40]; // 0x1020(0x40)
	float TileImageStreamoutSeconds; // 0x1060(0x04)
	char pad_1064[0x4]; // 0x1064(0x04)
	struct UImage* Image_TileImage; // 0x1068(0x08)
	struct UCommonTextBlock* Text_TileLabel; // 0x1070(0x08)
	char pad_1078[0x8]; // 0x1078(0x08)

	void OnUpdateOwnedState(bool bOwned); // Function CrewUI.CrewRewardTile.OnUpdateOwnedState // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnStartingDownloadTileImage(); // Function CrewUI.CrewRewardTile.OnStartingDownloadTileImage // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnDownloadTileImageComplete(struct UTexture2D* Texture); // Function CrewUI.CrewRewardTile.OnDownloadTileImageComplete // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	bool IsMonthlyBenefit(); // Function CrewUI.CrewRewardTile.IsMonthlyBenefit // (Final|Native|Protected|BlueprintCallable|BlueprintPure|Const) // @ game+0x685c960
};
...
struct UCrewSubscriptionContentContainer : UCommonActivatableWidget {
	...
	void OnTabSelected(int32_t TabIndex); // Function CrewUI.CrewSubscriptionContentContainer.OnTabSelected // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UCrewTileDetailsTag : UCommonUserWidget {
	...
	void OnTagSetup(enum class ECrewDetailsTag RewardTag, bool bIsOwnedTag); // Function CrewUI.CrewTileDetailsTag.OnTagSetup // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortProgressiveScreenBase : UFortItemPreviewScreen {
	...
	void BP_OnContainerTabVisibilityUpdated(bool bTabsVisible, float SpacingAdjustmentForTabs); // Function CrewUI.FortProgressiveScreenBase.BP_OnContainerTabVisibilityUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortProgressiveItemScreen : UFortProgressiveScreenBase {
	...
	void OnUpdateSubscriptionState(bool bSubscribed); // Function CrewUI.FortProgressiveItemScreen.OnUpdateSubscriptionState // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnSetIsSoloScreen(bool bInIsSoloScreen); // Function CrewUI.FortProgressiveItemScreen.OnSetIsSoloScreen // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnItemSelected(); // Function CrewUI.FortProgressiveItemScreen.OnItemSelected // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnErrorStateTextUpdated(struct FText& ErrorStateText); // Function CrewUI.FortProgressiveItemScreen.OnErrorStateTextUpdated // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortProgressiveItemStateTitleWidget : UUserWidget {
	...
	void BP_OnSetHeaderInfo(struct FText& Subheading, bool bSubscribed, int32_t UnlockedStages, int32_t MaxStages); // Function CrewUI.FortProgressiveItemStateTitleWidget.BP_OnSetHeaderInfo // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
};

// Class CrewUI.FortProgressiveItemWidget
// Size: 0x10b0 (Inherited: 0x1020)
struct UFortProgressiveItemWidget : UCommonButtonBase {
	struct UAthenaItemShopReactiveTileText* TileText_ItemName; // 0x1020(0x08)
	struct FProgressiveStageItemInfo StageItemInfo; // 0x1028(0x70)
	char pad_1098[0x18]; // 0x1098(0x18)

	void OnUnhighlighted(); // Function CrewUI.FortProgressiveItemWidget.OnUnhighlighted // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnTileMaterialLoaded(bool bSubscribed); // Function CrewUI.FortProgressiveItemWidget.OnTileMaterialLoaded // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnStageItemChanged(struct FProgressiveStageItemInfo& InStageItemInfo); // Function CrewUI.FortProgressiveItemWidget.OnStageItemChanged // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnPeekStateChanged(bool bIsInPeekState); // Function CrewUI.FortProgressiveItemWidget.OnPeekStateChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnHighlighted(); // Function CrewUI.FortProgressiveItemWidget.OnHighlighted // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortProgressiveSetDetailsWidget : UUserWidget {
	...
	void BP_OnUpdateSetDetails(struct FText& SetName, struct FText& ExpiringText, bool bCompleted); // Function CrewUI.FortProgressiveSetDetailsWidget.BP_OnUpdateSetDetails // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortProgressiveSetList : UCommonActivatableWidget {
	...
	void ClearSetTiles(); // Function CrewUI.FortProgressiveSetList.ClearSetTiles // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	struct UFortProgressiveSetTile* AddSetTile(); // Function CrewUI.FortProgressiveSetList.AddSetTile // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};

// Class CrewUI.FortProgressiveSetTile
// Size: 0x10d0 (Inherited: 0x1020)
struct UFortProgressiveSetTile : UCommonButtonBase {
	char pad_1020[0xb0]; // 0x1020(0xb0)

	void BP_OnTileMaterialLoaded(bool bSubscribed); // Function CrewUI.FortProgressiveSetTile.BP_OnTileMaterialLoaded // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void BP_OnInitializeSetInfo(struct FProgressiveSetInfo& InSetInfo, struct FText& BottomText, struct FText& BottomSubtext, bool bSubscribed); // Function CrewUI.FortProgressiveSetTile.BP_OnInitializeSetInfo // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortProgressiveStageList : UCommonActivatableWidget {
	...
	void SelectStageInDirection(int32_t Direction); // Function CrewUI.FortProgressiveStageList.SelectStageInDirection // (Final|Native|Public|BlueprintCallable) // @ game+0x68702a4
	void ClearStageWidgets(); // Function CrewUI.FortProgressiveStageList.ClearStageWidgets // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	struct UFortProgressiveStageWidget* AddStageWidget(); // Function CrewUI.FortProgressiveStageList.AddStageWidget // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortProgressiveStageWidget : UCommonUserWidget {
	...
	void OnSetTooltipVisible(bool bVisible); // Function CrewUI.FortProgressiveStageWidget.OnSetTooltipVisible // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnSetTooltipText(struct FText& InToolTipText); // Function CrewUI.FortProgressiveStageWidget.OnSetTooltipText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnPeekStateChanged(bool bIsInPeekState); // Function CrewUI.FortProgressiveStageWidget.OnPeekStateChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ClearStageItemWidgets(); // Function CrewUI.FortProgressiveStageWidget.ClearStageItemWidgets // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	struct UFortProgressiveItemWidget* AddStageItemWidget(); // Function CrewUI.FortProgressiveStageWidget.AddStageItemWidget // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortProgressiveTableOfContentsScreen : UFortProgressiveScreenBase {
	...
	void BP_OnUpdateSubscriptionState(bool bSubscribed); // Function CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateSubscriptionState // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void BP_OnUpdateNumTilesAvailable(int32_t NumTiles); // Function CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateNumTilesAvailable // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void BP_OnUpdateErrorStateText(struct FText& ErrorStateText); // Function CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateErrorStateText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void BP_OnUpdateBanner(struct FText& BannerText, bool bAllSetsCompleted, bool bSubscribed); // Function CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateBanner // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void BP_OnSetDescriptionText(struct FText& ProductDescription); // Function CrewUI.FortProgressiveTableOfContentsScreen.BP_OnSetDescriptionText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
};
