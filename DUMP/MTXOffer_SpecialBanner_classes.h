...
struct UMTXOffer_SpecialBanner_C : UUserWidget {
	...
	void SetupSpecialOfferBanner(bool bHasSale, struct FText SaleText, struct FString BannerOverrideTag, bool bHasBattlePassStars, int32_t iNumOfBattlePassStars); // Function MTXOffer_SpecialBanner.MTXOffer_SpecialBanner_C.SetupSpecialOfferBanner // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_MTXOffer_SpecialBanner(int32_t EntryPoint); // Function MTXOffer_SpecialBanner.MTXOffer_SpecialBanner_C.ExecuteUbergraph_MTXOffer_SpecialBanner // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
