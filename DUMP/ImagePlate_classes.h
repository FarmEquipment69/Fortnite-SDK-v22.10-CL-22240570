...
struct UImagePlateComponent : UPrimitiveComponent {
	...
	void SetImagePlate(struct FImagePlateParameters Plate); // Function ImagePlate.ImagePlateComponent.SetImagePlate // (Final|Native|Public|BlueprintCallable) // @ game+0x6f61244
	void OnRenderTextureChanged(); // Function ImagePlate.ImagePlateComponent.OnRenderTextureChanged // (Final|Native|Public) // @ game+0x6f61230
	struct FImagePlateParameters GetPlate(); // Function ImagePlate.ImagePlateComponent.GetPlate // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6f611f0
};
