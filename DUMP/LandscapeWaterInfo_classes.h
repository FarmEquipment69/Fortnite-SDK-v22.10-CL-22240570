...
struct ALandscapeWaterInfo_C : AActor {
	...
	void ReceiveBeginPlay(); // Function LandscapeWaterInfo.LandscapeWaterInfo_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void Set Flood Water Level(); // Function LandscapeWaterInfo.LandscapeWaterInfo_C.Set Flood Water Level // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_LandscapeWaterInfo(int32_t EntryPoint); // Function LandscapeWaterInfo.LandscapeWaterInfo_C.ExecuteUbergraph_LandscapeWaterInfo // (Final|UbergraphFunction) // @ game+0xda05cc
};
