...
struct AGCNL_Athena_VictoryCrown_CrownWearer_Looping_C : AFortGameplayCueNotify_Loop {
	...
	void GetVisualVolume(bool IsFirstPerson, double& NewParam1); // Function GCNL_Athena_VictoryCrown_CrownWearer_Looping.GCNL_Athena_VictoryCrown_CrownWearer_Looping_C.GetVisualVolume // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0xda05cc
	void Intro Ambient FX Timeline__FinishedFunc(); // Function GCNL_Athena_VictoryCrown_CrownWearer_Looping.GCNL_Athena_VictoryCrown_CrownWearer_Looping_C.Intro Ambient FX Timeline__FinishedFunc // (BlueprintEvent) // @ game+0xda05cc
	void Intro Ambient FX Timeline__UpdateFunc(); // Function GCNL_Athena_VictoryCrown_CrownWearer_Looping.GCNL_Athena_VictoryCrown_CrownWearer_Looping_C.Intro Ambient FX Timeline__UpdateFunc // (BlueprintEvent) // @ game+0xda05cc
	void Intro Flare Timeline__FinishedFunc(); // Function GCNL_Athena_VictoryCrown_CrownWearer_Looping.GCNL_Athena_VictoryCrown_CrownWearer_Looping_C.Intro Flare Timeline__FinishedFunc // (BlueprintEvent) // @ game+0xda05cc
	void Intro Flare Timeline__UpdateFunc(); // Function GCNL_Athena_VictoryCrown_CrownWearer_Looping.GCNL_Athena_VictoryCrown_CrownWearer_Looping_C.Intro Flare Timeline__UpdateFunc // (BlueprintEvent) // @ game+0xda05cc
	void AVIndicatorLoop(); // Function GCNL_Athena_VictoryCrown_CrownWearer_Looping.GCNL_Athena_VictoryCrown_CrownWearer_Looping_C.AVIndicatorLoop // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnRemovalGeneric(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UFXSystemComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents, struct UMatineeCameraShake* BurstCameraShakeInstance, struct ADecalActor* BurstDecalInstance); // Function GCNL_Athena_VictoryCrown_CrownWearer_Looping.GCNL_Athena_VictoryCrown_CrownWearer_Looping_C.OnRemovalGeneric // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	...
	void ExecuteUbergraph_GCNL_Athena_VictoryCrown_CrownWearer_Looping(int32_t EntryPoint); // Function GCNL_Athena_VictoryCrown_CrownWearer_Looping.GCNL_Athena_VictoryCrown_CrownWearer_Looping_C.ExecuteUbergraph_GCNL_Athena_VictoryCrown_CrownWearer_Looping // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
