...
struct UNPCStatusWidgetBar_C : UUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function NPCStatusWidgetBar.NPCStatusWidgetBar_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void SetPercent(double Value); // Function NPCStatusWidgetBar.NPCStatusWidgetBar_C.SetPercent // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_NPCStatusWidgetBar(int32_t EntryPoint); // Function NPCStatusWidgetBar.NPCStatusWidgetBar_C.ExecuteUbergraph_NPCStatusWidgetBar // (Final|UbergraphFunction) // @ game+0xda05cc
};
