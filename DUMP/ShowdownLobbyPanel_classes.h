...
struct UShowdownLobbyPanel_C : UFortTournamentLobbyPanel {
	...
	void InputTypeChanged(bool isGamepad); // Function ShowdownLobbyPanel.ShowdownLobbyPanel_C.InputTypeChanged // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void HandleCrossplayChanged(); // Function ShowdownLobbyPanel.ShowdownLobbyPanel_C.HandleCrossplayChanged // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void UpdateColors(); // Function ShowdownLobbyPanel.ShowdownLobbyPanel_C.UpdateColors // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Refresh(); // Function ShowdownLobbyPanel.ShowdownLobbyPanel_C.Refresh // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void RefreshDataBP(); // Function ShowdownLobbyPanel.ShowdownLobbyPanel_C.RefreshDataBP // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void Construct(); // Function ShowdownLobbyPanel.ShowdownLobbyPanel_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void BndEvt__EventDetailsButton_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature(struct UCommonButtonLegacy* Button); // Function ShowdownLobbyPanel.ShowdownLobbyPanel_C.BndEvt__EventDetailsButton_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature // (BlueprintEvent) // @ game+0xda05cc
	void EventColorize(); // Function ShowdownLobbyPanel.ShowdownLobbyPanel_C.EventColorize // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void PreConstruct(bool IsDesignTime); // Function ShowdownLobbyPanel.ShowdownLobbyPanel_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void BrandingToggle(bool hasBranding); // Function ShowdownLobbyPanel.ShowdownLobbyPanel_C.BrandingToggle // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void EventSwitchUI(enum class ECommonInputType bNewInputType); // Function ShowdownLobbyPanel.ShowdownLobbyPanel_C.EventSwitchUI // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_ShowdownLobbyPanel(int32_t EntryPoint); // Function ShowdownLobbyPanel.ShowdownLobbyPanel_C.ExecuteUbergraph_ShowdownLobbyPanel // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
