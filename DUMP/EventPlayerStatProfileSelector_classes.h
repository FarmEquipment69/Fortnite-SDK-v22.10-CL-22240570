...
struct UEventPlayerStatProfileSelector_C : UFortEventPlayerStatProfileSelector {
	...
	void Set Up Profile Selector Style(struct FFortTournamentDisplayInfo Tournament Display Info); // Function EventPlayerStatProfileSelector.EventPlayerStatProfileSelector_C.Set Up Profile Selector Style // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void BP_OnActivated(); // Function EventPlayerStatProfileSelector.EventPlayerStatProfileSelector_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_EventPlayerStatProfileSelector(int32_t EntryPoint); // Function EventPlayerStatProfileSelector.EventPlayerStatProfileSelector_C.ExecuteUbergraph_EventPlayerStatProfileSelector // (Final|UbergraphFunction) // @ game+0xda05cc
};
