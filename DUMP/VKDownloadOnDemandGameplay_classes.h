...
struct UDownloadOnDemandComponent : UControllerComponent {
	...
	void HandleMnemonicsFromValkyriePaletteProviderReceived(struct TArray<struct FString>& Mnemonics); // Function VKDownloadOnDemandGameplay.DownloadOnDemandComponent.HandleMnemonicsFromValkyriePaletteProviderReceived // (Final|Native|Private|HasOutParms) // @ game+0x6bff05c
};
