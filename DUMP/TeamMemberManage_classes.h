...
struct UTeamMemberManage_C : UFortTeamMemberManage {
	...
	void OnParticipationChanged(bool bIsParticipating); // Function TeamMemberManage.TeamMemberManage_C.OnParticipationChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void BP_OnActivated(); // Function TeamMemberManage.TeamMemberManage_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	...
	void BP_OnDeactivated(); // Function TeamMemberManage.TeamMemberManage_C.BP_OnDeactivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	...
	void OpenBannerEditor(); // Function TeamMemberManage.TeamMemberManage_C.OpenBannerEditor // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_TeamMemberManage(int32_t EntryPoint); // Function TeamMemberManage.TeamMemberManage_C.ExecuteUbergraph_TeamMemberManage // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
