...
struct AGCNL_Athena_Player_Sliding_CameraShake_C : AFortGameplayCueNotify_Loop {
	...
	struct UMatineeCameraShake* matineeCamShake; // 0x988(0x08)
	...
	void Timeline_0__FinishedFunc(); // Function GCNL_Athena_Player_Sliding_CameraShake.GCNL_Athena_Player_Sliding_CameraShake_C.Timeline_0__FinishedFunc // (BlueprintEvent) // @ game+0xda05cc
	void Timeline_0__UpdateFunc(); // Function GCNL_Athena_Player_Sliding_CameraShake.GCNL_Athena_Player_Sliding_CameraShake_C.Timeline_0__UpdateFunc // (BlueprintEvent) // @ game+0xda05cc
	...
	void cameraShakeTimer(); // Function GCNL_Athena_Player_Sliding_CameraShake.GCNL_Athena_Player_Sliding_CameraShake_C.cameraShakeTimer // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnApplicationGeneric(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UFXSystemComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents, struct UMatineeCameraShake* BurstCameraShakeInstance, struct ADecalActor* BurstDecalInstance); // Function GCNL_Athena_Player_Sliding_CameraShake.GCNL_Athena_Player_Sliding_CameraShake_C.OnApplicationGeneric // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_GCNL_Athena_Player_Sliding_CameraShake(int32_t EntryPoint); // Function GCNL_Athena_Player_Sliding_CameraShake.GCNL_Athena_Player_Sliding_CameraShake_C.ExecuteUbergraph_GCNL_Athena_Player_Sliding_CameraShake // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
