...
struct UFortAIComponent_Telemetry : UActorComponent {
	...
	void OnTetheredFollowerChanged(struct AFortPawn* NewFollower, struct AFortPawn* OldFollower); // Function FortniteAI.FortAIComponent_Telemetry.OnTetheredFollowerChanged // (Final|Native|Private) // @ game+0x990fbf8
	void OnPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIComponent_Telemetry.OnPawnDied // (Final|Native|Private|HasDefaults) // @ game+0x990f97c
	void OnDidDamage(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIComponent_Telemetry.OnDidDamage // (Final|Native|Private|HasDefaults) // @ game+0x990f700
	struct UFortAthenaAITelemetryData* GetOrCreateTelemetryData(struct UFortAthenaAITelemetryData* TelemetryDataClass); // Function FortniteAI.FortAIComponent_Telemetry.GetOrCreateTelemetryData // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x990f4b0
};
...
struct AFortAIController : AAIController {
	...
	void WakeUp(); // Function FortniteAI.FortAIController.WakeUp // (Final|Native|Public|BlueprintCallable) // @ game+0x99103ac
	void UnlockMovementResource(); // Function FortniteAI.FortAIController.UnlockMovementResource // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9910378
	void UnlockBehaviorResource(); // Function FortniteAI.FortAIController.UnlockBehaviorResource // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9910344
	void SetupCustomVIM(struct UObject* VIM); // Function FortniteAI.FortAIController.SetupCustomVIM // (Final|Native|Public|BlueprintCallable) // @ game+0x9910290
	void SetTeamInt(char InTeam); // Function FortniteAI.FortAIController.SetTeamInt // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x991018c
	void SetTeam(enum class EFortTeam InTeam); // Function FortniteAI.FortAIController.SetTeam // (Final|Native|Public|BlueprintCallable) // @ game+0x991018c
	void SetPawnAIType(enum class EFortressAIType NewAIType, struct AActor* SpawnSpot); // Function FortniteAI.FortAIController.SetPawnAIType // (Final|Native|Public|BlueprintCallable) // @ game+0x99100a8
	void SetIsSleeping(bool bNewSleepStatus); // Function FortniteAI.FortAIController.SetIsSleeping // (Final|Native|Public|BlueprintCallable) // @ game+0x9910028
	void SetGoalActor(struct AActor* InActor, bool bLocationAlwaysKnown); // Function FortniteAI.FortAIController.SetGoalActor // (Final|Native|Public|BlueprintCallable) // @ game+0x990ff60
	void SetFullPeripheralVision(bool bNewFullPeripheralVision); // Function FortniteAI.FortAIController.SetFullPeripheralVision // (Final|Native|Public|BlueprintCallable) // @ game+0x990fed0
	void SetAlwaysGameplayRelevant(bool bInAlwaysGameplayRelevant); // Function FortniteAI.FortAIController.SetAlwaysGameplayRelevant // (Final|Native|Public|BlueprintCallable) // @ game+0x990fe3c
	void OnBuildingActorGoalDestroyed(); // Function FortniteAI.FortAIController.OnBuildingActorGoalDestroyed // (Final|Native|Public) // @ game+0x990f6e8
	void OnActorGoalDestroyed(struct AActor* DestroyedActor); // Function FortniteAI.FortAIController.OnActorGoalDestroyed // (Final|Native|Public) // @ game+0x990f668
	void LockMovementResource(); // Function FortniteAI.FortAIController.LockMovementResource // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990f634
	void LockBehaviorResource(); // Function FortniteAI.FortAIController.LockBehaviorResource // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990f600
	bool IsIgnoringProximity(struct AFortAIController* FortAIController); // Function FortniteAI.FortAIController.IsIgnoringProximity // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x73d4acc
	bool IsAllowedToSleep(); // Function FortniteAI.FortAIController.IsAllowedToSleep // (Final|Native|Public|BlueprintCallable) // @ game+0x990f5c8
	void IgnoreProximityForDuration(float DurationToIgnore); // Function FortniteAI.FortAIController.IgnoreProximityForDuration // (RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990f540
	struct AActor* GetGoalActor(); // Function FortniteAI.FortAIController.GetGoalActor // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x73d44e4
	struct UFortAIEncounterInfo* GetEncounterInfo(); // Function FortniteAI.FortAIController.GetEncounterInfo // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990f204
	bool CreateBuildingActor(struct ABuildingSMActor* BuildingClass, struct FVector BuildLoc, struct FRotator BuildRot, bool bMirrored); // Function FortniteAI.FortAIController.CreateBuildingActor // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x990f01c
	void ClearAllFocalPoints(); // Function FortniteAI.FortAIController.ClearAllFocalPoints // (Final|Native|Public|BlueprintCallable) // @ game+0x990efbc
};
...
struct UAthenaAIServicePlayerBots : UAthenaAIService {
	...
	struct FScalableFloat MaxNumberOfBotsToSpawnAroundPlayer; // 0x678(0x28)
	float MaxAroundBotDistanceToSearchPOIToLand; // 0x6a0(0x04)
	char pad_6A4[0x4]; // 0x6a4(0x04)
	struct FScalableFloat BackfillEnabled; // 0x6a8(0x28)
	struct FScalableFloat UsePlayerCosmeticForBackfill; // 0x6d0(0x28)
	struct FScalableFloat UsePlayerInventoryForBackfill; // 0x6f8(0x28)
	struct FScalableFloat OnlyUseBackfillDuringSafezones; // 0x720(0x28)
	struct TSoftClassPtr<UObject> BackfillSpawnerData; // 0x748(0x28)
	struct FGameplayTagContainer SupportedItemTags; // 0x770(0x20)
	struct TArray<struct FCachedPOIVolumeLocations> CachedValidPOIVolumeLocations; // 0x790(0x10)
	struct TArray<struct ABuildingFoundation*> CachedBuildingFoundations; // 0x7a0(0x10)
	char pad_7B0[0x158]; // 0x7b0(0x158)
	struct AFortPlayerStartWarmup* LastTeamPlayerStart; // 0x908(0x08)
	char pad_910[0x8]; // 0x910(0x08)
	struct TMap<int32_t, struct UCacheSafeZoneLocation*> CacheSafeZoneLocationsMap; // 0x918(0x50)
	float DeadBotCleanupMinDelay; // 0x968(0x04)
	char pad_96C[0xc]; // 0x96c(0x0c)
	struct TSet<struct FString> ReservedPlayerNames; // 0x978(0x50)
	char pad_9C8[0x8]; // 0x9c8(0x08)
	struct TArray<int32_t> LocationsInSafeZoneFreeIndices; // 0x9d0(0x10)
	char pad_9E0[0x50]; // 0x9e0(0x50)
	struct AFortTeamInfoAthena* CurrentFillingTeam; // 0xa30(0x08)
	char pad_A38[0x58]; // 0xa38(0x58)
	struct FScalableFloat BotsUniqueIDUseValidAccountID; // 0xa90(0x28)
	int32_t CurrentBotControllerUID; // 0xab8(0x04)
	char pad_ABC[0x4]; // 0xabc(0x04)
	struct TArray<struct UFortAthenaBeaconComponent*> BeaconList; // 0xac0(0x10)
	char pad_AD0_0 : 6; // 0xad0(0x01)
	char bWaitForNavmeshToBeLoaded : 1; // 0xad0(0x01)
	char bDoSpawnBotFlow : 1; // 0xad0(0x01)
	char bDoMapSampling : 1; // 0xad1(0x01)
	char pad_AD1_1 : 7; // 0xad1(0x01)
	enum class EAthenaGamePhase GamePhaseToStartSpawning; // 0xad2(0x01)
	char pad_AD3[0x5]; // 0xad3(0x05)
	struct UFortAthenaAISpawnerData* DefaultBotAISpawnerData; // 0xad8(0x08)
	char pad_AE0[0x10]; // 0xae0(0x10)
	struct TSoftObjectPtr<UEnvQuery> EQSMapSampling; // 0xaf0(0x28)
	char pad_B18[0x30]; // 0xb18(0x30)
	struct FScalableFloat CanReviveDownedSquad; // 0xb48(0x28)
	struct UAthenaAIPopulationTracker* CachedAIPopulationTracker; // 0xb70(0x08)
	struct TArray<struct FFortServerBotInfo> PlayerBots; // 0xb78(0x10)
	struct TArray<struct FFortServerBotInfo> NonAthenaParticipantBots; // 0xb88(0x10)
	char pad_B98[0x88]; // 0xb98(0x88)
	struct TSoftObjectPtr<UDataTable> MMRSpawnTable; // 0xc20(0x28)
	struct FMMRSpawningPlayerBotsRuntimeInfo CachedMMRSpawningInfo; // 0xc48(0x38)
	char pad_C80[0x20]; // 0xc80(0x20)
	struct FScalableFloat OverridePOISpreadingSquadCount; // 0xca0(0x28)
	char pad_CC8[0xb8]; // 0xcc8(0xb8)

	struct APawn* SpawnAI(struct FVector& InSpawnLocation, struct FRotator& InSpawnRotation, struct UFortAthenaAISpawnerDataComponentList* AISpawnerComponentList); // Function FortniteAI.AthenaAIServicePlayerBots.SpawnAI // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x990d6a4
	void OnServerGameMemberRemoved(char InSquadId, char InTeamIndex, struct AFortPlayerStateAthena* ChangedPS); // Function FortniteAI.AthenaAIServicePlayerBots.OnServerGameMemberRemoved // (Final|Native|Private) // @ game+0x990d2f4
	void OnSafeZoneUpdated(); // Function FortniteAI.AthenaAIServicePlayerBots.OnSafeZoneUpdated // (Final|Native|Private) // @ game+0x990d2e0
	void OnPawnSpawned(struct APawn* Pawn, int32_t RequestId, bool bIsRespawn); // Function FortniteAI.AthenaAIServicePlayerBots.OnPawnSpawned // (Final|Native|Private) // @ game+0x990d030
	void OnGamePhaseChanged(enum class EAthenaGamePhase NewPhase); // Function FortniteAI.AthenaAIServicePlayerBots.OnGamePhaseChanged // (Native|Protected) // @ game+0x990ceb8
	void OnAgentGameOver(struct AFortAthenaAIBotController* AIBotController, struct AFortPawn* Pawn, struct AController* Instigator); // Function FortniteAI.AthenaAIServicePlayerBots.OnAgentGameOver // (Final|Native|Private) // @ game+0x990cb44
	void KillBots(bool bKillPlayers, bool bKillNoneParticipants, char TeamIndex, struct AActor* BotOwner); // Function FortniteAI.AthenaAIServicePlayerBots.KillBots // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990c7b4
	void JoinTeam(struct AController* SourceTeamController, struct AController* DestinationTeamController); // Function FortniteAI.AthenaAIServicePlayerBots.JoinTeam // (Final|Native|Public|BlueprintCallable) // @ game+0x990c504
	bool IsWeaponSupported(struct AFortWeapon* FortWeapon); // Function FortniteAI.AthenaAIServicePlayerBots.IsWeaponSupported // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x990c3dc
};

// Class FortniteAI.AthenaAIServiceCreativePlayerBots
// Size: 0xdd0 (Inherited: 0xd80)
struct UAthenaAIServiceCreativePlayerBots : UAthenaAIServicePlayerBots {
	struct TMap<struct AActor*, struct APlayerController*> HiringHistory; // 0xd78(0x50)

	struct APlayerController* GetLastHiringPlayer(struct AActor* HiredOwner); // Function FortniteAI.AthenaAIServiceCreativePlayerBots.GetLastHiringPlayer // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990c194
	void ClearHiringHistory(struct AActor* HiredOwner); // Function FortniteAI.AthenaAIServiceCreativePlayerBots.ClearHiringHistory // (Final|Native|Public|BlueprintCallable) // @ game+0x990be90
	void AddHiringHistory(struct AActor* HiredOwner, struct APlayerController* HiringPlayer); // Function FortniteAI.AthenaAIServiceCreativePlayerBots.AddHiringHistory // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990bd04
};

// Class FortniteAI.FortAthenaAIBotController
// Size: 0x1250 (Inherited: 0x3b0)
struct AFortAthenaAIBotController : AAIController {
	...
	struct FString BotIDSuffix; // 0xbd8(0x10)
	struct FString BotPlayerNameWithSkillRating; // 0xbe8(0x10)
	char pad_BF8[0x10]; // 0xbf8(0x10)
	struct UFortAthenaMutator_SpawningPolicyData* PolicyDataSpawner; // 0xc08(0x08)
	char pad_C10[0xd8]; // 0xc10(0xd8)
	struct UFortControllerComponent_Telemetry* FortControllerComponent_Telemetry; // 0xce8(0x08)
	bool bForceUsingBuildingTool; // 0xcf0(0x01)
	bool bForceHolsterWeapon; // 0xcf1(0x01)
	char pad_CF2[0x6]; // 0xcf2(0x06)
	struct UFortWorldItem* PendingEquipWeapon; // 0xcf8(0x08)
	char pad_D00[0x48]; // 0xd00(0x48)
	struct APawn* PlayerToSpectateOnDeath; // 0xd48(0x08)
	struct FMulticastInlineDelegate OnPlayerPawnAISpawnedDelegate; // 0xd50(0x10)
	char pad_D60[0x108]; // 0xd60(0x108)
	struct UAISenseConfig_Sight* AISenseConfig_SightOverride; // 0xe68(0x08)
	char pad_E70[0x10]; // 0xe70(0x10)
	struct AActor* BotOwner; // 0xe80(0x08)
	int32_t BotControllerUID; // 0xe88(0x04)
	char pad_E8C[0x4]; // 0xe8c(0x04)
	struct AFortPlayerPawnAthena* ReviveTarget; // 0xe90(0x08)
	char pad_E98[0x90]; // 0xe98(0x90)
	struct UFortAthenaAIBotCustomizationData* BotData; // 0xf28(0x08)
	struct FDebugMinimapData DebugMinimapData; // 0xf30(0x1b0)
	struct AFortPlayerPawnAthena* RevivePlayerPawnToken; // 0x10e0(0x08)
	char pad_10E8[0x18]; // 0x10e8(0x18)
	struct AActor* LeashActorToFollow; // 0x1100(0x08)
	struct FVector LeashActorToFollowLocalOffset; // 0x1108(0x18)
	struct AFortAthenaAILeashVolume* LeashVolume; // 0x1120(0x08)
	struct UFortGameStateComponent_AffiliationManager* CachedAffiliationManager; // 0x1128(0x08)
	struct UFortActorComponent_Affiliation* CachedAffiliationComponent; // 0x1130(0x08)
	bool bIsAffectedByMutatorHealthAndShieldModifiers; // 0x1138(0x01)
	char pad_1139[0x7]; // 0x1139(0x07)
	bool bHasChangedPawnCullDistanceToAggroMode; // 0x1140(0x01)
	char pad_1141[0x7]; // 0x1141(0x07)
	struct UFortAthenaAIRuntimeParameters_AIBotRespawn* RespawnRuntimeParameters; // 0x1148(0x08)
	struct ABuildingWall* CurrentBlockingDoor; // 0x1150(0x08)
	char pad_1158[0x10]; // 0x1158(0x10)
	struct APawn* FinisherPawn; // 0x1168(0x08)
	char pad_1170[0x54]; // 0x1170(0x54)
	enum class EFortPawnStasisMode PreviousStasisMode; // 0x11c4(0x01)
	bool bPostponeGiveWeaponCheat; // 0x11c5(0x01)
	bool bPostponeGiveMaterialsCheat; // 0x11c6(0x01)
	char pad_11C7[0x1]; // 0x11c7(0x01)
	float StartSpectatingTime; // 0x11c8(0x04)
	char pad_11CC[0x3c]; // 0x11cc(0x3c)
	struct UAthenaDanceItemDefinition* RequestedEmoteAsset; // 0x1208(0x08)
	char pad_1210[0x8]; // 0x1210(0x08)
	struct UBehaviorTree* BTAssetToRunOnPawnAISpawned; // 0x1218(0x08)
	char pad_1220[0x30]; // 0x1220(0x30)

	void UpdateLeashActorToFollowLocation(); // Function FortniteAI.FortAthenaAIBotController.UpdateLeashActorToFollowLocation // (Final|Native|Protected) // @ game+0x991e0b4
	void ThankBusDriver(); // Function FortniteAI.FortAthenaAIBotController.ThankBusDriver // (Final|Native|Protected) // @ game+0x991e0a0
	void SwitchTeam(char TeamIndex); // Function FortniteAI.FortAthenaAIBotController.SwitchTeam // (Final|Native|Public|BlueprintCallable) // @ game+0x991df44
	void StopSecondaryFire(bool bFireWhenStopping); // Function FortniteAI.FortAthenaAIBotController.StopSecondaryFire // (Final|Native|Public|BlueprintCallable) // @ game+0x991de70
	void StopFire(); // Function FortniteAI.FortAthenaAIBotController.StopFire // (Final|Native|Public|BlueprintCallable) // @ game+0x991de5c
	void StopEmote(); // Function FortniteAI.FortAthenaAIBotController.StopEmote // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991de48
	void StartSecondaryFire(); // Function FortniteAI.FortAthenaAIBotController.StartSecondaryFire // (Final|Native|Public|BlueprintCallable) // @ game+0x991ddcc
	void StartFire(); // Function FortniteAI.FortAthenaAIBotController.StartFire // (Final|Native|Public|BlueprintCallable) // @ game+0x991ddb8
	void SetSkillSet(struct UFortAthenaAIBotSkillSet* SkillSetClass); // Function FortniteAI.FortAthenaAIBotController.SetSkillSet // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991dcec
	void SetRadialLeashOuterRadius(float OuterRadius); // Function FortniteAI.FortAthenaAIBotController.SetRadialLeashOuterRadius // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991dc68
	void SetRadialLeashInnerRadius(float InnerRadius); // Function FortniteAI.FortAthenaAIBotController.SetRadialLeashInnerRadius // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991dbe4
	void SetPatrollingEnable(bool bEnable); // Function FortniteAI.FortAthenaAIBotController.SetPatrollingEnable // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991db64
	void SetLeashVolume(struct AFortAthenaAILeashVolume* InLeashVolume); // Function FortniteAI.FortAthenaAIBotController.SetLeashVolume // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991dac8
	void SetLeashReturnLocationMode(enum class ELeashReturnLocationMode ReturnMode); // Function FortniteAI.FortAthenaAIBotController.SetLeashReturnLocationMode // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991da4c
	void SetLeashActorToFollow(struct AActor* ActorToFollow, float LeashLocationUpdateRate, struct FVector LocalOffset); // Function FortniteAI.FortAthenaAIBotController.SetLeashActorToFollow // (Final|BlueprintAuthorityOnly|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x991d93c
	void SetBotOwner(struct AActor* InBotOwner); // Function FortniteAI.FortAthenaAIBotController.SetBotOwner // (Final|Native|Public|BlueprintCallable) // @ game+0x991d8bc
	void RequestEmote(struct FPrimaryAssetId& EmotePrimaryAssetId, float InfiniteEmoteMaxDuration); // Function FortniteAI.FortAthenaAIBotController.RequestEmote // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x991d7e8
	void RemoveSkillSet(struct UFortAthenaAIBotSkillSet* SkillSetClass); // Function FortniteAI.FortAthenaAIBotController.RemoveSkillSet // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991d6e0
	void RemoveEmoteRequest(); // Function FortniteAI.FortAthenaAIBotController.RemoveEmoteRequest // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991d6cc
	void ReleaseBuildTool(); // Function FortniteAI.FortAthenaAIBotController.ReleaseBuildTool // (Final|Native|Protected) // @ game+0x991d6b8
	void QueueStim(struct AActor* SourceActor, struct FVector& SourceLocation, struct FVector& SourceDirection, enum class EStimType NewStimType, float StimStrength, struct FName StimTag); // Function FortniteAI.FortAthenaAIBotController.QueueStim // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x991d4c4
	void PlayEmote(struct FPrimaryAssetId& EmotePrimaryAssetId); // Function FortniteAI.FortAthenaAIBotController.PlayEmote // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x991d438
	void OverrideSkill(float NewSkill); // Function FortniteAI.FortAthenaAIBotController.OverrideSkill // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991d3b4
	void OverrideAggressivenessPlayStyle(bool bInIsAggressive); // Function FortniteAI.FortAthenaAIBotController.OverrideAggressivenessPlayStyle // (Final|Native|Public|BlueprintCallable) // @ game+0x991d328
	void OnTargetPawnDestroyed(); // Function FortniteAI.FortAthenaAIBotController.OnTargetPawnDestroyed // (Final|Native|Public) // @ game+0x991d314
	void OnTargetPawnDead(struct AFortPawn* FortPawn); // Function FortniteAI.FortAthenaAIBotController.OnTargetPawnDead // (Final|Native|Public) // @ game+0x991d294
	void OnTargetPawnDamaged(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnTargetPawnDamaged // (Final|Native|Public|HasDefaults) // @ game+0x502a3f0
	void OnTargetBuildingDestroyed(struct ABuildingActor* Building, struct AAthenaAIController* AIController); // Function FortniteAI.FortAthenaAIBotController.OnTargetBuildingDestroyed // (Final|Native|Public) // @ game+0x991d1d0
	void OnTargetActorDestroyed(struct AActor* DestroyedActor); // Function FortniteAI.FortAthenaAIBotController.OnTargetActorDestroyed // (Final|Native|Public) // @ game+0x991d150
	void OnServerMarkerAdded(struct FFortWorldMarkerData& MarkerData); // Function FortniteAI.FortAthenaAIBotController.OnServerMarkerAdded // (Final|Native|Public|HasOutParms) // @ game+0x991d0ac
	void OnSafeZoneUpdated(); // Function FortniteAI.FortAthenaAIBotController.OnSafeZoneUpdated // (Final|Native|Public) // @ game+0x991d018
	void OnSafezoneStateChanged(enum class EFortSafeZoneState NewState); // Function FortniteAI.FortAthenaAIBotController.OnSafezoneStateChanged // (Final|Native|Public) // @ game+0x991d02c
	void OnPossessedPawnReceiveDamage(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnPossessedPawnReceiveDamage // (Final|Native|Public|HasDefaults) // @ game+0x991cd9c
	void OnPossesedPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnPossesedPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x991cb68
	void OnPerceptionSensed(struct AActor* SourceActor, struct FAIStimulus Stim); // Function FortniteAI.FortAthenaAIBotController.OnPerceptionSensed // (Native|Public) // @ game+0x991ca78
	void OnPawnWeaponChanged(struct AFortWeapon* NewWeapon, struct AFortWeapon* OldWeapon); // Function FortniteAI.FortAthenaAIBotController.OnPawnWeaponChanged // (Final|Native|Public) // @ game+0x991c9b4
	void OnPawnDidDamage(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* HitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnPawnDidDamage // (Final|Native|Public|HasDefaults) // @ game+0x991c738
	void OnMovementModeChange(struct ACharacter* InCharacter, enum class EMovementMode PrevMovementMode, char PreviousCustomMode); // Function FortniteAI.FortAthenaAIBotController.OnMovementModeChange // (Final|Native|Public) // @ game+0x991c5f0
	void OnLaunched(struct FVector LaunchVelocity, bool bXYOverride, bool bZOverride); // Function FortniteAI.FortAthenaAIBotController.OnLaunched // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x991c4d4
	void OnKnockbacked(struct FGameplayTag KnockbackTypeTag); // Function FortniteAI.FortAthenaAIBotController.OnKnockbacked // (Final|Native|Public|BlueprintCallable) // @ game+0x991c454
	void OnGamePhaseStepChanged(struct TScriptInterface<IFortSafeZoneInterface>& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep); // Function FortniteAI.FortAthenaAIBotController.OnGamePhaseStepChanged // (Final|Native|Public|HasOutParms) // @ game+0x991c374
	void OnGamePhaseChanged(enum class EAthenaGamePhase GamePhase); // Function FortniteAI.FortAthenaAIBotController.OnGamePhaseChanged // (Final|Native|Public) // @ game+0x991c2f4
	void OnEndSpectating(struct AFortPlayerStateZone* Spectator); // Function FortniteAI.FortAthenaAIBotController.OnEndSpectating // (Final|Native|Public) // @ game+0x651d860
	void OnCurrentHarvestableDestroyed(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaAIBotController.OnCurrentHarvestableDestroyed // (Final|Native|Protected|HasDefaults) // @ game+0x991c0c8
	void OnBeginSpectating(struct AFortPlayerStateZone* Spectator); // Function FortniteAI.FortAthenaAIBotController.OnBeginSpectating // (Final|Native|Public) // @ game+0x651d860
	void OnAlertLevelChanged(enum class EAlertLevel OldAlertLevel, enum class EAlertLevel NewAlertLevel); // Function FortniteAI.FortAthenaAIBotController.OnAlertLevelChanged // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnAgentDBNO(struct AFortPawn* InPlayer, bool bInIsDBNO); // Function FortniteAI.FortAthenaAIBotController.OnAgentDBNO // (Final|Native|Public) // @ game+0x991c000
	void NotifyPickupsSpawnedOnDeath(struct TArray<struct AFortPickup*>& SpawnedPickups); // Function FortniteAI.FortAthenaAIBotController.NotifyPickupsSpawnedOnDeath // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x65913b0
	bool IsAnAthenaGameParticipant(); // Function FortniteAI.FortAthenaAIBotController.IsAnAthenaGameParticipant // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x991bfe4
	struct UAthenaMarkerComponent* GetMarkerComponent(); // Function FortniteAI.FortAthenaAIBotController.GetMarkerComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x991bfcc
	struct AActor* GetCurrentThreat(); // Function FortniteAI.FortAthenaAIBotController.GetCurrentThreat // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x991bf8c
	struct AActor* GetBotOwner(); // Function FortniteAI.FortAthenaAIBotController.GetBotOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x991bf74
	struct AFortWeapon* EquipWeaponByTag(struct FGameplayTag& WeaponTag); // Function FortniteAI.FortAthenaAIBotController.EquipWeaponByTag // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x991bedc
	struct AFortWeapon* EquipWeapon(struct UFortWorldItem* Weapon); // Function FortniteAI.FortAthenaAIBotController.EquipWeapon // (Final|Native|Public|BlueprintCallable) // @ game+0x991be4c
	struct AFortWeapon* EquipMeleeWeapon(); // Function FortniteAI.FortAthenaAIBotController.EquipMeleeWeapon // (Final|Native|Public|BlueprintCallable) // @ game+0x991bdb4
	struct AFortWeapon* EquipBestWeapon(); // Function FortniteAI.FortAthenaAIBotController.EquipBestWeapon // (Final|Native|Public|BlueprintCallable) // @ game+0x991bd90
	...
	void Cheat_ClearForcedCosmeticItems(); // Function FortniteAI.FortAthenaAIBotController.Cheat_ClearForcedCosmeticItems // (Net|NetReliableNative|Event|Public|NetServer|NetValidate) // @ game+0x991bc20
	void ChangeActiveVariantForCosmeticItem(struct FName ItemTemplateToChange, struct FGameplayTag VariantChannelToChange, struct FGameplayTag DesiredActiveVariant); // Function FortniteAI.FortAthenaAIBotController.ChangeActiveVariantForCosmeticItem // (BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991bb28
	void BlueprintOnBehaviorTreeStarted(); // Function FortniteAI.FortAthenaAIBotController.BlueprintOnBehaviorTreeStarted // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void AddTargetInfos(struct TArray<struct AActor*>& Targets, enum class EPerceptionState PerceptionState, float ForgetTime, float ForgetDistance); // Function FortniteAI.FortAthenaAIBotController.AddTargetInfos // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x991b9b4
	void AddTargetInfo(struct AActor* Target, bool bForceTarget, enum class EPerceptionState PerceptionState, float ForgetTime, float ForgetDistance); // Function FortniteAI.FortAthenaAIBotController.AddTargetInfo // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991b81c
};
...
struct UFortNavModifierComponent : UNavModifierComponent {
	...
	void SetComponentAffectingNavMesh(struct UPrimitiveComponent* InComponentAffectingNavMesh); // Function FortniteAI.FortNavModifierComponent.SetComponentAffectingNavMesh // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x992d1d0
};
...
struct UFortPhysicsObjectNavigationComponent : UFortNavModifierComponent {
	...
	void OnSleepStateChanged(struct UPrimitiveComponent* SimulatingComponent, bool bIsAwake); // Function FortniteAI.FortPhysicsObjectNavigationComponent.OnSleepStateChanged // (Final|RequiredAPI|Native|Protected) // @ game+0x992cdb0
};
...
struct AAIHotSpot : AActor {
	...
	void SetEnabled(bool bEnabled); // Function FortniteAI.AIHotSpot.SetEnabled // (Native|Public|BlueprintCallable) // @ game+0x990ac78
	int32_t RemoveGroupFromHotspot(struct TArray<struct AAIController*> GroupOfAI); // Function FortniteAI.AIHotSpot.RemoveGroupFromHotspot // (Native|Public|BlueprintCallable) // @ game+0x990ab8c
	bool RemoveFromHotspot(struct AAIController* AI, bool bAssignFromWaitingList); // Function FortniteAI.AIHotSpot.RemoveFromHotspot // (Native|Public|BlueprintCallable) // @ game+0x990aac0
	void OnSlotOccupied(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotOccupied // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a9c4
	void OnSlotFreed(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotFreed // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a8c8
	void OnSlotEnabled(int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotEnabled // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a804
	void OnSlotDisabled(int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotDisabled // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a740
	void OnSlotClaimed(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotClaimed // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a644
	void OnSlotBlocked(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnSlotBlocked // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a548
	void OnRemovedSlotlessBehavior(struct AAIController* AI, bool bIsClamingSlot); // Function FortniteAI.AIHotSpot.OnRemovedSlotlessBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a47c
	void OnRemovedBehavior(struct AAIController* AI, int32_t Index, int32_t UserId, enum class EAIHotSpotSlot PrevState, bool bWasOnWaitingList); // Function FortniteAI.AIHotSpot.OnRemovedBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a2f8
	void OnMoveToSlotFinished(struct AAIController* AI, int32_t Index, int32_t UserId, bool bResult); // Function FortniteAI.AIHotSpot.OnMoveToSlotFinished // (BlueprintAuthorityOnly|Native|Event|Protected|BlueprintEvent) // @ game+0x990a1b8
	void OnHotSpotEnabled(); // Function FortniteAI.AIHotSpot.OnHotSpotEnabled // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x1651e44
	void OnHotSpotDisabled(); // Function FortniteAI.AIHotSpot.OnHotSpotDisabled // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x16d0230
	bool OnAssignedSlotlessBehavior(struct AAIController* AI); // Function FortniteAI.AIHotSpot.OnAssignedSlotlessBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a124
	bool OnAssignedOccupiedBehavior(struct AAIController* AI, int32_t Index, int32_t UserId); // Function FortniteAI.AIHotSpot.OnAssignedOccupiedBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x990a024
	bool OnAssignedClaimedBehavior(struct AAIController* AI, int32_t Index, int32_t UserId, bool bWasOnWaitingList); // Function FortniteAI.AIHotSpot.OnAssignedClaimedBehavior // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent) // @ game+0x9909ee0
	bool OccupySlotByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.OccupySlotByIndex // (Native|Public|BlueprintCallable) // @ game+0x76eaec8
	bool IsSlotlessAssignmentAllowed(); // Function FortniteAI.AIHotSpot.IsSlotlessAssignmentAllowed // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909840
	bool IsEnabled(); // Function FortniteAI.AIHotSpot.IsEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909560
	bool IsAIAllowed(struct AAIController* AI); // Function FortniteAI.AIHotSpot.IsAIAllowed // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent|Const) // @ game+0x9909438
	bool HasEnabledSlots(); // Function FortniteAI.AIHotSpot.HasEnabledSlots // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99093f8
	bool HasAssignedAI(struct AAIController* AI, enum class EAIHotSpotAssignmentFilter Filter); // Function FortniteAI.AIHotSpot.HasAssignedAI // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909334
	int32_t GetSlotUserIdByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotUserIdByIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99092a0
	enum class EAIHotSpotSlot GetSlotStateByOwner(struct AAIController* AIOwner); // Function FortniteAI.AIHotSpot.GetSlotStateByOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99091e8
	enum class EAIHotSpotSlot GetSlotStateByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotStateByIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909154
	struct FRotator GetSlotRotationByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotRotationByIndex // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x990909c
	struct AAIController* GetSlotOwnerByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotOwnerByIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908fb0
	struct FVector GetSlotLocationByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotLocationByIndex // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908f10
	int32_t GetSlotIndexByOwner(struct AAIController* AIOwner); // Function FortniteAI.AIHotSpot.GetSlotIndexByOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908e58
	int32_t GetSlotCount(enum class EAIHotSpotSlotFilter Filter); // Function FortniteAI.AIHotSpot.GetSlotCount // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908db4
	struct UAIHotSpotSlot* GetSlotByOwner(struct AAIController* AIOwner); // Function FortniteAI.AIHotSpot.GetSlotByOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908d18
	struct UAIHotSpotSlot* GetSlotByIndex(int32_t Index); // Function FortniteAI.AIHotSpot.GetSlotByIndex // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908c8c
	int32_t GetAssignedAICount(enum class EAIHotSpotAssignmentFilter Filter); // Function FortniteAI.AIHotSpot.GetAssignedAICount // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908b70
	struct TArray<struct AAIController*> GetAssignedAI(enum class EAIHotSpotAssignmentFilter Filter); // Function FortniteAI.AIHotSpot.GetAssignedAI // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908aa4
	struct TArray<int32_t> FindBestSlotIndices(struct TArray<struct AAIController*> AI); // Function FortniteAI.AIHotSpot.FindBestSlotIndices // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99086c4
	int32_t FindBestSlotIndex(struct AAIController* AI); // Function FortniteAI.AIHotSpot.FindBestSlotIndex // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908630
	bool CanUseSlotByIndex(struct AAIController* AI, int32_t Index); // Function FortniteAI.AIHotSpot.CanUseSlotByIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990856c
	bool AssignToSlotByIndex(struct AAIController* AI, int32_t Index); // Function FortniteAI.AIHotSpot.AssignToSlotByIndex // (Native|Public|BlueprintCallable) // @ game+0x9908278
	bool AssignToHotspot(struct AAIController* AI); // Function FortniteAI.AIHotSpot.AssignToHotspot // (Native|Public|BlueprintCallable) // @ game+0x93312c8
	int32_t AssignGroupToHotspot(struct TArray<struct AAIController*> GroupOfAI); // Function FortniteAI.AIHotSpot.AssignGroupToHotspot // (Native|Public|BlueprintCallable) // @ game+0x990818c
	void AssignFromWaitingList(); // Function FortniteAI.AIHotSpot.AssignFromWaitingList // (Final|Native|Public|BlueprintCallable) // @ game+0x9908178
};
...
struct UAIHotSpotSlot : UObject {
	...
	void SetSlotState(enum class EAIHotSpotSlot NewState); // Function FortniteAI.AIHotSpotSlot.SetSlotState // (Native|Public|BlueprintCallable) // @ game+0x990ae48
	void SetSlotOwnerAndState(struct AAIController* NewOwner, enum class EAIHotSpotSlot NewState); // Function FortniteAI.AIHotSpotSlot.SetSlotOwnerAndState // (Native|Public|BlueprintCallable) // @ game+0x990ad80
	void SetSlotEnabled(bool bNewEnabled); // Function FortniteAI.AIHotSpotSlot.SetSlotEnabled // (Native|Public|BlueprintCallable) // @ game+0x990acfc
	void OnStateChanged(struct AAIController* SlotOwner, enum class EAIHotSpotSlot NewState); // Function FortniteAI.AIHotSpotSlot.OnStateChanged // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda05cc
	bool IsEnabled(); // Function FortniteAI.AIHotSpotSlot.IsEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990957c
	bool IsAIAllowed(struct AAIController* AI); // Function FortniteAI.AIHotSpotSlot.IsAIAllowed // (BlueprintAuthorityOnly|Native|Event|Public|BlueprintEvent|Const) // @ game+0x99094cc
	bool HasUserId(); // Function FortniteAI.AIHotSpotSlot.HasUserId // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990941c
	int32_t GetSlotUserId(); // Function FortniteAI.AIHotSpotSlot.GetSlotUserId // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909288
	enum class EAIHotSpotSlot GetSlotState(); // Function FortniteAI.AIHotSpotSlot.GetSlotState // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990913c
	struct FRotator GetSlotRotation(); // Function FortniteAI.AIHotSpotSlot.GetSlotRotation // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9909064
	float GetSlotRadius(); // Function FortniteAI.AIHotSpotSlot.GetSlotRadius // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990904c
	struct AAIController* GetSlotOwner(); // Function FortniteAI.AIHotSpotSlot.GetSlotOwner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6a63824
	struct FVector GetSlotLocation(); // Function FortniteAI.AIHotSpotSlot.GetSlotLocation // (Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908ee8
	int32_t GetSlotIndex(); // Function FortniteAI.AIHotSpotSlot.GetSlotIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x278f394
	float GetSlotHeight(); // Function FortniteAI.AIHotSpotSlot.GetSlotHeight // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908e40
	struct FBox GetSlotBounds(); // Function FortniteAI.AIHotSpotSlot.GetSlotBounds // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908c44
	struct AAIHotSpot* GetHotSpot(); // Function FortniteAI.AIHotSpotSlot.GetHotSpot // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908bfc
	void ClearSlot(); // Function FortniteAI.AIHotSpotSlot.ClearSlot // (Native|Public|BlueprintCallable) // @ game+0x5cf922c
};
...
struct UAIHotSpotSlotGenerator : UObject {
	...
	struct AAIHotSpot* GetHotSpot(); // Function FortniteAI.AIHotSpotSlotGenerator.GetHotSpot // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908bfc
	void GenerateSlots(); // Function FortniteAI.AIHotSpotSlotGenerator.GenerateSlots // (Native|Event|Public|BlueprintEvent) // @ game+0x132bc44
	struct UAIHotSpotSlot* AddSlot(struct FVector& RelativeLocation, struct FRotator& RelativeRotation, struct UAIHotSpotSlot* CustomSlotClass, bool bEnabled); // Function FortniteAI.AIHotSpotSlotGenerator.AddSlot // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9908008
};
...
struct UAthenaAIBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	void MakeBotGroupsTakeEachOtherAsTargets(struct TArray<struct AActor*>& GroupA, struct TArray<struct AActor*>& GroupB, enum class EPerceptionState PerceptionState, float ForgetTime, float ForgetDistance); // Function FortniteAI.AthenaAIBlueprintLibrary.MakeBotGroupsTakeEachOtherAsTargets // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9909d10
	void KillBots(struct UObject* WorldContextObject, bool bKillPlayers, bool bKillNoneParticipants, char TeamIndex, struct AActor* BotOwner); // Function FortniteAI.AthenaAIBlueprintLibrary.KillBots // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9909b54
	void JoinTeam(struct UObject* WorldContextObject, struct AController* SourceTeamController, struct AController* DestinationTeamController); // Function FortniteAI.AthenaAIBlueprintLibrary.JoinTeam // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x99099ec
	bool IsWeaponSupported(struct UObject* WorldContextObject, struct AFortWeapon* FortWeapon); // Function FortniteAI.AthenaAIBlueprintLibrary.IsWeaponSupported // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x990985c
	bool IsItemDefinitionSupported(struct UObject* WorldContextObject, struct UFortItemDefinition* FortItemDef); // Function FortniteAI.AthenaAIBlueprintLibrary.IsItemDefinitionSupported // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable) // @ game+0x9909598
	struct UAthenaAIServicePlayerBots* GetAIServicePlayerBots(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIBlueprintLibrary.GetAIServicePlayerBots // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9908a0c
	struct UAthenaAIServiceLoot* GetAIServiceLoot(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIBlueprintLibrary.GetAIServiceLoot // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9908938
	struct UAthenaAIServiceCreativePlayerBots* GetAIServiceCreativePlayerBots(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIBlueprintLibrary.GetAIServiceCreativePlayerBots // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9908864
	struct UAthenaAIPopulationTracker* GetAIPopulationTracker(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIBlueprintLibrary.GetAIPopulationTracker // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x99087cc
	struct APawn* AthenaSpawnAIFromClass(struct UObject* WorldContextObject, struct APawn* PawnClass, struct UBehaviorTree* BehaviorTree, struct FVector Location, struct FRotator Rotation, bool bNoCollisionFail, struct AActor* Owner); // Function FortniteAI.AthenaAIBlueprintLibrary.AthenaSpawnAIFromClass // (Final|Native|Static|Public|HasDefaults|BlueprintCallable) // @ game+0x9908340
	bool AIPawnFromGAHasLuringPickupAsGoal(struct FGameplayAbilityActorInfo& ActorInfo, struct FGameplayTag GameplayTag, float MaxLifetime, enum class EFortPickupSpawnSource RequiredPickupSpawnSource); // Function FortniteAI.AthenaAIBlueprintLibrary.AIPawnFromGAHasLuringPickupAsGoal // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9907e9c
};
...
struct AFortAIDirector : AActor {
	...
	void UnregisterPatrolWard(struct TScriptInterface<IFortPatrolWardInterface> PatrolWard); // Function FortniteAI.FortAIDirector.UnregisterPatrolWard // (Final|Native|Public|BlueprintCallable) // @ game+0x9912468
	struct UFortAIEncounterInfo* StartEncounter(struct FString& EncounterInstigator, struct UFortDifficultyEncounterSettings* DifficultyEncounterSettings, struct FFortAIEncounterQueryData OptionalQueryData); // Function FortniteAI.FortAIDirector.StartEncounter // (Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x991224c
	void RegisterPatrolWard(struct TScriptInterface<IFortPatrolWardInterface> PatrolWard); // Function FortniteAI.FortAIDirector.RegisterPatrolWard // (Final|Native|Public|BlueprintCallable) // @ game+0x99121bc
	void ReceivePawnSpawned(struct AFortPawn* SpawnedPawn); // Function FortniteAI.FortAIDirector.ReceivePawnSpawned // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void PostDayPhaseChanged(enum class EFortDayPhase CurrentDayPhase, enum class EFortDayPhase PreviousDayPhase, bool bAtCreation); // Function FortniteAI.FortAIDirector.PostDayPhaseChanged // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnRestStarted(); // Function FortniteAI.FortAIDirector.OnRestStarted // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnRampStarted(); // Function FortniteAI.FortAIDirector.OnRampStarted // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnPlayerSpawn(struct AFortPlayerPawn* PlayerPawn); // Function FortniteAI.FortAIDirector.OnPlayerSpawn // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnPlayerDied(struct AFortPlayerPawn* PlayerPawn); // Function FortniteAI.FortAIDirector.OnPlayerDied // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnPeakStarted(); // Function FortniteAI.FortAIDirector.OnPeakStarted // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnPawnDied(struct AFortAIPawn* KilledPawn); // Function FortniteAI.FortAIDirector.OnPawnDied // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnFadeStarted(); // Function FortniteAI.FortAIDirector.OnFadeStarted // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnDirectorDeactivated(); // Function FortniteAI.FortAIDirector.OnDirectorDeactivated // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnDayPhaseChanged(enum class EFortDayPhase CurrentDayPhase, enum class EFortDayPhase PreviousDayPhase, bool bAtCreation); // Function FortniteAI.FortAIDirector.OnDayPhaseChanged // (Native|Public) // @ game+0x99120bc
	bool IsPointTooCloseToPatrolWards(struct FVector& Point, enum class EWardAffectType WardEffectTypeFilter); // Function FortniteAI.FortAIDirector.IsPointTooCloseToPatrolWards // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9911fe0
	bool IsLineTooCloseToPatrolWards(struct FVector& LineStart, struct FVector& LineEnd); // Function FortniteAI.FortAIDirector.IsLineTooCloseToPatrolWards // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9911ef0
	bool IsAnyEncounterGoalWithinDistanceOfPoint(struct FVector& Point, float Distance, bool bOnlyActiveEncounters); // Function FortniteAI.FortAIDirector.IsAnyEncounterGoalWithinDistanceOfPoint // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9911de8
	bool IsAnyAIRelevantToPlayer(struct AFortPlayerPawn* Player); // Function FortniteAI.FortAIDirector.IsAnyAIRelevantToPlayer // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9911a58
	bool IsAnyActiveEncounterRelevantToPlayer(struct AFortPlayerPawn* Player); // Function FortniteAI.FortAIDirector.IsAnyActiveEncounterRelevantToPlayer // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9911d44
	bool IsAnyActiveEncounterRelevantToDefender(struct AFortAIPawn* Defender); // Function FortniteAI.FortAIDirector.IsAnyActiveEncounterRelevantToDefender // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9911ca0
	struct FVector GetVectorFromEncounterDirection(enum class EFortEncounterDirection Direction); // Function FortniteAI.FortAIDirector.GetVectorFromEncounterDirection // (Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x99119c4
	struct TArray<struct ABuildingRift*> GetRiftsFromClosestActiveEncounterTo(struct AActor* Target); // Function FortniteAI.FortAIDirector.GetRiftsFromClosestActiveEncounterTo // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9911868
	int32_t GetNumPlayers(); // Function FortniteAI.FortAIDirector.GetNumPlayers // (BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x75f9610
	int32_t GetNumActiveEncounters(); // Function FortniteAI.FortAIDirector.GetNumActiveEncounters // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9911850
	enum class EFortEncounterDirection GetEncounterDirectionFromVector(struct FVector DirectionVector); // Function FortniteAI.FortAIDirector.GetEncounterDirectionFromVector // (Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x99117c0
	void GetAmbientThreatEncounterSpawnLocations(struct TArray<struct FVector>& AmbientThreatEncounterSpawnLocations); // Function FortniteAI.FortAIDirector.GetAmbientThreatEncounterSpawnLocations // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9911700
	void Deactivate(); // Function FortniteAI.FortAIDirector.Deactivate // (BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x1651e44
	struct TArray<enum class EFortEncounterDirection> ConvertInvalidDirectionsToValidDirections(struct TArray<enum class EFortEncounterDirection> InvalidDirections); // Function FortniteAI.FortAIDirector.ConvertInvalidDirectionsToValidDirections // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x9911610
	void Activate(); // Function FortniteAI.FortAIDirector.Activate // (BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x1f7f57c
};
...
struct AAthenaAIDirector : AFortAIDirector {
	...
	void AggroOnActor(struct AAthenaAIController* AIController, struct AActor* Target); // Function FortniteAI.AthenaAIDirector.AggroOnActor // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x990bdd8
};
...
struct UAthenaAIPerceptionStimuliSourceComponent : UAIPerceptionStimuliSourceComponent {
	...
	void OnOwnerTeamIndexChanged(); // Function FortniteAI.AthenaAIPerceptionStimuliSourceComponent.OnOwnerTeamIndexChanged // (Final|Native|Private) // @ game+0x990d01c
};
...
struct UAthenaAIPopulationTracker : UAISubsystem {
	...
	void OnFortPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.AthenaAIPopulationTracker.OnFortPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x990cc3c
	void OnAISpawned(struct APawn* Pawn, int32_t RequestId); // Function FortniteAI.AthenaAIPopulationTracker.OnAISpawned // (Final|Native|Private) // @ game+0x990c904
	void OnAgentGameOver(struct AFortAthenaAIBotController* AIBotController, struct AFortPawn* Pawn, struct AController* Instigator); // Function FortniteAI.AthenaAIPopulationTracker.OnAgentGameOver // (Final|Native|Private) // @ game+0x990ca24
	int32_t GetNumTotalBots(); // Function FortniteAI.AthenaAIPopulationTracker.GetNumTotalBots // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990c2d4
	int32_t GetNumPlayerBots(); // Function FortniteAI.AthenaAIPopulationTracker.GetNumPlayerBots // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9287338
	int32_t GetNumNonAthenaParticipantBots(); // Function FortniteAI.AthenaAIPopulationTracker.GetNumNonAthenaParticipantBots // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990c2c0
	int32_t GetNumAIPawn(); // Function FortniteAI.AthenaAIPopulationTracker.GetNumAIPawn // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990c2ac
	struct FAIPopulationCountSnapshot GetAIPopulationTrackerCount(); // Function FortniteAI.AthenaAIPopulationTracker.GetAIPopulationTrackerCount // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x990c058
	struct TArray<struct AController*> GetAIMatchingQuery(struct FGameplayTagQuery& TagQuery); // Function FortniteAI.AthenaAIPopulationTracker.GetAIMatchingQuery // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x990bf14
};
...
struct UAthenaAIServiceCover : UAthenaAIService {
	...
	struct UAthenaAIServiceCover* GetAthenaAIServiceCover(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIServiceCover.GetAthenaAIServiceCover // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x990c094
};
...
struct UAthenaAIServiceLOFOccluder : UAthenaAIService {
	...
	void UnregisterOccluder(struct AActor* OccluderActor); // Function FortniteAI.AthenaAIServiceLOFOccluder.UnregisterOccluder // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x990d794
	void RegisterOccluder(struct AActor* OccluderActor, float SphereRadius); // Function FortniteAI.AthenaAIServiceLOFOccluder.RegisterOccluder // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x990d3ec
	bool IsLOFOccluded(struct FVector& StartLocation, struct FVector& EndLocation); // Function FortniteAI.AthenaAIServiceLOFOccluder.IsLOFOccluded // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x990c2ec
	struct UAthenaAIServiceLOFOccluder* GetAthenaAIServiceLOFOccluder(struct UObject* WorldContextObject); // Function FortniteAI.AthenaAIServiceLOFOccluder.GetAthenaAIServiceLOFOccluder // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x990c114
};
...
struct UAthenaAIServiceLoot : UAthenaAIService {
	...
	void UpdateSupplyDropStatus(); // Function FortniteAI.AthenaAIServiceLoot.UpdateSupplyDropStatus // (Final|Native|Private) // @ game+0x990d94c
	void UpdateMovingLoots(); // Function FortniteAI.AthenaAIServiceLoot.UpdateMovingLoots // (Final|Native|Private) // @ game+0x990d938
	void OnGamePhaseStepChanged(struct TScriptInterface<IFortSafeZoneInterface>& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep); // Function FortniteAI.AthenaAIServiceLoot.OnGamePhaseStepChanged // (Final|Native|Public|HasOutParms) // @ game+0x990cf3c
	void K2_RemoveGameplayTagFromLoot(struct AActor* LootActor, struct FGameplayTag& GameplayTag); // Function FortniteAI.AthenaAIServiceLoot.K2_RemoveGameplayTagFromLoot // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x990c6e4
	void K2_AddGameplayTagToLoot(struct AActor* LootActor, struct FGameplayTag& GameplayTag); // Function FortniteAI.AthenaAIServiceLoot.K2_AddGameplayTagToLoot // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x990c614
};
...
struct UAthenaAISpawner : UAISubsystem {
	...
	int32_t RequestSpawn(struct UFortAthenaAISpawnerDataComponentList* AISpawnerComponentList, struct FTransform& SpawnTransform, bool bUrgentRequest); // Function FortniteAI.AthenaAISpawner.RequestSpawn // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x990e64c
	void QueueForDespawn(struct AActor* ActorToDespawn); // Function FortniteAI.AthenaAISpawner.QueueForDespawn // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990e500
	bool CancelRequest(int32_t RequestId); // Function FortniteAI.AthenaAISpawner.CancelRequest // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990db2c
};
...
struct UFortAISystem : UAISystem {
	...
	bool IsInCone2D(struct FVector ConeOrigin, struct FVector ConeDirection, float HalfAngle, struct FVector LocationToCheck); // Function FortniteAI.FortAISystem.IsInCone2D // (Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x991ae64
};
...
struct UAthenaAISystem : UFortAISystem {
	...
	void OnAIPawnSpawned(struct AController* SpawnedController, bool bIsABot, struct AFortPawn* FortAIPawn, struct AFortPlayerPawn* PlayerPawn); // Function FortniteAI.AthenaAISystem.OnAIPawnSpawned // (Final|Native|Protected) // @ game+0x990e3a8
	void OnAIPawnDied(struct AController* KilledController, bool bIsABot, struct AFortPawn* KilledAIPawn, struct AFortPlayerPawn* KilledPlayerPawn, struct AController* KillerController); // Function FortniteAI.AthenaAISystem.OnAIPawnDied // (Final|Native|Protected) // @ game+0x990e210
	void HandlePlayerExitAircraft(struct AController* ExitingController); // Function FortniteAI.AthenaAISystem.HandlePlayerExitAircraft // (Final|Native|Protected) // @ game+0x990de1c
	void HandleGamePhaseStepChanged(struct TScriptInterface<IFortSafeZoneInterface>& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep); // Function FortniteAI.AthenaAISystem.HandleGamePhaseStepChanged // (Final|Native|Protected|HasOutParms) // @ game+0x990dd3c
	void AIProfiling_OnSafeZoneUpdated(); // Function FortniteAI.AthenaAISystem.AIProfiling_OnSafeZoneUpdated // (Final|Native|Public) // @ game+0x21ce104
	void AIProfiling_OnGamePhaseChanged(enum class EAthenaGamePhase GamePhase); // Function FortniteAI.AthenaAISystem.AIProfiling_OnGamePhaseChanged // (Final|Native|Public) // @ game+0x6759234
};
...
struct AAthenaCreativeRift : ABuildingRift {
	...
	void NotifyActorDespawnEndOverlap(struct UPrimitiveComponent* OverlappedComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // Function FortniteAI.AthenaCreativeRift.NotifyActorDespawnEndOverlap // (Final|Native|Public) // @ game+0x990e0d4
	void BlueprintShowRift(); // Function FortniteAI.AthenaCreativeRift.BlueprintShowRift // (RequiredAPI|Event|Public|BlueprintEvent) // @ game+0xda05cc
};
...
struct AAthenaNavInvokerBox : AActor {
	...
	void SetInvokerEnabled(bool bEnable); // Function FortniteAI.AthenaNavInvokerBox.SetInvokerEnabled // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x990e85c
};
...
struct AAthenaNavMesh : AFortNavMesh {
	...
	void MoveTiles(struct FBox& SourceBox, struct FIntPoint& TileOffset, float RotationDeg, struct FVector2D& FillerTilePosition); // Function FortniteAI.AthenaNavMesh.MoveTiles // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x990df60
	void ComputeOffsetForMoveTiles(struct FVector& StartPosition, struct FVector& DesiredPosition, struct FVector& OutEndPosition, struct FIntPoint& OutTileOffset); // Function FortniteAI.AthenaNavMesh.ComputeOffsetForMoveTiles // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x990dbb8
};
...
struct UAthenaNavPresenceDetectorComponent : UActorComponent {
	...
	void OnNavMeshTilesUpdated(struct FUpdatedNavMeshTiles& UpdatedNavMeshTiles); // Function FortniteAI.AthenaNavPresenceDetectorComponent.OnNavMeshTilesUpdated // (Final|Native|Protected|HasOutParms) // @ game+0x50292e0
	bool HasValidNavMeshLocation(); // Function FortniteAI.AthenaNavPresenceDetectorComponent.HasValidNavMeshLocation // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x50292b0
};
...
struct UFortNavSystem : UNavigationSystemV1 {
	...
	void OnNavDataRegistered(struct ANavigationData* NavData); // Function FortniteAI.FortNavSystem.OnNavDataRegistered // (Final|Native|Protected) // @ game+0x992cb7c
	bool IsNavmeshInRadiusInitialized(struct UObject* WorldContext, struct FVector& TestLocation, float TestRadius); // Function FortniteAI.FortNavSystem.IsNavmeshInRadiusInitialized // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x992c7ec
};
...
struct UAthenaNavSystem : UFortNavSystem {
	...
	void UnregisterNavGenerationObserver(struct USceneComponent* Component); // Function FortniteAI.AthenaNavSystem.UnregisterNavGenerationObserver // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable) // @ game+0x990e8dc
	void RegisterNavGenerationObserver(struct USceneComponent* Component, struct FDelegate event); // Function FortniteAI.AthenaNavSystem.RegisterNavGenerationObserver // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable) // @ game+0x990e580
	bool IsInitialNavigationLockActive(struct UObject* WorldContextObject); // Function FortniteAI.AthenaNavSystem.IsInitialNavigationLockActive // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x990de9c
};
...
struct UDespawnExpiredPawnComponent : UFortPawnComponent {
	...
	struct TArray<struct ABuildingRift*> GetDespawnRifts(); // Function FortniteAI.DespawnExpiredPawnComponent.GetDespawnRifts // (Final|Native|Public|BlueprintCallable) // @ game+0x990f190
	void DespawnExpired(); // Function FortniteAI.DespawnExpiredPawnComponent.DespawnExpired // (Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x750c798
	void AddDespawnRift(struct ABuildingRift* NewRift); // Function FortniteAI.DespawnExpiredPawnComponent.AddDespawnRift // (Final|Native|Public|BlueprintCallable) // @ game+0x990eed0
};
...
struct UFortAIComponent_Voice : UActorComponent {
	...
	void SetVoiceSoundBank(struct UFortTaggedSoundBank* InSoundBank); // Function FortniteAI.FortAIComponent_Voice.SetVoiceSoundBank // (Final|Native|Public|BlueprintCallable) // @ game+0x9910210
	struct UFortTaggedSoundBank* GetVoiceSoundBank(); // Function FortniteAI.FortAIComponent_Voice.GetVoiceSoundBank // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x21e8d84
};
...
struct AFortAIDirectorDataManager : AActor {
	...
	void TriggerEvent(struct FFortAIDirectorEvent& TriggeredEvent); // Function FortniteAI.FortAIDirectorDataManager.TriggerEvent // (Native|Public|HasOutParms) // @ game+0x99146e4
	float GetAIDirectorFactorValue(enum class EFortAIDirectorFactor AIDirectorFactor); // Function FortniteAI.FortAIDirectorDataManager.GetAIDirectorFactorValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99133d4
};
...
struct UFortAIEncounterInfo : UObject {
	...
	void UnRegisterAISpawner(struct AActor* InAISpawner); // Function FortniteAI.FortAIEncounterInfo.UnRegisterAISpawner // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9914788
	void SpawnTestAIGroup(struct UFortAISpawnGroup* SpawnGroupToSpawn, struct FVector SpawnLocation, struct FRotator SpawnRotation, struct AActor* SpawnSource, struct TArray<struct UFortAbilitySet*> AbilitySetsToGrantOnSpawn, struct FFortAISpawnGroupUpgradeData UpgradeData, bool bAllowAssigningToExternalSpawners, float SecondsBetweenSpawns); // Function FortniteAI.FortAIEncounterInfo.SpawnTestAIGroup // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x9914400
	struct AFortAIPawn* SpawnAIPawnReservedForEnemySpawner(struct AActor* EnemySpawner, struct FVector SpawnLocation, struct FRotator SpawnRotation); // Function FortniteAI.FortAIEncounterInfo.SpawnAIPawnReservedForEnemySpawner // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x99142d0
	void SetPawnNumberLimit(int32_t InPawnNumberLimit); // Function FortniteAI.FortAIEncounterInfo.SetPawnNumberLimit // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9914254
	void SetNukeWavesAtEncounterEnd(bool bNuke); // Function FortniteAI.FortAIEncounterInfo.SetNukeWavesAtEncounterEnd // (Final|Native|Public|BlueprintCallable) // @ game+0x99141d4
	void SetEncounterActivationState(bool bEncounterActivityState); // Function FortniteAI.FortAIEncounterInfo.SetEncounterActivationState // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9914154
	void RequestActivation(int32_t ActivationDelay); // Function FortniteAI.FortAIEncounterInfo.RequestActivation // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x99140d4
	void RegisterAISpawner(struct AActor* InAISpawner); // Function FortniteAI.FortAIEncounterInfo.RegisterAISpawner // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9914054
	void OnRestStarted(); // Function FortniteAI.FortAIEncounterInfo.OnRestStarted // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnRampStarted(); // Function FortniteAI.FortAIEncounterInfo.OnRampStarted // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnPeakStarted(); // Function FortniteAI.FortAIEncounterInfo.OnPeakStarted // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnGoalTakeDamage(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIEncounterInfo.OnGoalTakeDamage // (Final|Native|Public|HasDefaults) // @ game+0x9913dd8
	void OnGameDifficultyChanged(); // Function FortniteAI.FortAIEncounterInfo.OnGameDifficultyChanged // (Final|Native|Private) // @ game+0x9913dc4
	void OnFadeStarted(); // Function FortniteAI.FortAIEncounterInfo.OnFadeStarted // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnEncounterPawnDamaged(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIEncounterInfo.OnEncounterPawnDamaged // (Final|Native|Protected|HasDefaults) // @ game+0x9913b48
	void NotifyRiftDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIEncounterInfo.NotifyRiftDied // (Final|Native|Public|HasDefaults) // @ game+0x99138cc
	bool GroupHasAIRemainingToSpawn(struct FFortAISpawnerData& FortAISpawnerData); // Function FortniteAI.FortAIEncounterInfo.GroupHasAIRemainingToSpawn // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x99137d0
	int32_t GetPawnNumberLimit(); // Function FortniteAI.FortAIEncounterInfo.GetPawnNumberLimit // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99137b0
	float GetEncounterTimeSeconds(); // Function FortniteAI.FortAIEncounterInfo.GetEncounterTimeSeconds // (Final|Native|Public|BlueprintCallable) // @ game+0x7643264
	void GetEncounterRifts(struct TArray<struct ABuildingRift*>& OutRifts); // Function FortniteAI.FortAIEncounterInfo.GetEncounterRifts // (Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9913714
	struct AActor* GetEncounterQueryActor(); // Function FortniteAI.FortAIEncounterInfo.GetEncounterQueryActor // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9913690
	void GetEncounterGameplayTags(struct FGameplayTagContainer& OutEncounterTags); // Function FortniteAI.FortAIEncounterInfo.GetEncounterGameplayTags // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x99135d8
	struct AFortAIDirectorDataManager* GetEncounterDataManager(); // Function FortniteAI.FortAIEncounterInfo.GetEncounterDataManager // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x99135ac
	void GetEncounterAssignmentGoalActors(struct TArray<struct AActor*>& OutGoalActors); // Function FortniteAI.FortAIEncounterInfo.GetEncounterAssignmentGoalActors // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9913510
	bool GetCurrentSpawnAreaDirections(struct TArray<enum class EFortEncounterDirection>& OutDirections); // Function FortniteAI.FortAIEncounterInfo.GetCurrentSpawnAreaDirections // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9913464
	bool EncounterHasReservedSpawnRequestForEnemySpawner(struct AActor* EnemySpawner); // Function FortniteAI.FortAIEncounterInfo.EncounterHasReservedSpawnRequestForEnemySpawner // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9913298
	void DespawnPendingAndCurrentAI(); // Function FortniteAI.FortAIEncounterInfo.DespawnPendingAndCurrentAI // (Final|Native|Public|BlueprintCallable) // @ game+0x9913260
	struct UFortAIAssignment* CreateEncounterAssignment(struct UFortAIAssignmentSettings* AssignmentSettings, struct AActor* GoalActor); // Function FortniteAI.FortAIEncounterInfo.CreateEncounterAssignment // (Final|Native|Public|BlueprintCallable) // @ game+0x991319c
};
...
struct UFortAIEncounterInfoOwnerInterface : UInterface {
	...
	struct UFortAIEncounterInfo* GetEncounterInfo(); // Function FortniteAI.FortAIEncounterInfoOwnerInterface.GetEncounterInfo // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x208bcdc
};
...
struct UFortAIEncounterRiftManager : UObject {
	...
	void OnRiftDestroyed(struct AActor* Rift); // Function FortniteAI.FortAIEncounterRiftManager.OnRiftDestroyed // (Final|Native|Public) // @ game+0x50299f0
	struct AFortMission* GetAssociatedMission(); // Function FortniteAI.FortAIEncounterRiftManager.GetAssociatedMission // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9915eb0
};
...
struct UFortAIEncounterSequence : UObject {
	...
	void StopCurrentEncounter(); // Function FortniteAI.FortAIEncounterSequence.StopCurrentEncounter // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9917f8c
	struct UFortAIEncounterInfo* StartCurrentEncounterWithSavedData(enum class EFortEncounterSequenceResult& OutRequestResult, int32_t ActivationDelay); // Function FortniteAI.FortAIEncounterSequence.StartCurrentEncounterWithSavedData // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9917eb0
	struct UFortAIEncounterInfo* StartCurrentEncounter(enum class EFortEncounterSequenceResult& OutRequestResult, struct TArray<struct AActor*>& InTargetActors, struct UFortAIAssignmentSettings* InAssignmentSettings, struct FEncounterEnvironmentQueryInfo InOverrideEnvironmentQueryInfo, struct AActor* InOptionalQueryActor, struct FGameplayTagContainer InInjectedTags, struct FFortEncounterSettings InEncounterSettings, int32_t ActivationDelay); // Function FortniteAI.FortAIEncounterSequence.StartCurrentEncounter // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9917b64
	void SetEncounterStartingData(struct TArray<struct AActor*>& InTargetActors, struct UFortAIAssignmentSettings* InAssignmentSettings, struct FEncounterEnvironmentQueryInfo InOverrideEnvironmentQueryInfo, struct AActor* InOptionalQueryActor, struct FGameplayTagContainer InInjectedTags, struct FFortEncounterSettings InEncounterSettings); // Function FortniteAI.FortAIEncounterSequence.SetEncounterStartingData // (Final|BlueprintAuthorityOnly|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x99178ac
	enum class EFortEncounterSequenceResult Previous(); // Function FortniteAI.FortAIEncounterSequence.Previous // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x991731c
	enum class EFortEncounterSequenceResult Next(); // Function FortniteAI.FortAIEncounterSequence.Next // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x99172f8
	enum class EFortEncounterSequenceResult Last(); // Function FortniteAI.FortAIEncounterSequence.Last // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x9916294
	bool IsOnFinalIndexInSequence(); // Function FortniteAI.FortAIEncounterSequence.IsOnFinalIndexInSequence // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9916278
	bool HasEncounter(); // Function FortniteAI.FortAIEncounterSequence.HasEncounter // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99160ec
	int32_t GetNumEncountersInSequence(); // Function FortniteAI.FortAIEncounterSequence.GetNumEncountersInSequence // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7341a0c
	int32_t GetEncounterIndexInSequence(); // Function FortniteAI.FortAIEncounterSequence.GetEncounterIndexInSequence // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d378
	struct UFortAIEncounterInfo* GetCurrentEncounter(); // Function FortniteAI.FortAIEncounterSequence.GetCurrentEncounter // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x68f8914
	bool EncounterBelongsToSequence(struct UFortAIEncounterInfo* InEncounter); // Function FortniteAI.FortAIEncounterSequence.EncounterBelongsToSequence // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9915d8c
};
...
struct UFortAIEncounterTargetInterface : UInterface {
	...
	bool IsFloatingTarget(); // Function FortniteAI.FortAIEncounterTargetInterface.IsFloatingTarget // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	float GetObjectiveCompletionPercentage(); // Function FortniteAI.FortAIEncounterTargetInterface.GetObjectiveCompletionPercentage // (Event|Public|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortAIEnvironmentalDangerSourceInterface : UInterface {
	...
	struct FBox GetDangerSourceBounds(); // Function FortniteAI.FortAIEnvironmentalDangerSourceInterface.GetDangerSourceBounds // (Native|Event|Public|HasDefaults|BlueprintEvent|Const) // @ game+0x9915fa0
	bool GetDangerSourceActive(); // Function FortniteAI.FortAIEnvironmentalDangerSourceInterface.GetDangerSourceActive // (Native|Event|Public|BlueprintEvent|Const) // @ game+0x740dff8
	float GetDangerAtLocation(struct FVector& Location); // Function FortniteAI.FortAIEnvironmentalDangerSourceInterface.GetDangerAtLocation // (Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent|Const) // @ game+0x9915f08
};
...
struct UFortAIFunctionLibrary : UBlueprintFunctionLibrary {
	...
	bool TeleportAIPawn(struct AFortAIPawn* AIPawn, struct FVector DestLocation, struct FRotator DestRotation, bool bIgnoreCollision); // Function FortniteAI.FortAIFunctionLibrary.TeleportAIPawn // (Final|BlueprintAuthorityOnly|Native|Static|Public|HasDefaults|BlueprintCallable) // @ game+0x9917fa0
	void SetHearingRange(struct AActor* AIAgent, float Range); // Function FortniteAI.FortAIFunctionLibrary.SetHearingRange // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x75d6670
	void RequestNavUpdateForBuilding(struct ABuildingActor* BuildingActor); // Function FortniteAI.FortAIFunctionLibrary.RequestNavUpdateForBuilding // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x9917778
	void MakeNoiseEventAtLocation(struct AActor* NoiseMaker, float MaxRange, struct FVector& NoiseLocation, struct FName NoiseTag); // Function FortniteAI.FortAIFunctionLibrary.MakeNoiseEventAtLocation // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x991700c
	void MakeNoiseEvent(struct AActor* NoiseMaker, float MaxRange, struct FName NoiseTag); // Function FortniteAI.FortAIFunctionLibrary.MakeNoiseEvent // (Final|RequiredAPI|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9916d14
	bool IsConcealedByPerceptionModifiers(struct UObject* WorldContextObject, struct FVector ObserverLocation, struct FVector TargetLocation, float& OutConcealment); // Function FortniteAI.FortAIFunctionLibrary.IsConcealedByPerceptionModifiers // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x9916108
	struct UFortAthenaAIRuntimeParameters* GetOrCreateAIRuntimeParameters(struct AAIController* AIController, struct UFortAthenaAIRuntimeParameters* ParametersClass); // Function FortniteAI.FortAIFunctionLibrary.GetOrCreateAIRuntimeParameters // (Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable) // @ game+0x9915fe8
	struct UAthenaAISpawner* GetAISpawner(struct UObject* WorldContextObject); // Function FortniteAI.FortAIFunctionLibrary.GetAISpawner // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x9915e18
};
...
struct AFortAIGoalManager : AActor {
	...
	void SetCurrentGoalDiscouragement(struct UObject* WorldContext, struct AFortAIController* AI); // Function FortniteAI.FortAIGoalManager.SetCurrentGoalDiscouragement // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x99177fc
	void RemoveWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier AssignmentIdentifier); // Function FortniteAI.FortAIGoalManager.RemoveWorldAssignment // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x9917690
	void RemoveGoalsFromWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, struct TArray<struct FFortAIGoalInfo>& GoalInfos); // Function FortniteAI.FortAIGoalManager.RemoveGoalsFromWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9917490
	void RemoveGoalFromWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, struct FFortAIGoalInfo& GoalInfo); // Function FortniteAI.FortAIGoalManager.RemoveGoalFromWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9917340
	void MakeGoalsFromLocationsAndActor(struct TArray<struct FFortAIGoalInfo>& Goals, struct UObject* WorldContextObject, struct TArray<struct FVector>& GoalLocations, struct AActor* GoalActor); // Function FortniteAI.FortAIGoalManager.MakeGoalsFromLocationsAndActor // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9916ad4
	void MakeGoalsFromLocations(struct TArray<struct FFortAIGoalInfo>& Goals, struct UObject* WorldContextObject, struct TArray<struct FVector>& GoalLocations); // Function FortniteAI.FortAIGoalManager.MakeGoalsFromLocations // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x99168d0
	void MakeGoalsFromActors(struct TArray<struct FFortAIGoalInfo>& Goals, struct UObject* WorldContextObject, struct TArray<struct AActor*>& GoalActors, bool bActorsAlwaysPerceived, bool bGoalActorsAllowUndermining); // Function FortniteAI.FortAIGoalManager.MakeGoalsFromActors // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9916650
	void MakeGoalFromLocation(struct FFortAIGoalInfo& Goal, struct UObject* WorldContextObject, struct FVector& GoalLocation); // Function FortniteAI.FortAIGoalManager.MakeGoalFromLocation // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x99164e8
	void MakeGoalFromActor(struct FFortAIGoalInfo& Goal, struct UObject* WorldContextObject, struct AActor* GoalActor, bool bActorAlwaysPerceived, bool bGoalActorAllowsUndermining); // Function FortniteAI.FortAIGoalManager.MakeGoalFromActor // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x99162b8
	void CreateWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier WorldAssignmentIdentifier, struct UFortAIAssignmentSettings* AssignmentSettings, struct UFortAIGoalProvider* GoalProvider, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, enum class EAssignmentCreationResult& CreationResult); // Function FortniteAI.FortAIGoalManager.CreateWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9915b78
	struct UFortAIAssignment* AddWorldAssignment(struct UFortAIAssignmentSettings* AssignmentSettings, struct AActor* GoalActor); // Function FortniteAI.FortAIGoalManager.AddWorldAssignment // (Final|Native|Public|BlueprintCallable) // @ game+0x9915ab4
	void AddGoalToWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, struct FFortAIGoalInfo& GoalInfo); // Function FortniteAI.FortAIGoalManager.AddGoalToWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x9915764
	void AddGoalsToWorldAssignment(struct UObject* WorldContextObject, struct FFortAIAssignmentIdentifier& AssignmentIdentifier, struct TArray<struct FFortAIGoalInfo>& GoalInfos); // Function FortniteAI.FortAIGoalManager.AddGoalsToWorldAssignment // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x99158b4
	void AddGoalActorToAssignment(struct UFortAIAssignment* Assignment, struct AActor* GoalActor); // Function FortniteAI.FortAIGoalManager.AddGoalActorToAssignment // (Final|Native|Public|BlueprintCallable) // @ game+0x9915518
	void AddGoal(struct AActor* GoalActor, struct UFortAIAssignmentSettings* GoalSettings); // Function FortniteAI.FortAIGoalManager.AddGoal // (Final|Native|Public|BlueprintCallable) // @ game+0x9915450
};
...
struct UFortAIGoalProvider : UObject {
	...
	void UpdateGoals(); // Function FortniteAI.FortAIGoalProvider.UpdateGoals // (Native|Public|BlueprintCallable) // @ game+0x6859ae8
	bool InitializeGoalProvider(struct UWorld* ContextWorld, struct UFortAIAssignment* Assignment); // Function FortniteAI.FortAIGoalProvider.InitializeGoalProvider // (Native|Public|BlueprintCallable) // @ game+0x9918920
	struct UFortAIEncounterInfo* GetEncounterInfo(); // Function FortniteAI.FortAIGoalProvider.GetEncounterInfo // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99185ec
};
...
struct UFortAIManagerMinigameComponent : UActorComponent {
	...
	void OnPawnSpawned(struct APawn* Pawn, int32_t RequestId); // Function FortniteAI.FortAIManagerMinigameComponent.OnPawnSpawned // (Final|Native|Public) // @ game+0x9918c98
	void OnPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAIManagerMinigameComponent.OnPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x9918a1c
	void HandleMinigameStarted(); // Function FortniteAI.FortAIManagerMinigameComponent.HandleMinigameStarted // (Final|Native|Public) // @ game+0x99186e8
};
...
struct UFortAIRootAssignmentProviderInterface : UInterface {
	...
	struct FFortAIAssignmentIdentifier GetRootAssignmentIdentifier(); // Function FortniteAI.FortAIRootAssignmentProviderInterface.GetRootAssignmentIdentifier // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99186a0
};
...
struct UFortAISpawnerInterface : UInterface {
	...
	bool OnReceiveSpawnGroup(); // Function FortniteAI.FortAISpawnerInterface.OnReceiveSpawnGroup // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	bool IsReadyToReceiveNewSpawnGroup(); // Function FortniteAI.FortAISpawnerInterface.IsReadyToReceiveNewSpawnGroup // (Event|Public|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortAISpawnerUtilityComponent : UActorComponent {
	...
	void StartEnvironmentQuery(); // Function FortniteAI.FortAISpawnerUtilityComponent.StartEnvironmentQuery // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9919394
	void SetQueryRadius(float Radius); // Function FortniteAI.FortAISpawnerUtilityComponent.SetQueryRadius // (Final|Native|Public|BlueprintCallable) // @ game+0x9919310
	void SetMinigame(struct AFortMinigame* Minigame); // Function FortniteAI.FortAISpawnerUtilityComponent.SetMinigame // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9919284
	void SetEQSQuery(struct TSoftObjectPtr<UEnvQuery> SelectedEQSQuery); // Function FortniteAI.FortAISpawnerUtilityComponent.SetEQSQuery // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x99191c4
	int32_t RequestSpawn(struct UFortAthenaAISpawnerDataComponentList* AISpawnerComponentList, struct FTransform& SpawnTransform); // Function FortniteAI.FortAISpawnerUtilityComponent.RequestSpawn // (Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x99190a4
	void OnUnownedPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAISpawnerUtilityComponent.OnUnownedPawnDied // (Final|Native|Private|HasDefaults) // @ game+0x9918d5c
	bool IsSpawnCountCapped(); // Function FortniteAI.FortAISpawnerUtilityComponent.IsSpawnCountCapped // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x1feab40
	void HandleUnownedPawnSpawned(struct AFortPawn* FortPawn); // Function FortniteAI.FortAISpawnerUtilityComponent.HandleUnownedPawnSpawned // (Final|Native|Public|BlueprintCallable) // @ game+0x99186fc
};
...
struct UFortAISpawnGroup : UPrimaryDataAsset {
	...
	bool IsValidForEnemySpawners(); // Function FortniteAI.FortAISpawnGroup.IsValidForEnemySpawners // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x1f9b38c
	bool IsPrototype(); // Function FortniteAI.FortAISpawnGroup.IsPrototype // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9918a04
	bool IsLargeSpawnGroup(); // Function FortniteAI.FortAISpawnGroup.IsLargeSpawnGroup // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99189ec
	int32_t GetNumberOfEnemies(); // Function FortniteAI.FortAISpawnGroup.GetNumberOfEnemies // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x68f8964
	struct UFortAIPawnVariant* GetEnemy(int32_t EnemyIndex); // Function FortniteAI.FortAISpawnGroup.GetEnemy // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9918618
};
...
struct UFortAITetheringBoxBoundsInterface : UInterface {
	...
	float GetTetheredBoxBoundsWidth(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsWidth // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda05cc
	float GetTetheredBoxBoundsHeight(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsHeight // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda05cc
	float GetTetheredBoxBoundsEQSSpaceBetween(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsEQSSpaceBetween // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda05cc
	float GetTetheredBoxBoundsEQSGridSize(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsEQSGridSize // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|BlueprintEvent) // @ game+0xda05cc
	struct FVector GetTetheredBoxBoundsCenter(); // Function FortniteAI.FortAITetheringBoxBoundsInterface.GetTetheredBoxBoundsCenter // (RequiredAPI|BlueprintAuthorityOnly|Event|Public|HasDefaults|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortAthenaAIBotCosmeticData : UDataAsset {
	...
	struct TSoftObjectPtr<UFortAthenaAIBotCosmeticLibraryData> FindLibraryDataFromName(struct FString PartialName); // Function FortniteAI.FortAthenaAIBotCosmeticData.FindLibraryDataFromName // (Final|Native|Public|BlueprintCallable) // @ game+0x991e5ac
};
...
struct UFortAthenaAIBotCosmeticLibraryData : UPrimaryDataAsset {
	...
	struct TArray<struct UDataTable*> RetrieveDataTables(); // Function FortniteAI.FortAthenaAIBotCosmeticLibraryData.RetrieveDataTables // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x991f170
	struct UDataTable* FindDataTableFromAssetType(struct FString AssetType); // Function FortniteAI.FortAthenaAIBotCosmeticLibraryData.FindDataTableFromAssetType // (Final|Native|Public|BlueprintCallable) // @ game+0x991e448
	bool FillDataTableValuesFromSourceLibrary(struct UFortAthenaAIBotCosmeticLibraryData* SourceLibrary); // Function FortniteAI.FortAthenaAIBotCosmeticLibraryData.FillDataTableValuesFromSourceLibrary // (Final|Native|Public|BlueprintCallable) // @ game+0x991e2b0
};
...
struct UBotCosmeticBlueprintHelperLibrary : UBlueprintFunctionLibrary {
	...
	bool SplitDataArrayByType(struct TArray<struct FString>& InAssetNames, struct TArray<struct FString>& InAssetTypes, struct TArray<int32_t>& InAssetUsageCounts, struct TArray<int32_t>& InAssetTypeSplitIndices, int32_t CurrentSplitIndex, struct FString& OutAssetType, struct TArray<struct FString>& OutAssetNames, struct TArray<int32_t>& OutAssetUsageCounts); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.SplitDataArrayByType // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x991f274
	struct TArray<struct FString> OpenCSVFileDialog(struct FString TitleDetails, bool bAllowMultipleFiles); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.OpenCSVFileDialog // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x991efc8
	bool LoadDataFromCSV(struct FString FilePath, struct TArray<struct FString>& ForbiddenAssetNames, struct TArray<struct FString>& ForbiddenAssetPrefix, struct TArray<struct FString>& AssetNames, struct TArray<struct FString>& AssetTypes, struct TArray<int32_t>& AssetUsageCounts, struct TArray<int32_t>& AssetTypeSplitIndices); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.LoadDataFromCSV // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x991eb28
	bool GenerateWeightedCSV(struct FString AssetTypeName, struct TArray<struct FString>& AssetNames, struct TArray<int32_t>& AssetWeight, struct FString& CSV); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.GenerateWeightedCSV // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x991e778
	bool ExportDataTableToSourceCSV(struct UDataTable* DataTable, bool bCanCheckOutFile); // Function FortniteAI.BotCosmeticBlueprintHelperLibrary.ExportDataTableToSourceCSV // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x991e204
};
...
struct UFortAthenaAIBotCustomizationData : UPrimaryDataAsset {
	...
	void SetCharacterCustomizationFromPlayerPawn(struct AFortPlayerPawn* InFortPawn); // Function FortniteAI.FortAthenaAIBotCustomizationData.SetCharacterCustomizationFromPlayerPawn // (Final|Native|Public|BlueprintCallable) // @ game+0x991f1e4
};
...
struct UFortAthenaAIBotEvaluator_Movement : UFortAthenaAIBotEvaluator {
	...
	void OnCurrentUnstuckSteeringAttemptFinished(enum class EBotUnstuckSteeringReason UnstuckSteeringReason); // Function FortniteAI.FortAthenaAIBotEvaluator_Movement.OnCurrentUnstuckSteeringAttemptFinished // (Final|Native|Private) // @ game+0x991f840
	void EvaluateIsolatedIslandSteering(); // Function FortniteAI.FortAthenaAIBotEvaluator_Movement.EvaluateIsolatedIslandSteering // (Final|Native|Private) // @ game+0x991f750
};
...
struct UFortAthenaAIBotEvaluator_Converted : UFortAthenaAIBotEvaluator_Movement {
	...
	void OnUnconvertedEvent(struct AFortPawn* UnconvertedPawn, enum class EUnconvertReason UnconvertReason); // Function FortniteAI.FortAthenaAIBotEvaluator_Converted.OnUnconvertedEvent // (Final|Native|Protected) // @ game+0x991ef14
	void OnConvertedEvent(struct AFortPawn* InstigatorPawn, struct AFortPawn* ConvertedPawn); // Function FortniteAI.FortAthenaAIBotEvaluator_Converted.OnConvertedEvent // (Final|Native|Protected) // @ game+0x991ee54
};
...
struct UFortAthenaAIBotEvaluator_DBNO : UFortAthenaAIBotEvaluator_Movement {
	...
	void OnAllyPawnDBNOStateChanged(struct AFortPawn* InPlayer, bool bInIsDBNO); // Function FortniteAI.FortAthenaAIBotEvaluator_DBNO.OnAllyPawnDBNOStateChanged // (Final|Native|Private) // @ game+0x991f778
};
...
struct UFortAthenaAIBotEvaluator_EvasiveManeuvers : UFortAthenaAIBotEvaluator {
	...
	void OnMoveCompleted(struct FAIRequestID RequestId, enum class EPathFollowingResult MovementResult); // Function FortniteAI.FortAthenaAIBotEvaluator_EvasiveManeuvers.OnMoveCompleted // (Final|Native|Public) // @ game+0x991f8c0
};
...
struct UFortAthenaAIBotEvaluator_Heal : UFortAthenaAIBotEvaluator {
	...
	void HandlePlayerHealthOrShieldChanged(); // Function FortniteAI.FortAthenaAIBotEvaluator_Heal.HandlePlayerHealthOrShieldChanged // (Final|Native|Private) // @ game+0x991f764
};
...
struct UFortAthenaAIBotEvaluator_Retreat : UFortAthenaAIBotEvaluator_Movement {
	...
	void HandlePlayerHealthOrShieldChanged(); // Function FortniteAI.FortAthenaAIBotEvaluator_Retreat.HandlePlayerHealthOrShieldChanged // (Final|Native|Protected) // @ game+0x991f984
};
...
struct UFortAthenaAIBotEvaluator_SandTunnel : UFortAthenaAIBotEvaluator_TagQuery {
	...
	void OnBotControllerAlertLevelChanged(struct AFortAthenaAIBotController* BotController, enum class EAlertLevel OldAlertLevel, enum class EAlertLevel NewAlertLevel); // Function FortniteAI.FortAthenaAIBotEvaluator_SandTunnel.OnBotControllerAlertLevelChanged // (Final|Native|Private) // @ game+0x991f9ac
	void Jump(); // Function FortniteAI.FortAthenaAIBotEvaluator_SandTunnel.Jump // (Final|Native|Protected) // @ game+0x991f998
};
...
struct UFortAthenaAIBotEvaluator_Storm : UFortAthenaAIBotEvaluator_Movement {
	...
	void OnSafezoneStateChanged(enum class EFortSafeZoneState NewState); // Function FortniteAI.FortAthenaAIBotEvaluator_Storm.OnSafezoneStateChanged // (Final|Native|Public) // @ game+0x991fac4
	void OnSafeZonePhaseChanged(); // Function FortniteAI.FortAthenaAIBotEvaluator_Storm.OnSafeZonePhaseChanged // (Final|Native|Public) // @ game+0x991fab0
};
...
struct UFortAthenaAIBotPathFollowingComponent : UFortPathFollowingComponentBase {
	...
	void HandlePawnTeleported(struct AFortPawn* TeleportedPawn); // Function FortniteAI.FortAthenaAIBotPathFollowingComponent.HandlePawnTeleported // (Final|Native|Public) // @ game+0x992182c
};
...
struct UFortAthenaAISpawnerData : UFortAthenaSpawnerDataBase {
	...
	struct UFortAthenaAISpawnerDataComponent_VoiceBase* GetVoiceComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetVoiceComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924fd0
	struct UFortAthenaAISpawnerDataComponent_SpawnParamsBase* GetSpawnParamsComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetSpawnParamsComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924e58
	struct UFortAthenaAISpawnerDataComponent_SmartObjectBase* GetSmartObjectComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetSmartObjectComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924e1c
	struct UFortAthenaAISpawnerDataComponent_ScriptBase* GetScriptComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetScriptComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924de0
	struct UFortAthenaAISpawnerDataComponent_PerceptionBase* GetPerceptionComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetPerceptionComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924da4
	struct UFortAthenaAISpawnerDataComponent_OptimBase* GetOptimizationComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetOptimizationComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924ca4
	struct UFortAthenaAISpawnerDataComponent_InventoryBase* GetInventoryComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetInventoryComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924bf8
	struct UFortAthenaAISpawnerDataComponent_GroupBase* GetGroupComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetGroupComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924bbc
	struct UFortAthenaAISpawnerDataComponent_GameplayBase* GetGameplayComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetGameplayComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924b80
	struct UFortAthenaAISpawnerDataComponent_GameplayAbilityBase* GetGameplayAbilityComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetGameplayAbilityComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924b44
	struct UFortAthenaAISpawnerDataComponent_DebugBase* GetDebugComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetDebugComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924aec
	struct UFortAthenaAISpawnerDataComponent_CosmeticBase* GetCosmeticComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetCosmeticComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924ab0
	struct UFortAthenaAISpawnerDataComponent_ConversationBase* GetConversationComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetConversationComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924a74
	struct UFortAthenaAISpawnerDataComponent_ChanceEncounterBase* GetChanceEncounterComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetChanceEncounterComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924a38
	struct UFortAthenaAISpawnerDataComponent_BehaviorBase* GetBehaviorComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetBehaviorComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924a00
	struct UFortAthenaAISpawnerDataComponent_AnalyticBase* GetAnalyticComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetAnalyticComponent // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6c1c55c
	struct UFortAthenaAISpawnerDataComponent_LODBase* GetAILODComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetAILODComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924974
	struct UFortAthenaAISpawnerDataComponent_AffiliationBase* GetAffiliationComponent(); // Function FortniteAI.FortAthenaAISpawnerData.GetAffiliationComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99249ac
	struct UFortAthenaAISpawnerDataComponentList* CreateComponentListFromClass(struct UFortAthenaAISpawnerData* AISpawnerDataClass, struct UObject* OuterObject); // Function FortniteAI.FortAthenaAISpawnerData.CreateComponentListFromClass // (Final|RequiredAPI|Native|Static|Public|BlueprintCallable) // @ game+0x99246a8
	struct UFortAthenaAISpawnerDataComponentList* CreateComponentList(struct UObject* OuterObject); // Function FortniteAI.FortAthenaAISpawnerData.CreateComponentList // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924618
};
...
struct UFortAthenaAIBotSpawnerData : UFortAthenaAISpawnerData {
	...
	struct UFortAthenaAISpawnerDataComponent_VehicleBase* GetVehicleComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetVehicleComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992210c
	struct UFortAthenaAISpawnerDataComponent_SkillsetBase* GetSkillSetComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetSkillSetComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99220d0
	struct UFortAthenaAISpawnerDataComponent_PerksBase* GetPerksComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetPerksComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9922094
	struct UFortAthenaAISpawnerDataComponent_CoverBase* GetCoverComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetCoverComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9922058
	struct UFortAthenaAISpawnerDataComponent_ConstructionBase* GetConstructionComponent(); // Function FortniteAI.FortAthenaAIBotSpawnerData.GetConstructionComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992201c
};
...
struct UFortAthenaAIEvaluator_DormantUntilPhase : UFortAthenaAIEvaluator {
	...
	void HandleGamePhaseStepChanged(struct TScriptInterface<IFortSafeZoneInterface>& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep); // Function FortniteAI.FortAthenaAIEvaluator_DormantUntilPhase.HandleGamePhaseStepChanged // (Final|Native|Private|HasOutParms) // @ game+0x9922148
};
...
struct UFortAthenaAILODSettingsContainer : UObject {
	struct TMap<struct UObject*, struct TScriptInterface<IFortAthenaAILODSettings>> ClassToSettings; // 0x28(0x50)
...
struct UFortAthenaAILODComponent : UActorComponent {
	...
	void OnRep_CurrentFortAILODLevel(); // Function FortniteAI.FortAthenaAILODComponent.OnRep_CurrentFortAILODLevel // (Final|Native|Private) // @ game+0x2084fec
};
...
struct UFortAthenaAIRuntimeParametersComponent : UActorComponent {
	...
	struct TMap<struct UObject*, struct UFortAthenaAIRuntimeParameters*> ExtractedRuntimeParameters; // 0xf0(0x50)
};
...
struct UFortAthenaAIRuntimeParameters_SmartObjectBase : UFortAthenaAIRuntimeParameters {
	...
	float GlobalSmartObjectLastUseTimestamp; // 0x98(0x04)
	float GlobalSmartObjectCooldown; // 0x9c(0x04)
};
...
struct UFortAthenaAISpawnerDataComponentList : UObject {
	...
	struct UFortAthenaAISpawnerDataComponentList* OverrideComponentClass(struct UFortAthenaAISpawnerDataComponent* NewComponentSubClass); // Function FortniteAI.FortAthenaAISpawnerDataComponentList.OverrideComponentClass // (Final|Native|Public|BlueprintCallable) // @ game+0x99251bc
	struct UFortAthenaAISpawnerDataComponentList* OverrideComponent(struct UFortAthenaAISpawnerDataComponent* NewComponent); // Function FortniteAI.FortAthenaAISpawnerDataComponentList.OverrideComponent // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x992512c
	struct UFortAthenaAISpawnerDataComponent* GetOrCreateComponentClassForModification(struct UObject* ComponentOuter, struct UFortAthenaAISpawnerDataComponent* ClassToClone); // Function FortniteAI.FortAthenaAISpawnerDataComponentList.GetOrCreateComponentClassForModification // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924ce0
	struct TArray<struct UFortAthenaAISpawnerDataComponent*> GetList(); // Function FortniteAI.FortAthenaAISpawnerDataComponentList.GetList // (Final|Native|Public|BlueprintCallable) // @ game+0x9924c30
};
...
struct UFortAthenaAISpawnerDataComponent_AffiliationBase : UFortAthenaAISpawnerDataComponent {
	...
	void SetFullTeamAwarenessPropagationDistance(float InFullTeamAwarenessMaxDistance); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.SetFullTeamAwarenessPropagationDistance // (Final|Native|Public|BlueprintCallable) // @ game+0x9925440
	void SetFullTeamAwarenessPropagation(bool bInFullTeamAwarenessPropagation); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.SetFullTeamAwarenessPropagation // (Final|Native|Public|BlueprintCallable) // @ game+0x99253bc
	void SetFactionTags(struct FGameplayTagContainer& NewTags); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.SetFactionTags // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9925300
	void SetAwarenessPropagationIsBasedOnAlertLevel(bool bInAwarenessPropagationIsBasedOnAlertLevel); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.SetAwarenessPropagationIsBasedOnAlertLevel // (Final|Native|Public|BlueprintCallable) // @ game+0x9925274
	bool GetFullTeamAwarenessPropagation(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.GetFullTeamAwarenessPropagation // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9924b28
	float GetFullTeamAwarenessMaxDistance(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.GetFullTeamAwarenessMaxDistance // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x742444c
	struct FGameplayTagContainer GetFactionTag(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.GetFactionTag // (Final|Native|Public|BlueprintCallable) // @ game+0x68f8978
	bool GetAwarenessPropagationIsBasedOnAlertLevel(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AffiliationBase.GetAwarenessPropagationIsBasedOnAlertLevel // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x99249e4
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotAffiliation : UFortAthenaAISpawnerDataComponent_AffiliationBase {
	...
	void SetOverrideTeamIndex(int32_t InOverrideTeamIdx); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotAffiliation.SetOverrideTeamIndex // (Final|Native|Public|BlueprintCallable) // @ game+0x99254c4
	bool GetTeamID(int32_t& OutTeamId); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotAffiliation.GetTeamID // (Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9924f30
	bool GetSquadID(int32_t& OutSquadId); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotAffiliation.GetSquadID // (Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9924e90
};
...
struct UFortAthenaAIRuntimeParameters_BehaviorTreeControl : UFortAthenaAIRuntimeParameters {
	...
	bool IsBehaviorTreeBranchActive(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAIRuntimeParameters_BehaviorTreeControl.IsBehaviorTreeBranchActive // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992500c
	void EnableBehaviorTreeBranch(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAIRuntimeParameters_BehaviorTreeControl.EnableBehaviorTreeBranch // (Final|Native|Public|BlueprintCallable) // @ game+0x9924874
	void DisableBehaviorTreeBranch(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAIRuntimeParameters_BehaviorTreeControl.DisableBehaviorTreeBranch // (Final|Native|Public|BlueprintCallable) // @ game+0x992476c
};
...
struct UFortAthenaAISpawnerDataComponent_BehaviorBase : UFortAthenaAISpawnerDataComponent {
	...
	struct UBehaviorTree* GetBehaviorTree(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_BehaviorBase.GetBehaviorTree // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x9926b54
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotBehavior : UFortAthenaAISpawnerDataComponent_Behavior {
	...
	bool IsBehaviorTreeBranchActive(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotBehavior.IsBehaviorTreeBranchActive // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992509c
	void EnableBehaviorTreeBranch(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotBehavior.EnableBehaviorTreeBranch // (Final|Native|Public|BlueprintCallable) // @ game+0x99248f4
	void DisableBehaviorTreeBranch(enum class EBehaviorTreeBranches Behavior); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotBehavior.DisableBehaviorTreeBranch // (Final|Native|Public|BlueprintCallable) // @ game+0x99247f0
};
...
struct UFortAthenaAISpawnerDataComponent_ConstructionBase : UFortAthenaAISpawnerDataComponent {
	...
	bool GetConstructionBuildingInfo(struct FConstructionBuildingList& OutConstructionInfoList); // Function FortniteAI.FortAthenaAISpawnerDataComponent_ConstructionBase.GetConstructionBuildingInfo // (Native|Event|Public|HasOutParms|BlueprintEvent|Const) // @ game+0x9926ba4
};
...
struct UFortAthenaAISpawnerDataComponent_CosmeticBase : UFortAthenaAISpawnerDataComponent {
	...
	void GetFallbackTag(struct FGameplayTag& OutFallbackTag); // Function FortniteAI.FortAthenaAISpawnerDataComponent_CosmeticBase.GetFallbackTag // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9926c78
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotCosmeticBase : UFortAthenaAISpawnerDataComponent_CosmeticBase {
	...
	void GetLoadout(struct FFortAthenaLoadout& OutLoadout); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetLoadout // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9925d54
	void GetDances(struct TArray<struct UAthenaDanceItemDefinition*>& Dances, struct AFortAthenaAIBotController* BotController); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetDances // (Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9925ba4
	void GetCustomCharacterParts(struct TArray<struct UCustomCharacterPart*>& OutCustomCharacterParts); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetCustomCharacterParts // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9925b04
	void GetAnimBPOverride(struct UAnimInstance*& OutAnimBPOverride, int32_t& OutPriority); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetAnimBPOverride // (Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9925a24
	void GetAllLoadouts(struct TArray<struct FFortAthenaLoadout>& OutLoadouts); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotCosmeticBase.GetAllLoadouts // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9925988
};
...
struct UFortAthenaAIRuntimeParameters_AIConvert : UFortAthenaAIRuntimeParameters {
	...
	void SetForceKillWhenUnconverted(bool bInForceKillWhenUnconverted); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.SetForceKillWhenUnconverted // (Final|Native|Public|BlueprintCallable) // @ game+0x9927124
	void SetForceKillWhenConverterDies(bool bInForceKillWhenConverterDies); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.SetForceKillWhenConverterDies // (Final|Native|Public|BlueprintCallable) // @ game+0x99270a8
	void SetCanBeConvertedFromDBNO(bool bInCanBeConvertedFromDBNO); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.SetCanBeConvertedFromDBNO // (Final|Native|Public|BlueprintCallable) // @ game+0x9926f78
	void SetCanBeConverted(bool bInCanBeConverted); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.SetCanBeConverted // (Final|Native|Public|BlueprintCallable) // @ game+0x9926e54
	bool GetForceKillWhenUnconverted(); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.GetForceKillWhenUnconverted // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9926d1c
	bool GetForceKillWhenConverterDies(); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.GetForceKillWhenConverterDies // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9926d08
	bool GetCanBeConvertedFromDBNO(); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.GetCanBeConvertedFromDBNO // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9926b90
	bool GetCanBeConverted(); // Function FortniteAI.FortAthenaAIRuntimeParameters_AIConvert.GetCanBeConverted // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9926b7c
};
...
struct UFortAthenaAISpawnerDataComponent_GameplayBase : UFortAthenaAISpawnerDataComponent {
	...
	bool ShouldOverrideGlobalSpeedMultiplier(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.ShouldOverrideGlobalSpeedMultiplier // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x757f2d0
	void SetCopyConverterSpecificRelations(bool bInCopyConverterSpecificRelations); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.SetCopyConverterSpecificRelations // (Final|Native|Public|BlueprintCallable) // @ game+0x9926ff4
	void SetCanBeConverted(bool bInCanBeConverted); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.SetCanBeConverted // (Final|Native|Public|BlueprintCallable) // @ game+0x9926ed0
	void PostOnSpawnedBP(struct APawn* PawnAI); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.PostOnSpawnedBP // (Event|Public|BlueprintEvent|Const) // @ game+0xda05cc
	float GetGlobalSpeedMultiplier(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayBase.GetGlobalSpeedMultiplier // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9926d30
};

// Class FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay
// Size: 0x5b0 (Inherited: 0x2b8)
struct UFortAthenaAISpawnerDataComponent_AIBotGameplay : UFortAthenaAISpawnerDataComponent_GameplayBase {
	...
	void SetNameSettings(enum class EBotNamingMode InNamingMode, struct FString InName, bool bInAddPlayerIDSuffix); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetNameSettings // (Final|Native|Public|BlueprintCallable) // @ game+0x99260cc
	void SetLeashOuterRadius(float InLeashOuterRadius); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetLeashOuterRadius // (Final|Native|Public|BlueprintCallable) // @ game+0x9926048
	void SetLeashLocation(struct FVector InLeashLocation); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetLeashLocation // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x9925fc0
	void SetLeashInnerRadius(float InLeashInnerRadius); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetLeashInnerRadius // (Final|Native|Public|BlueprintCallable) // @ game+0x9925f3c
	void SetAssociatedPatrolPath(struct AFortAthenaPatrolPath* InAssociatedPatrolPath); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotGameplay.SetAssociatedPatrolPath // (Final|Native|Public|BlueprintCallable) // @ game+0x9925e1c
};
...
struct UFortAthenaAISpawnerDataComponent_GameplayAbilityBase : UFortAthenaAISpawnerDataComponent {
	...
	void SetLooseTagsToApplyToPawn(struct FGameplayTagContainer& InGameplayTagContainer); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayAbilityBase.SetLooseTagsToApplyToPawn // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x99271a0
	struct FGameplayTagContainer GetLooseTagsToApplyToPawn(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayAbilityBase.GetLooseTagsToApplyToPawn // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9926dfc
	void GetInitialGameplayEffects(struct TArray<struct FInitialGameplayEffectInfo>& OutGEs); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayAbilityBase.GetInitialGameplayEffects // (Native|Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9925e9c
	void GetInitialGameplayAbilities(struct TArray<struct UFortAbilitySet*>& OutGASets); // Function FortniteAI.FortAthenaAISpawnerDataComponent_GameplayAbilityBase.GetInitialGameplayAbilities // (Native|Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9926d5c
};
...
struct UFortAthenaAISpawnerDataComponent_InventoryBase : UFortAthenaAISpawnerDataComponent {
	...
	void GetInventoryItems(struct TArray<struct FItemAndCount>& OutList); // Function FortniteAI.FortAthenaAISpawnerDataComponent_InventoryBase.GetInventoryItems // (RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x9926d5c
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotInventory : UFortAthenaAISpawnerDataComponent_InventoryBase {
	...
	void SetInventoryItems(struct TArray<struct FItemAndCount>& InItems); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotInventory.SetInventoryItems // (Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9925e9c
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotPerception : UFortAthenaAISpawnerDataComponent_PerceptionBase {
	...
	void SetVisibilityRange(float InSightRadius, float LoseSightRadius); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotPerception.SetVisibilityRange // (Final|Native|Public|BlueprintCallable) // @ game+0x992634c
};
...
struct UFortAthenaAISpawnerDataComponent_SkillsetBase : UFortAthenaAISpawnerDataComponent {
	...
	bool ShouldUseMatchMMRToOverrideSkillLevel(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SkillsetBase.ShouldUseMatchMMRToOverrideSkillLevel // (Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x757f2d0
	struct TArray<struct UFortAthenaAIBotSkillSet*> GetSkillSets(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SkillsetBase.GetSkillSets // (Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x9927e10
	float GetSkill(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SkillsetBase.GetSkill // (Native|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x9927d80
};
...
struct UFortAthenaAISpawnerDataComponent_AIBotSkillset : UFortAthenaAISpawnerDataComponent_SkillsetBase {
	...
	void SetSkill(float InSKill); // Function FortniteAI.FortAthenaAISpawnerDataComponent_AIBotSkillset.SetSkill // (Final|Native|Public|BlueprintCallable) // @ game+0x99262c8
};
...
struct UFortAthenaAISpawnerDataComponent_CosmeticLibrary : UFortAthenaAISpawnerDataComponent_AIBotCosmeticBase {
	...
	int32_t GetAICosmeticLibraryDataIndex(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_CosmeticLibrary.GetAICosmeticLibraryDataIndex // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9926b2c
	struct UFortAthenaAIBotCosmeticLibraryData* GetAICosmeticLibraryData(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_CosmeticLibrary.GetAICosmeticLibraryData // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9926b04
};
...
struct UFortAthenaAISpawnerDataComponent_LODBase : UFortAthenaAISpawnerDataComponent {
	...
	struct FClientAILODSettings GetClientAILODSettings(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_LODBase.GetClientAILODSettings // (RequiredAPI|Native|Event|Public|BlueprintEvent|Const) // @ game+0x9927cf4
	struct UFortAthenaAILODSettingsContainer* GetAILODSettingsContainer(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_LODBase.GetAILODSettingsContainer // (Native|Event|Public|BlueprintEvent|Const) // @ game+0x2016fa0
};
...
struct UFortAthenaAISpawnerDataComponent_SpawnParamsBase : UFortAthenaAISpawnerDataComponent {
	...
	bool ShouldSpawnInAir(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.ShouldSpawnInAir // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x757ffa8
	bool ShouldCheckForOverlaps(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.ShouldCheckForOverlaps // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9928130
	float GetSpawnTracePadding(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetSpawnTracePadding // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9927e88
	struct TArray<struct UFortAthenaAISpawnerData*> GetSpawnerDataSpawnedAsChildren(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetSpawnerDataSpawnedAsChildren // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9927eb4
	struct FDataTableRowHandle GetPawnStatHandle(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetPawnStatHandle // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9927ddc
	struct APawn* GetPawnClass(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetPawnClass // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9927dac
	float GetInAirSpawnTraceStartHeight(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetInAirSpawnTraceStartHeight // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9927d80
	float GetInAirSpawnTraceSphereRadius(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetInAirSpawnTraceSphereRadius // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9926d30
	float GetInAirSpawnTraceEndHeight(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetInAirSpawnTraceEndHeight // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9927d54
	struct AAIController* GetAIControllerClass(); // Function FortniteAI.FortAthenaAISpawnerDataComponent_SpawnParamsBase.GetAIControllerClass // (RequiredAPI|Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x9927cc4
};
...
struct UFortAthenaAlertStateComponent : UActorComponent {
	...
	void SetStealthMeterTargetTime(float InStealthMeterTargetTime); // Function FortniteAI.FortAthenaAlertStateComponent.SetStealthMeterTargetTime // (Final|Native|Public|BlueprintCallable) // @ game+0x99280ac
	void SetStealthMeterTarget(float InStealthMeterTarget); // Function FortniteAI.FortAthenaAlertStateComponent.SetStealthMeterTarget // (Final|Native|Public|BlueprintCallable) // @ game+0x9928028
	void OnStealthMeterChanged(struct AFortAthenaAIBotController* BotController, float StealthMeterTarget, float StealthMeterTargetTime); // Function FortniteAI.FortAthenaAlertStateComponent.OnStealthMeterChanged // (Final|Native|Public) // @ game+0x9927f2c
	float GetStealthMeterTargetTime(); // Function FortniteAI.FortAthenaAlertStateComponent.GetStealthMeterTargetTime // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6a6380c
	float GetStealthMeterTarget(); // Function FortniteAI.FortAthenaAlertStateComponent.GetStealthMeterTarget // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7643264
};
...
struct UFortAthenaBTService_ManageWeapon : UBTService {
	...
	void ManageWeaponTargeting(struct UBehaviorTreeComponent* OwnerComp); // Function FortniteAI.FortAthenaBTService_ManageWeapon.ManageWeaponTargeting // (Final|Native|Protected|Const) // @ game+0x9928158
};
...
struct UFortAthenaBTService_Slide : UBTService {
	...
	void OnStopSliding(struct AFortPlayerPawn* Pawn); // Function FortniteAI.FortAthenaBTService_Slide.OnStopSliding // (Final|Native|Private) // @ game+0x9928278
};
...
struct UFortAthenaLeashComponent : UActorComponent {
	...
	void SetLeashRadius(float NewRadius); // Function FortniteAI.FortAthenaLeashComponent.SetLeashRadius // (Final|Native|Public|BlueprintCallable) // @ game+0x502c030
	bool IsInsideLeash(struct FVector& Location); // Function FortniteAI.FortAthenaLeashComponent.IsInsideLeash // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928d44
	float GetLeashRadius(); // Function FortniteAI.FortAthenaLeashComponent.GetLeashRadius // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928ba4
	struct FVector GetLeashCenter(); // Function FortniteAI.FortAthenaLeashComponent.GetLeashCenter // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928b7c
};
...
struct AFortAthenaLocalGameplayBehavior : AActor {
	...
	void OnExecute(struct AActor* Activator); // Function FortniteAI.FortAthenaLocalGameplayBehavior.OnExecute // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnAbort(); // Function FortniteAI.FortAthenaLocalGameplayBehavior.OnAbort // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void FinishExecute(); // Function FortniteAI.FortAthenaLocalGameplayBehavior.FinishExecute // (Final|Native|Public|BlueprintCallable) // @ game+0x9928ae4
};
...
struct UFortAthenaNpcGalileoComponent : UActorComponent {
	...
	void SetPatrolPath(struct TArray<struct FVector>& NewPatrolPath); // Function FortniteAI.FortAthenaNpcGalileoComponent.SetPatrolPath // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x9929474
	void SetCommunicationGroup(struct TArray<struct AFortAthenaAIBotController*>& AIBotControllerList); // Function FortniteAI.FortAthenaNpcGalileoComponent.SetCommunicationGroup // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x99293d4
	void OnPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortAthenaNpcGalileoComponent.OnPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x992912c
	struct TArray<struct FVector> GetPatrolPath(); // Function FortniteAI.FortAthenaNpcGalileoComponent.GetPatrolPath // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928bd8
	struct TArray<struct AFortAthenaAIBotController*> GetCommunicationGroup(); // Function FortniteAI.FortAthenaNpcGalileoComponent.GetCommunicationGroup // (Final|Native|Public|BlueprintCallable) // @ game+0x9928b3c
};
...
struct UFortAthenaNpcPatrollingComponent : UActorComponent {
	...
	void UpdateCurrentDestinationToNearestNextPoint(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.UpdateCurrentDestinationToNearestNextPoint // (Final|Native|Public|BlueprintCallable) // @ game+0x992966c
	void SetPatrolPath(struct AFortAthenaPatrolPath* NewPatrolPath, bool bOrientationAlreadyRandomized); // Function FortniteAI.FortAthenaNpcPatrollingComponent.SetPatrolPath // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x9929518
	void SelectNextPatrolPoint(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.SelectNextPatrolPoint // (Final|Native|Public|BlueprintCallable) // @ game+0x99293c0
	bool IsPatrollingEnable(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.IsPatrollingEnable // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928dd8
	bool IsCurrentPatrolPointAnEndPoint(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.IsCurrentPatrolPointAnEndPoint // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928d00
	int32_t GetPatrolPointsCount(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.GetPatrolPointsCount // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928cd8
	struct AFortAthenaPatrolPath* GetPatrolPath(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.GetPatrolPath // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7512b40
	struct AFortAthenaPatrolPoint* GetCurrentPatrolPoint(); // Function FortniteAI.FortAthenaNpcPatrollingComponent.GetCurrentPatrolPoint // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928b58
	bool FindAndSetDynamicPatrolPath(struct FFortAthenaAIObjectTrackerQuery& FindQuery, bool bOrientationAlreadyRandomized, bool bExcludeCurrentlyUsedPatrolPath); // Function FortniteAI.FortAthenaNpcPatrollingComponent.FindAndSetDynamicPatrolPath // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x99289a4
};
...
struct AFortAthenaPatrolPath : AActor {
	...
	void SetPatrolPathEnabled(bool bIsEnabled); // Function FortniteAI.FortAthenaPatrolPath.SetPatrolPathEnabled // (Final|Native|Public|BlueprintCallable) // @ game+0x99295e0
	void OnCurrentPlaylistLoaded(struct FName PlaylistName, struct FGameplayTagContainer& PlaylistContextTags); // Function FortniteAI.FortAthenaPatrolPath.OnCurrentPlaylistLoaded // (Final|Native|Protected|HasOutParms) // @ game+0x9928df0
	void GetPatrolPoints(struct TArray<struct AFortAthenaPatrolPoint*>& OutPatrolPoints); // Function FortniteAI.FortAthenaPatrolPath.GetPatrolPoints // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928bf4
	bool CanBeUsed(); // Function FortniteAI.FortAthenaPatrolPath.CanBeUsed // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x9928978
};
...
struct UFortAthenaTrackableAIObjectComponent : UActorComponent {
	...
	struct UObject* CustomRegistrationClass; // 0xd8(0x08)
};
...
struct UFortAthenaTrackableAIObjectVehicleComponent : UFortAthenaTrackableAIObjectComponent {
	...
	void HandleSleepStateChanged(bool bIsAwake); // Function FortniteAI.FortAthenaTrackableAIObjectVehicleComponent.HandleSleepStateChanged // (Final|Native|Private) // @ game+0x9929874
};
...
struct UFortBotMissionLogic : UObject {
	...
	struct AFortBotStructureBuilder* SpawnStructureBuilder(struct AActor* MissionGoal, struct UFortBuildingInstructions* BuildingInstructions); // Function FortniteAI.FortBotMissionLogic.SpawnStructureBuilder // (Final|Native|Public|BlueprintCallable) // @ game+0x9929fb8
	void SetGoalsInvulnerable(bool bGodMode); // Function FortniteAI.FortBotMissionLogic.SetGoalsInvulnerable // (Final|Native|Public|BlueprintCallable) // @ game+0x9929f38
	void SetCurrentBehavior(struct UBehaviorTree* Behavior); // Function FortniteAI.FortBotMissionLogic.SetCurrentBehavior // (Final|Native|Public|BlueprintCallable) // @ game+0x9929eb8
	void ResetBehavior(); // Function FortniteAI.FortBotMissionLogic.ResetBehavior // (Final|Native|Public|BlueprintCallable) // @ game+0x9929dc0
	void OnMissionStarted(); // Function FortniteAI.FortBotMissionLogic.OnMissionStarted // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnMissionFinished(); // Function FortniteAI.FortBotMissionLogic.OnMissionFinished // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnMissionActivated(); // Function FortniteAI.FortBotMissionLogic.OnMissionActivated // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	bool OnInteractWithMissionGoal(struct AFortAIController* BotAI, struct AActor* MissionGoal); // Function FortniteAI.FortBotMissionLogic.OnInteractWithMissionGoal // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	bool OnCanStartOtherMission(struct AFortAIController* BotAI, struct AFortMission* OtherMission); // Function FortniteAI.FortBotMissionLogic.OnCanStartOtherMission // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnAssignedBehavior(struct AFortAIController* BotAI); // Function FortniteAI.FortBotMissionLogic.OnAssignedBehavior // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void MarkSingleLocator(struct AActor* LocatorActor); // Function FortniteAI.FortBotMissionLogic.MarkSingleLocator // (Final|Native|Public|BlueprintCallable) // @ game+0x9929940
	void MarkAllLocated(); // Function FortniteAI.FortBotMissionLogic.MarkAllLocated // (Final|Native|Public|BlueprintCallable) // @ game+0x99298f4
	void ClearAllLocated(); // Function FortniteAI.FortBotMissionLogic.ClearAllLocated // (Final|Native|Public|BlueprintCallable) // @ game+0x9929844
};
...
struct AFortBotStructureBuilder : AActor {
	...
	void RunDeconstructor(); // Function FortniteAI.FortBotStructureBuilder.RunDeconstructor // (Final|Native|Public|BlueprintCallable) // @ game+0x9929e38
	void OnBuildingDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortBotStructureBuilder.OnBuildingDied // (Final|Native|Protected|HasDefaults) // @ game+0x9929b44
	void BuildAll(); // Function FortniteAI.FortBotStructureBuilder.BuildAll // (Final|Native|Public|BlueprintCallable) // @ game+0x9929830
};
...
struct UFortBTDecorator_GameplayAbility_CompareDistance : UFortBTDecorator_QueryGameplayAbility {
	struct TArray<struct FDistanceToTargetComparison> DistanceComparisons; // 0xd8(0x10)
};
...
struct UFortBTDecorator_GameplayAbility_HasNearbyPawns : UFortBTDecorator_QueryGameplayAbility {
	float NearbyPawnDistance; // 0xd8(0x04)
	bool bFilterAIPawns; // 0xdc(0x01)
	bool bFilterPlayerPawns; // 0xdd(0x01)
...
struct UFortBTDecorator_IsMoving : UFortBTDecorator_QueryGameplayAbility {
	float UpdateInterval; // 0xd8(0x04)
	float MinTime; // 0xdc(0x04)
	bool bUseMinDist; // 0xe0(0x01)
	char pad_E1[0x3]; // 0xe1(0x03)
	float MinDistMinTime; // 0xe4(0x04)
	struct FDistanceToTargetComparison MinDistanceComparison; // 0xe8(0x38)
};
...
struct UFortBTTask_GameMoveTo : UBTTask_MoveTo {
	...
	char bDeimosFlavor : 1; // 0xec(0x01)
...
struct UFortCollisionResponseSwapperComponent : UActorComponent {
	...
	void UnregisterCallbacksForOverlap(); // Function FortniteAI.FortCollisionResponseSwapperComponent.UnregisterCallbacksForOverlap // (Final|Native|Protected|BlueprintCallable) // @ game+0x445acd8
	void RestoreCollisionResponses(); // Function FortniteAI.FortCollisionResponseSwapperComponent.RestoreCollisionResponses // (Final|Native|Protected) // @ game+0x992ae38
	void RegisterCallbacksForOverlap(struct UPrimitiveComponent* InCollisionPrimitiveComponent, struct UPrimitiveComponent* InOverlapPrimitiveComponent); // Function FortniteAI.FortCollisionResponseSwapperComponent.RegisterCallbacksForOverlap // (Final|Native|Protected|BlueprintCallable) // @ game+0x445aab8
	void HandleEndOverlap(struct UPrimitiveComponent* OverlappedComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex); // Function FortniteAI.FortCollisionResponseSwapperComponent.HandleEndOverlap // (Final|Native|Protected) // @ game+0x992a6f4
	void HandleBeginOverlap(struct UPrimitiveComponent* OverlappedComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult); // Function FortniteAI.FortCollisionResponseSwapperComponent.HandleBeginOverlap // (Final|Native|Protected|HasOutParms) // @ game+0x992a4b0
};
...
struct UFortCreativeCreatureManagerInfoComponent : UFortMinigameLogicComponent {
	...
	void SetWeaponKnockbackImmunityEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetWeaponKnockbackImmunityEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x992b780
	void SetWeaponKnockbackImmunity(bool InImmuneToWeaponKnockback); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetWeaponKnockbackImmunity // (Final|Native|Public|BlueprintCallable) // @ game+0x992b700
	void SetScorePoints(int32_t InScorePoints); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetScorePoints // (Final|Native|Public|BlueprintCallable) // @ game+0x992b684
	void SetScoreDistribution(enum class EScoreDistributionType InScoreDistribution); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetScoreDistribution // (Final|Native|Public|BlueprintCallable) // @ game+0x992b608
	void SetOverrideDamage(float InOverrideDamage); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetOverrideDamage // (Final|Native|Public|BlueprintCallable) // @ game+0x992b584
	void SetMovementSpeedOverrideEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMovementSpeedOverrideEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x992b504
	void SetMovementSpeedMultiplier(float InOverrideMovementSpeedMultiplier); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMovementSpeedMultiplier // (Final|Native|Public|BlueprintCallable) // @ game+0x992b480
	void SetMovementOverrideTag(struct FGameplayTag tag); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMovementOverrideTag // (Final|Native|Public|BlueprintCallable) // @ game+0x992b404
	void SetMaxHealthOverrideTag(struct FGameplayTag tag); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMaxHealthOverrideTag // (Final|Native|Public|BlueprintCallable) // @ game+0x992b388
	void SetMaxHealthOverrideEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMaxHealthOverrideEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x992b308
	void SetMaxHealth(int32_t InMaxHealth); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetMaxHealth // (Final|Native|Public|BlueprintCallable) // @ game+0x992b28c
	void SetHearingAggroRange(float InHearingAggroRange); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetHearingAggroRange // (Final|Native|Public|BlueprintCallable) // @ game+0x992b208
	void SetEnvironmentalDamageOverrideEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetEnvironmentalDamageOverrideEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x992b188
	void SetEnvironmentalDamageOverride(float InOverrideDamage); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetEnvironmentalDamageOverride // (Final|Native|Public|BlueprintCallable) // @ game+0x992b104
	void SetDamageOverrideTag(struct FGameplayTag tag); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetDamageOverrideTag // (Final|Native|Public|BlueprintCallable) // @ game+0x992b088
	void SetDamageOverrideEffect(struct UGameplayEffect* Effect); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetDamageOverrideEffect // (Final|Native|Public|BlueprintCallable) // @ game+0x992b008
	void SetCreatureManagerComponent(struct UFortCreativeCreatureManagerComponent* InCreatureManagerComponent); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetCreatureManagerComponent // (Final|Native|Public|BlueprintCallable) // @ game+0x992af88
	void SetCreatureBlueprintClass(struct TSoftClassPtr<UObject> InCreatureBlueprintClass); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetCreatureBlueprintClass // (Final|Native|Public|BlueprintCallable) // @ game+0x992aec8
	void SetAffectedTargetsType(enum class ECreatureManagerAffectedTargets InAffectedTargetsType); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.SetAffectedTargetsType // (Final|Native|Public|BlueprintCallable) // @ game+0x992ae4c
	void ResetWeaponKnockbackImmunity(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetWeaponKnockbackImmunity // (Final|Native|Public|BlueprintCallable) // @ game+0x992ae20
	void ResetScorePoints(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetScorePoints // (Final|Native|Public|BlueprintCallable) // @ game+0x992ae08
	void ResetScoreDistribution(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetScoreDistribution // (Final|Native|Public|BlueprintCallable) // @ game+0x992adf0
	void ResetOverrideDamage(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetOverrideDamage // (Final|Native|Public|BlueprintCallable) // @ game+0x992add8
	void ResetMovementSpeedMultiplier(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetMovementSpeedMultiplier // (Final|Native|Public|BlueprintCallable) // @ game+0x992adc0
	void ResetMaxHealth(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetMaxHealth // (Final|Native|Public|BlueprintCallable) // @ game+0x992ada8
	void ResetHearingAggroRange(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetHearingAggroRange // (Final|Native|Public|BlueprintCallable) // @ game+0x992ad90
	void ResetEnvironmentalDamageOverride(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.ResetEnvironmentalDamageOverride // (Final|Native|Public|BlueprintCallable) // @ game+0x992ad78
	bool GetWeaponKnockbackImmunity(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetWeaponKnockbackImmunity // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992a498
	int32_t GetScorePoints(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetScorePoints // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7435e44
	enum class EScoreDistributionType GetScoreDistribution(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetScoreDistribution // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992a480
	float GetOverrideDamage(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetOverrideDamage // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992a468
	float GetMovementSpeedMultiplier(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetMovementSpeedMultiplier // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992a450
	int32_t GetMaxHealth(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetMaxHealth // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x24d88b8
	float GetHearingAggroRange(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetHearingAggroRange // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x7435e2c
	float GetEnvironmentalDamageOverride(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetEnvironmentalDamageOverride // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992a438
	struct UFortCreativeCreatureManagerComponent* GetCreatureManagerComponent(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetCreatureManagerComponent // (Final|Native|Public|BlueprintCallable) // @ game+0x992a420
	struct TSoftClassPtr<UObject> GetCreatureBlueprintClass(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetCreatureBlueprintClass // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992a2ec
	enum class ECreatureManagerAffectedTargets GetAffectedTargetsType(); // Function FortniteAI.FortCreativeCreatureManagerInfoComponent.GetAffectedTargetsType // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x992a2d4
};
...
struct UFortCreativeCreatureManagerComponent : UActorComponent {
	...
	void OnInfoComponentRemoved(struct UFortCreativeCreatureManagerInfoComponent* CreatureManagerInfoComponent); // Function FortniteAI.FortCreativeCreatureManagerComponent.OnInfoComponentRemoved // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x992acdc
	void OnInfoComponentAdded(struct UFortCreativeCreatureManagerInfoComponent* CreatureManagerInfoComponent); // Function FortniteAI.FortCreativeCreatureManagerComponent.OnInfoComponentAdded // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x992ac30
	void OnAIPawnDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortCreativeCreatureManagerComponent.OnAIPawnDied // (Final|Native|Public|HasDefaults) // @ game+0x992a830
};
...
struct AFortCreativePatrolPath : AFortAthenaPatrolPath {
	...
	void SetPatrolHasValidNavMesh(bool bValidNavMesh); // Function FortniteAI.FortCreativePatrolPath.SetPatrolHasValidNavMesh // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x502ccb0
	bool HasPatrolValidNavMesh(); // Function FortniteAI.FortCreativePatrolPath.HasPatrolValidNavMesh // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x502cc90
};
...
struct AFortEnemySpawn : ABuildingActor {
	float ClusterRadius; // 0x778(0x04)
...
struct UFortEnvQueryManager : UEnvQueryManager {
	...
	void OnGamePhaseChanged(enum class EAthenaGamePhase GamePhase); // Function FortniteAI.FortEnvQueryManager.OnGamePhaseChanged // (Final|Native|Protected) // @ game+0x992bf0c
};
...
struct AFortEQSPrevisActor : AActor {
	...
	void SetQueryTemplate(struct UEnvQuery* InPrevisQueryTemplate); // Function FortniteAI.FortEQSPrevisActor.SetQueryTemplate // (Final|Native|Public|BlueprintCallable) // @ game+0x651d860
	void PrepForPrevis(); // Function FortniteAI.FortEQSPrevisActor.PrepForPrevis // (Event|Public|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortInfluenceMap : UObject {
	...
	void K2_GetInfluenceSourcePositions(struct UObject* WorldContext, struct TArray<struct FVector>& InfluenceSourcePositions); // Function FortniteAI.FortInfluenceMap.K2_GetInfluenceSourcePositions // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x992be0c
	void K2_AddInfluenceSource(struct UObject* WorldContext, struct FVector& Position, struct FString SourceName, float Strength); // Function FortniteAI.FortInfluenceMap.K2_AddInfluenceSource // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x992bbf8
};
...
struct UFortNavPathRendererComponent : UActorComponent {
	...
	int32_t CurrentPathColorIndex; // 0x118(0x04)
	char pad_11C[0x4]; // 0x11c(0x04)

	void UpdatePathsVisualOnClient(); // Function FortniteAI.FortNavPathRendererComponent.UpdatePathsVisualOnClient // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x992d250
	void OnRep_PathPointsUpdated(); // Function FortniteAI.FortNavPathRendererComponent.OnRep_PathPointsUpdated // (Final|Native|Private) // @ game+0x992cc70
	void OnRep_ColorIndexUpdated(); // Function FortniteAI.FortNavPathRendererComponent.OnRep_ColorIndexUpdated // (Final|Native|Private) // @ game+0x992cc5c
	void DeactivateFX(); // Function FortniteAI.FortNavPathRendererComponent.DeactivateFX // (Final|RequiredAPI|Native|Public|BlueprintCallable) // @ game+0x992c6b8
};
...
struct UFortPatrolWardInterface : UInterface {
	...
	enum class EWardAffectType GetAffectingType(); // Function FortniteAI.FortPatrolWardInterface.GetAffectingType // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent|Const) // @ game+0xda05cc
	float GetAffectingDistance(); // Function FortniteAI.FortPatrolWardInterface.GetAffectingDistance // (BlueprintAuthorityOnly|Event|Public|BlueprintEvent|Const) // @ game+0xda05cc
};
...
struct UFortPawnComponent_AIBotPingCommand : UFortPawnComponent_PingCommand {
	...
	void OnServerMarkerRemoved(struct FMarkerID MarkerID); // Function FortniteAI.FortPawnComponent_AIBotPingCommand.OnServerMarkerRemoved // (Final|Native|Public) // @ game+0x992cd28
	void OnServerMarkerAdded(struct FFortWorldMarkerData& MarkerData); // Function FortniteAI.FortPawnComponent_AIBotPingCommand.OnServerMarkerAdded // (Final|Native|Public|HasOutParms) // @ game+0x992cc84
	void HandleOnNPCUnconvertEvent(struct AFortPawn* UnconvertedFortPawn, enum class EUnconvertReason UnconvertReason); // Function FortniteAI.FortPawnComponent_AIBotPingCommand.HandleOnNPCUnconvertEvent // (Final|Native|Public) // @ game+0x992c730
};
...
struct UFortPawnComponent_AIFormation : UFortPawnComponent {
	...
	void OnUserDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortPawnComponent_AIFormation.OnUserDied // (Final|Native|Private|HasDefaults) // @ game+0x992ce78
};
...
struct UFortPawnComponent_AIGroup : UFortPawnComponent {
	...
	void OnGroupMemberDied(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function FortniteAI.FortPawnComponent_AIGroup.OnGroupMemberDied // (Final|Native|Private|HasDefaults) // @ game+0x992c900
};
...
struct UFortQueryTwoPointSolver : UObject {
	...
	void Start(struct UObject* Querier); // Function FortniteAI.FortQueryTwoPointSolver.Start // (Final|Native|Public|BlueprintCallable) // @ game+0x992d930
	void SkipToNextPointA(); // Function FortniteAI.FortQueryTwoPointSolver.SkipToNextPointA // (Final|Native|Public|BlueprintCallable) // @ game+0x992d918
	void SetCustomRotationA(struct FRotator& Rotation); // Function FortniteAI.FortQueryTwoPointSolver.SetCustomRotationA // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x992d880
	void OnCustomRotationMode(struct FVector& InPointA, struct FVector Querier); // Function FortniteAI.FortQueryTwoPointSolver.OnCustomRotationMode // (Event|Public|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0xda05cc
	struct FRotator GetRandomRotationOffset(); // Function FortniteAI.FortQueryTwoPointSolver.GetRandomRotationOffset // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x992d848
	void AddNamedFloatParamB(struct FName ParamName, float Value); // Function FortniteAI.FortQueryTwoPointSolver.AddNamedFloatParamB // (Final|Native|Public|BlueprintCallable) // @ game+0x992d74c
	void AddNamedFloatParamA(struct FName ParamName, float Value); // Function FortniteAI.FortQueryTwoPointSolver.AddNamedFloatParamA // (Final|Native|Public|BlueprintCallable) // @ game+0x992d650
};
...
struct AFortThreatVisualsManager : AActor {
	...
	bool StormsExist(); // Function FortniteAI.FortThreatVisualsManager.StormsExist // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x993eafc
	void SetMinimumCloudAltitude(float NewMinimumAltitude); // Function FortniteAI.FortThreatVisualsManager.SetMinimumCloudAltitude // (Final|Native|Public|BlueprintCallable) // @ game+0x929e8f4
	void SetCloudsAreHidden(bool bHide); // Function FortniteAI.FortThreatVisualsManager.SetCloudsAreHidden // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x993ea64
	void ResetMinimumCloudAltitude(); // Function FortniteAI.FortThreatVisualsManager.ResetMinimumCloudAltitude // (Final|Native|Public|BlueprintCallable) // @ game+0x993ea4c
	void OnWorldReady(); // Function FortniteAI.FortThreatVisualsManager.OnWorldReady // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnThreatCloudsChanged(struct TArray<struct FThreatLocationInfo>& ThreatLocationInfo); // Function FortniteAI.FortThreatVisualsManager.OnThreatCloudsChanged // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnRep_ThreatLocations(); // Function FortniteAI.FortThreatVisualsManager.OnRep_ThreatLocations // (Final|Native|Private) // @ game+0x16d0230
	void OnRep_StormWinds(); // Function FortniteAI.FortThreatVisualsManager.OnRep_StormWinds // (Final|Native|Private) // @ game+0x2133fe0
	void OnRep_HideClouds(); // Function FortniteAI.FortThreatVisualsManager.OnRep_HideClouds // (Final|Native|Private) // @ game+0x1651e44
	void OnRep_GoalActorLocations(); // Function FortniteAI.FortThreatVisualsManager.OnRep_GoalActorLocations // (Final|Native|Private) // @ game+0x1651d1c
	void OnBeginThreatVisualsPrecursor(struct AActor* SourceActor, struct FVector& EndLocation); // Function FortniteAI.FortThreatVisualsManager.OnBeginThreatVisualsPrecursor // (BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0xda05cc
	struct TArray<struct FThreatLocationInfo> GetThreatClouds(); // Function FortniteAI.FortThreatVisualsManager.GetThreatClouds // (Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x993e9b8
	struct AThreatCloud* GetThreatCloud(struct FThreatLocationInfo& ThreatLocInfo); // Function FortniteAI.FortThreatVisualsManager.GetThreatCloud // (Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x993e8c4
	bool GetCloudsAreHidden(); // Function FortniteAI.FortThreatVisualsManager.GetCloudsAreHidden // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x993e8ac
	void BeginThreatVisualsPrecursor(struct AActor* SourceActor, struct FVector ThreatLocation); // Function FortniteAI.FortThreatVisualsManager.BeginThreatVisualsPrecursor // (Net|NetReliableNative|Event|NetMulticast|Public|HasDefaults) // @ game+0x993e7d0
};
...
struct AThreatCloud : AActor {
	...
	void OnThreatVolumeChanged(); // Function FortniteAI.ThreatCloud.OnThreatVolumeChanged // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnLightningStrike(struct FVector& StartLocation, struct FVector& EndLocation, struct ABuildingRift* Rift, bool bLightningStruckRift); // Function FortniteAI.ThreatCloud.OnLightningStrike // (BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintEvent) // @ game+0xda05cc
	void OnCloudStart(); // Function FortniteAI.ThreatCloud.OnCloudStart // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnCloudHiddenChange(bool bCloudsAreHidden); // Function FortniteAI.ThreatCloud.OnCloudHiddenChange // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnCloudDeactivated(enum class EFortThreatDeactivationType DeactivationType); // Function FortniteAI.ThreatCloud.OnCloudDeactivated // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnCloudActivated(); // Function FortniteAI.ThreatCloud.OnCloudActivated // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnBeginDeath(); // Function FortniteAI.ThreatCloud.OnBeginDeath // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ManualLightningFlash(); // Function FortniteAI.ThreatCloud.ManualLightningFlash // (RequiredAPI|Event|Public|BlueprintEvent) // @ game+0xda05cc
	struct FBox GetThreatVolume(); // Function FortniteAI.ThreatCloud.GetThreatVolume // (Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x993ea0c
};
