...
struct Utask_verse_ue_input_component$WaitForAction_L_Nverse__ue__input__component_M_N_Kchar_M_Ninput__event_R : Utask(:type) {
	...
	int64_t Update(); // Function EpicGamesEngine.task_verse_ue_input_component$WaitForAction_L_Nverse__ue__input__component_M_N_Kchar_M_Ninput__event_R.Update // (Native|Public|HasOutParms) // @ game+0x5cb6210
};
