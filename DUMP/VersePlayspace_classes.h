...
struct Utask_playspace_component$__WaitForMatchBegin : Utask(:type) {
	...
	int64_t Update(); // Function VersePlayspace.task_playspace_component$__WaitForMatchBegin.Update // (Native|Public|HasOutParms) // @ game+0x639eb80
};
...
struct Utask_playspace_component$__WaitForMatchEnd : Utask(:type) {
	...
	int64_t Update(); // Function VersePlayspace.task_playspace_component$__WaitForMatchEnd.Update // (Native|Public|HasOutParms) // @ game+0x639eb88
};
...
struct Utask_playspace_component$__WaitForPlayerAdded : Utask(:type) {
	...
	int64_t Update(); // Function VersePlayspace.task_playspace_component$__WaitForPlayerAdded.Update // (Native|Public|HasOutParms) // @ game+0x639eb90
};
...
struct Utask_playspace_component$__WaitForPlayerRemoved : Utask(:type) {
	...
	int64_t Update(); // Function VersePlayspace.task_playspace_component$__WaitForPlayerRemoved.Update // (Native|Public|HasOutParms) // @ game+0x639eba0
};
...
struct Utask_playspace_component$__WaitForSetupComplete : Utask(:type) {
	...
	int64_t Update(); // Function VersePlayspace.task_playspace_component$__WaitForSetupComplete.Update // (Native|Public|HasOutParms) // @ game+0x639eba8
};
