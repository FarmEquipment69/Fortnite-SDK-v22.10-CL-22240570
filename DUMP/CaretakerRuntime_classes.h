...
struct UFortAIAnimInstance_Caretaker : UFortAIAnimInstance {
	...
	void SetDelayedMaterialParameters(); // Function CaretakerRuntime.FortAIAnimInstance_Caretaker.SetDelayedMaterialParameters // (Final|Native|Protected|BlueprintCallable) // @ game+0x67559f8
	struct UFortAnimWorldStriderComponent* GetWorldStriderComponent(); // Function CaretakerRuntime.FortAIAnimInstance_Caretaker.GetWorldStriderComponent // (Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x67555a4
	float GetWalkSpeedWarpingValue(); // Function CaretakerRuntime.FortAIAnimInstance_Caretaker.GetWalkSpeedWarpingValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6755578
	float GetWalkPlayRateValue(); // Function CaretakerRuntime.FortAIAnimInstance_Caretaker.GetWalkPlayRateValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6755558
	float GetStartAnimPosition(); // Function CaretakerRuntime.FortAIAnimInstance_Caretaker.GetStartAnimPosition // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x675552c
};
...
struct AFortAthenaCaretakerAIController : AAthenaAIController {
	...
	void OnMovementModeChanged(struct ACharacter* CharacterOwner, enum class EMovementMode PreviousMovementMode, char PreviousCustomMode); // Function CaretakerRuntime.FortAthenaCaretakerAIController.OnMovementModeChanged // (Final|Native|Public) // @ game+0x67555cc
	void DebugUpdate(float UpdateInterval); // Function CaretakerRuntime.FortAthenaCaretakerAIController.DebugUpdate // (Final|Native|Public|BlueprintCallable) // @ game+0x651cf58
};
