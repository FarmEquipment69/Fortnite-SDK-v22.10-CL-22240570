...
struct UTempestLightningComponent : UGameFrameworkComponent {
	...
	float GetLightningRadius(); // Function SuperstormRuntime.TempestLightningComponent.GetLightningRadius // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x68e0b24
	float GetCloudHeight(); // Function SuperstormRuntime.TempestLightningComponent.GetCloudHeight // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x68e0af0
};
...
struct UTempestTornadoForcesComponent : UGameFrameworkComponent {
	...
	void OnVehicleInTornadoPlayerExit(struct AFortPlayerControllerAthena* PlayerController, struct AFortAthenaVehicle* Vehicle); // Function SuperstormRuntime.TempestTornadoForcesComponent.OnVehicleInTornadoPlayerExit // (Final|Native|Private) // @ game+0x68e0c6c
	bool IsActorInTornado(struct AActor* Actor); // Function SuperstormRuntime.TempestTornadoForcesComponent.IsActorInTornado // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x68e0b58
};
