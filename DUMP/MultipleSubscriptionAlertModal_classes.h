...
struct UMultipleSubscriptionAlertModal_C : UCrewMultiSubscriptionAlertModal {
	...
	void OnSetHowToCancelURL(struct FString MoreInfoUrl); // Function MultipleSubscriptionAlertModal.MultipleSubscriptionAlertModal_C.OnSetHowToCancelURL // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_MultipleSubscriptionAlertModal(int32_t EntryPoint); // Function MultipleSubscriptionAlertModal.MultipleSubscriptionAlertModal_C.ExecuteUbergraph_MultipleSubscriptionAlertModal // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
