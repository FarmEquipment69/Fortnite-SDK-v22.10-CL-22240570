...
struct UHighTower_Tapas_Axe_AnimBP_C : UCustomCharacterPartAnimInstance_HightowerTapasAxe {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function HighTower_Tapas_Axe_AnimBP.HighTower_Tapas_Axe_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_HighTower_Tapas_Axe_AnimBP(int32_t EntryPoint); // Function HighTower_Tapas_Axe_AnimBP.HighTower_Tapas_Axe_AnimBP_C.ExecuteUbergraph_HighTower_Tapas_Axe_AnimBP // (Final|UbergraphFunction) // @ game+0xda05cc
};
