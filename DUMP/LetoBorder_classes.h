...
struct ULetoBorder_C : UFortLetoLayoutBorder {
	...
	void UpdateBorderWidth(float HalfBorderWidth); // Function LetoBorder.LetoBorder_C.UpdateBorderWidth // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_LetoBorder(int32_t EntryPoint); // Function LetoBorder.LetoBorder_C.ExecuteUbergraph_LetoBorder // (Final|UbergraphFunction) // @ game+0xda05cc
};
