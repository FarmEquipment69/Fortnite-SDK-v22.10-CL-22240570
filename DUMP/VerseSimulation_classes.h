...
struct UPlayer : UPlayerHandle {
	...
	void $InitInstance(); // Function VerseSimulation.Player.$InitInstance // (None) // @ game+0xda05cc
	void $InitCDO(); // Function VerseSimulation.Player.$InitCDO // (None) // @ game+0xda05cc
};
...
struct Uplayer_component : UEntityActorPlayerComponent {
	...
	struct UPlayer* _L_2fVerse_2eorg_2fSimulation_2fplayer__component_N_RGetHandle(struct Ftuple_L_R __verse_0xB2CDDD72_Argument); // Function VerseSimulation.player_component._L_2fVerse_2eorg_2fSimulation_2fplayer__component_N_RGetHandle // (Native|Public|HasOutParms|BlueprintCallable) // @ game+0x639eb30
	void $InitInstance(); // Function VerseSimulation.player_component.$InitInstance // (None) // @ game+0xda05cc
	void $InitCDO(); // Function VerseSimulation.player_component.$InitCDO // (None) // @ game+0xda05cc
};
...
struct Uplayer_multicast_delegate : Umulticast_delegate_base {
	...
	struct UObject* _L_2fVerse_2eorg_2fSimulation_2fsubscribable__player_N_RSubscribe_L_Nplayer_Tvoid_R(struct FDelegate __verse_0xB2CDDD72_Argument); // Function VerseSimulation.player_multicast_delegate._L_2fVerse_2eorg_2fSimulation_2fsubscribable__player_N_RSubscribe_L_Nplayer_Tvoid_R // (Native|Public|HasOutParms|BlueprintCallable) // @ game+0x5feae48
	void _L_2fVerse_2eorg_2fSimulation_2fplayer__multicast__delegate_N_RBroadcast_L_Nplayer_R(struct UPlayer* __verse_0xB2CDDD72_Argument); // Function VerseSimulation.player_multicast_delegate._L_2fVerse_2eorg_2fSimulation_2fplayer__multicast__delegate_N_RBroadcast_L_Nplayer_R // (Native|Public|BlueprintCallable) // @ game+0x63ab750
	void $InitInstance(); // Function VerseSimulation.player_multicast_delegate.$InitInstance // (None) // @ game+0xda05cc
	void $InitCDO(); // Function VerseSimulation.player_multicast_delegate.$InitCDO // (None) // @ game+0xda05cc
};
...
struct USimulation : UObject {
	...
	struct Utask(:type)* Sleep_L_Nfloat_R(struct Utask(:type)* __verse_0xC1E81372_CallingTask, int64_t __verse_0xA3A00DDB_CallerResumeState, int64_t __verse_0x2AC0E4D8_CallerCancelState, double __verse_0xB2CDDD72_Argument); // Function VerseSimulation.Simulation.Sleep_L_Nfloat_R // (Final|Static|Public|HasOutParms|BlueprintCallable) // @ game+0xda05cc
	double _L_2fVerse_2eorg_2fSimulation_N_RGetSimulationElapsedTime(struct Ftuple_L_R __verse_0xB2CDDD72_Argument); // Function VerseSimulation.Simulation._L_2fVerse_2eorg_2fSimulation_N_RGetSimulationElapsedTime // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x63aaa40
	OptionProperty _L_2fVerse_2eorg_2fSimulation_N_RGetPlayerComponentByIndex_L_Nint_R(int64_t __verse_0xB2CDDD72_Argument); // Function VerseSimulation.Simulation._L_2fVerse_2eorg_2fSimulation_N_RGetPlayerComponentByIndex_L_Nint_R // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x63aaa38
	OptionProperty _L_2fVerse_2eorg_2fSimulation_N_RGetOrCreateComponentOfTypeForPlayer_L_Nplayer__component_M_Ntype_R(struct Ftuple_Lplayer__component_Mtype_R __verse_0xB2CDDD72_Argument); // Function VerseSimulation.Simulation._L_2fVerse_2eorg_2fSimulation_N_RGetOrCreateComponentOfTypeForPlayer_L_Nplayer__component_M_Ntype_R // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x63aaa30
	OptionProperty _L_2fVerse_2eorg_2fSimulation_N_RGetOrCreateComponentOfTypeForPlayer_L_Nint_M_Ntype_R(struct Ftuple_Lint_Mtype_R __verse_0xB2CDDD72_Argument); // Function VerseSimulation.Simulation._L_2fVerse_2eorg_2fSimulation_N_RGetOrCreateComponentOfTypeForPlayer_L_Nint_M_Ntype_R // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x63aaa28
	OptionProperty _L_2fVerse_2eorg_2fSimulation_N_RGetComponentOfTypeForPlayer_L_Nplayer__component_M_Ntype_R(struct Ftuple_Lplayer__component_Mtype_R __verse_0xB2CDDD72_Argument); // Function VerseSimulation.Simulation._L_2fVerse_2eorg_2fSimulation_N_RGetComponentOfTypeForPlayer_L_Nplayer__component_M_Ntype_R // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x63aaa20
	OptionProperty _L_2fVerse_2eorg_2fSimulation_N_RGetComponentOfTypeForPlayer_L_Nint_M_Ntype_R(struct Ftuple_Lint_Mtype_R __verse_0xB2CDDD72_Argument); // Function VerseSimulation.Simulation._L_2fVerse_2eorg_2fSimulation_N_RGetComponentOfTypeForPlayer_L_Nint_M_Ntype_R // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0x63aaa18
	void $InitCDO(); // Function VerseSimulation.Simulation.$InitCDO // (None) // @ game+0xda05cc
};
...
struct Utask_Simulation$Sleep_L_Nfloat_R : Utask(:type) {
	...
	int64_t Update(); // Function VerseSimulation.task_Simulation$Sleep_L_Nfloat_R.Update // (Native|Public|HasOutParms) // @ game+0x63aaa08
};
