...
struct UPinModal_C : UFortPinModal {
	...
	void Set Visual States(enum class EPinModalValidityState Pin States); // Function PinModal.PinModal_C.Set Visual States // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void SetPreviewData(); // Function PinModal.PinModal_C.SetPreviewData // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	struct TArray<struct UFortPinButton*> CollectPinButtons(); // Function PinModal.PinModal_C.CollectPinButtons // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void PreConstruct(bool IsDesignTime); // Function PinModal.PinModal_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnSetPinState(enum class EPinModalValidityState PinModalState); // Function PinModal.PinModal_C.OnSetPinState // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_PinModal(int32_t EntryPoint); // Function PinModal.PinModal_C.ExecuteUbergraph_PinModal // (Final|UbergraphFunction) // @ game+0xda05cc
};
