...
struct ABP_Background_Raytracing_C : AActor {
	...
	void UserConstructionScript(); // Function BP_Background_Raytracing.BP_Background_Raytracing_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
