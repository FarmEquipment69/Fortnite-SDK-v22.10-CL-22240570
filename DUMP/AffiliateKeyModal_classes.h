...
struct UAffiliateKeyModal_C : UFortAffilateModal {
	...
	void SetupAffiliateField(struct FString AffilateName); // Function AffiliateKeyModal.AffiliateKeyModal_C.SetupAffiliateField // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void BndEvt__CloseButton_K2Node_ComponentBoundEvent_21_CommonButtonClicked__DelegateSignature(struct UCommonButtonLegacy* Button); // Function AffiliateKeyModal.AffiliateKeyModal_C.BndEvt__CloseButton_K2Node_ComponentBoundEvent_21_CommonButtonClicked__DelegateSignature // (BlueprintEvent) // @ game+0xda05cc
	void BndEvt__AcceptButton_K2Node_ComponentBoundEvent_26_CommonButtonClicked__DelegateSignature(struct UCommonButtonLegacy* Button); // Function AffiliateKeyModal.AffiliateKeyModal_C.BndEvt__AcceptButton_K2Node_ComponentBoundEvent_26_CommonButtonClicked__DelegateSignature // (BlueprintEvent) // @ game+0xda05cc
	void Onset(bool bSuccess); // Function AffiliateKeyModal.AffiliateKeyModal_C.Onset // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void OnCheckComplete(bool bSuccess, bool bWasValidAffiliateName, struct FString AffilateNameChecked); // Function AffiliateKeyModal.AffiliateKeyModal_C.OnCheckComplete // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void BP_OnActivated(); // Function AffiliateKeyModal.AffiliateKeyModal_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void (); // Function AffiliateKeyModal.AffiliateKeyModal_C. // (BlueprintEvent) // @ game+0xda05cc
	...
	void ExecuteUbergraph_AffiliateKeyModal(int32_t EntryPoint); // Function AffiliateKeyModal.AffiliateKeyModal_C.ExecuteUbergraph_AffiliateKeyModal // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
	void OnSuccess__DelegateSignature(); // Function AffiliateKeyModal.AffiliateKeyModal_C.OnSuccess__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnPopupClosed__DelegateSignature(); // Function AffiliateKeyModal.AffiliateKeyModal_C.OnPopupClosed__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
