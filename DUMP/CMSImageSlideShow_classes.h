...
struct UCMSImageSlideShow_C : UUserWidget {
	...
	void SetMediaURLs(struct TArray<struct FString>& MediaURLs); // Function CMSImageSlideShow.CMSImageSlideShow_C.SetMediaURLs // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void ExecuteUbergraph_CMSImageSlideShow(int32_t EntryPoint); // Function CMSImageSlideShow.CMSImageSlideShow_C.ExecuteUbergraph_CMSImageSlideShow // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
	void CarouselIndexChanged__DelegateSignature(int32_t CurrentPageIndex); // Function CMSImageSlideShow.CMSImageSlideShow_C.CarouselIndexChanged__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
