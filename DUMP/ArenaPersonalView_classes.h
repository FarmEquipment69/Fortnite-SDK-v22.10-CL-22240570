...
struct UArenaPersonalView_C : UFortArenaPersonalDivisionView {
	...
	void Colorize(struct FFortTournamentDisplayInfo Color Info); // Function ArenaPersonalView.ArenaPersonalView_C.Colorize // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_ArenaPersonalView(int32_t EntryPoint); // Function ArenaPersonalView.ArenaPersonalView_C.ExecuteUbergraph_ArenaPersonalView // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
