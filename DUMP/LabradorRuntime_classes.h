...
struct UFortLabradorComponent_Telemetry : UFortAIComponent_Telemetry {
	...
	void OnWakeUp(struct AActor* GoalActor); // Function LabradorRuntime.FortLabradorComponent_Telemetry.OnWakeUp // (Final|Native|Public|BlueprintCallable) // @ game+0x685b230
	void OnTeleport(); // Function LabradorRuntime.FortLabradorComponent_Telemetry.OnTeleport // (Final|Native|Public|BlueprintCallable) // @ game+0x685b218
	void OnDamaged(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* FHitComponent, struct FName BoneName, struct FVector Momentum); // Function LabradorRuntime.FortLabradorComponent_Telemetry.OnDamaged // (Final|Native|Private|HasDefaults) // @ game+0x685afc4
};
