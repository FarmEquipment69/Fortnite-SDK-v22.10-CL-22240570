...
struct UContentOnDemand_C : UFortContentOnDemand {
	...
	void OnUpdatedState(int32_t NumActiveDownloads, int32_t NumErrors); // Function ContentOnDemand.ContentOnDemand_C.OnUpdatedState // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void Construct(); // Function ContentOnDemand.ContentOnDemand_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_ContentOnDemand(int32_t EntryPoint); // Function ContentOnDemand.ContentOnDemand_C.ExecuteUbergraph_ContentOnDemand // (Final|UbergraphFunction) // @ game+0xda05cc
};
