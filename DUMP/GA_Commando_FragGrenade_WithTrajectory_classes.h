...
struct UGA_Commando_FragGrenade_WithTrajectory_C : UGAT_CommandoActiveAbility_C {
	...
	void ActiveAbilitySetup(struct UAbilitySystemComponent* AbilitySystemIn, struct UAbilitySystemComponent*& AbilitySystemOut); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.ActiveAbilitySetup // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void SpawnFragGrenade(struct AFortProjectileBase* ProjectileClass, struct FVector& SpawnLocation, struct FRotator InputPin, struct FFortGameplayEffectContainerSpec EffectContainerSpecToApplyOnExplode, double InitialSpeed, double GravityScale); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.SpawnFragGrenade // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void CalcGrenadeSpeedFromPitch(double AimPitch, double& GrenadeSpeed); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.CalcGrenadeSpeedFromPitch // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0xda05cc
	void UpdateTrajectorySpline(); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.UpdateTrajectorySpline // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void SetupDummyProjectile(); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.SetupDummyProjectile // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void SpawnLocationAndRotation(struct FVector& OutLoc, struct FRotator& OutRot); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.SpawnLocationAndRotation // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0xda05cc
	void SetupAbility(struct UAbilitySystemComponent* AbilitySystemComponentRef); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.SetupAbility // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void SetupGrenade(double AimPitch, struct AFortProjectileBase*& Base Grenade, double& Projectile Speed, struct FFortGameplayEffectContainerSpec& Explosion Gameplay Spec, double& Projectile Gravity Scale); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.SetupGrenade // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnFinish_F5D87C9E46378707AE4C79B3A42F5A45(); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.OnFinish_F5D87C9E46378707AE4C79B3A42F5A45 // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnCancelled_854170AF4268B06A435A3AA33232C5BF(); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.OnCancelled_854170AF4268B06A435A3AA33232C5BF // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnInterrupted_854170AF4268B06A435A3AA33232C5BF(); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.OnInterrupted_854170AF4268B06A435A3AA33232C5BF // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnBlendOut_854170AF4268B06A435A3AA33232C5BF(); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.OnBlendOut_854170AF4268B06A435A3AA33232C5BF // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnCompleted_854170AF4268B06A435A3AA33232C5BF(); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.OnCompleted_854170AF4268B06A435A3AA33232C5BF // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnFinish_1C6A100D44D1ACE5BBB57DAEDB3561CB(); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.OnFinish_1C6A100D44D1ACE5BBB57DAEDB3561CB // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Completed_BF65CDBE4F9E98E9174850B85775A15B(struct FGameplayAbilityTargetDataHandle& TargetData, struct FGameplayTag ApplicationTag); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.Completed_BF65CDBE4F9E98E9174850B85775A15B // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Cancelled_BF65CDBE4F9E98E9174850B85775A15B(struct FGameplayAbilityTargetDataHandle& TargetData, struct FGameplayTag ApplicationTag); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.Cancelled_BF65CDBE4F9E98E9174850B85775A15B // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Triggered_BF65CDBE4F9E98E9174850B85775A15B(struct FGameplayAbilityTargetDataHandle& TargetData, struct FGameplayTag ApplicationTag); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.Triggered_BF65CDBE4F9E98E9174850B85775A15B // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnAbilityInputReleased(); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.OnAbilityInputReleased // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void K2_OnEndAbility(bool bWasCancelled); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.K2_OnEndAbility // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void CleanupTrajectoryDisplay(); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.CleanupTrajectoryDisplay // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void K2_ActivateAbility(); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.K2_ActivateAbility // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void TossGrenade(); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.TossGrenade // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ServerSpawnProjectile(); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.ServerSpawnProjectile // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_GA_Commando_FragGrenade_WithTrajectory(int32_t EntryPoint); // Function GA_Commando_FragGrenade_WithTrajectory.GA_Commando_FragGrenade_WithTrajectory_C.ExecuteUbergraph_GA_Commando_FragGrenade_WithTrajectory // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
