...
struct UMediaPlateComponent : UActorComponent {
	...
	void Stop(); // Function MediaPlate.MediaPlateComponent.Stop // (Final|Native|Public|BlueprintCallable) // @ game+0x7391f48
	void Play(); // Function MediaPlate.MediaPlateComponent.Play // (Final|Native|Public|BlueprintCallable) // @ game+0x7391f34
	struct UMediaTexture* GetMediaTexture(); // Function MediaPlate.MediaPlateComponent.GetMediaTexture // (Final|Native|Public|BlueprintCallable) // @ game+0x7391f14
	struct UMediaPlayer* GetMediaPlayer(); // Function MediaPlate.MediaPlateComponent.GetMediaPlayer // (Final|Native|Public|BlueprintCallable) // @ game+0x7391ef4
};
