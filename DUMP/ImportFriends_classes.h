...
struct UImportFriends_C : UFortSocialImportPanel {
	...
	void ScaleTextButton(int32_t CharThreshold, struct UScaleBox* ContainingScaleBox, struct UIconTextButton_C* Button); // Function ImportFriends.ImportFriends_C.ScaleTextButton // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ScaleTextboxWithWrappingWorkaround(struct UScaleBox* ContainingScaleBox, int32_t CharLimitThreshold, struct UCommonTextBlock* TargetText, int32_t WrapAtHorrizontal); // Function ImportFriends.ImportFriends_C.ScaleTextboxWithWrappingWorkaround // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void HandleHeaderText(); // Function ImportFriends.ImportFriends_C.HandleHeaderText // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void HandleDescriptionText(); // Function ImportFriends.ImportFriends_C.HandleDescriptionText // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void PreConstruct(bool IsDesignTime); // Function ImportFriends.ImportFriends_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnPanelTypeSet(enum class ESocialImportPanelType NewType); // Function ImportFriends.ImportFriends_C.OnPanelTypeSet // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnIncentivizedSet(bool bIncentivized); // Function ImportFriends.ImportFriends_C.OnIncentivizedSet // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	...
	void BP_OnActivated(); // Function ImportFriends.ImportFriends_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_ImportFriends(int32_t EntryPoint); // Function ImportFriends.ImportFriends_C.ExecuteUbergraph_ImportFriends // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
