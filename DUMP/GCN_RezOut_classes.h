...
struct AGCN_RezOut_C : AFortGameplayCueNotify_BurstLatent {
	...
	void Spawn Drone VFX(); // Function GCN_RezOut.GCN_RezOut_C.Spawn Drone VFX // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Set Timeline Playrates(); // Function GCN_RezOut.GCN_RezOut_C.Set Timeline Playrates // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Dissolve Material Setup(); // Function GCN_RezOut.GCN_RezOut_C.Dissolve Material Setup // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Spawn Dissolve VFX(); // Function GCN_RezOut.GCN_RezOut_C.Spawn Dissolve VFX // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Clean-Up Teleportation Light(); // Function GCN_RezOut.GCN_RezOut_C.Clean-Up Teleportation Light // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Spawn Teleportation Light(); // Function GCN_RezOut.GCN_RezOut_C.Spawn Teleportation Light // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Spawn Teleportation Drone(); // Function GCN_RezOut.GCN_RezOut_C.Spawn Teleportation Drone // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Stop Looping Audio(); // Function GCN_RezOut.GCN_RezOut_C.Stop Looping Audio // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Play Elmination AnimMontage(); // Function GCN_RezOut.GCN_RezOut_C.Play Elmination AnimMontage // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void TFX_GlowCharacterMesh__FinishedFunc(); // Function GCN_RezOut.GCN_RezOut_C.TFX_GlowCharacterMesh__FinishedFunc // (BlueprintEvent) // @ game+0xda05cc
	void TFX_GlowCharacterMesh__UpdateFunc(); // Function GCN_RezOut.GCN_RezOut_C.TFX_GlowCharacterMesh__UpdateFunc // (BlueprintEvent) // @ game+0xda05cc
	void TFX_ResOutCharacterMesh__FinishedFunc(); // Function GCN_RezOut.GCN_RezOut_C.TFX_ResOutCharacterMesh__FinishedFunc // (BlueprintEvent) // @ game+0xda05cc
	void TFX_ResOutCharacterMesh__UpdateFunc(); // Function GCN_RezOut.GCN_RezOut_C.TFX_ResOutCharacterMesh__UpdateFunc // (BlueprintEvent) // @ game+0xda05cc
	void OnBurstGeneric(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UFXSystemComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents, struct UMatineeCameraShake* BurstCameraShakeInstance, struct ADecalActor* BurstDecalInstance); // Function GCN_RezOut.GCN_RezOut_C.OnBurstGeneric // (Event|Public|HasOutParms|BlueprintEvent|Const) // @ game+0xda05cc
	void Pre-Sequence Change(); // Function GCN_RezOut.GCN_RezOut_C.Pre-Sequence Change // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Set Additional Niagara Parameters on Spawned FX(struct UNiagaraComponent* Spawned Death FX); // Function GCN_RezOut.GCN_RezOut_C.Set Additional Niagara Parameters on Spawned FX // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Set Additional Niagara Parameters on Drone FX(struct UNiagaraComponent* Drone FX); // Function GCN_RezOut.GCN_RezOut_C.Set Additional Niagara Parameters on Drone FX // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_GCN_RezOut(int32_t EntryPoint); // Function GCN_RezOut.GCN_RezOut_C.ExecuteUbergraph_GCN_RezOut // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
