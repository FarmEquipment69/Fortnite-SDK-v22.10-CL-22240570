...
struct UWBP_Modal_ReviewYourSettings_C : UFortReviewYourSettingsModal {
	...
	void OnModalBackout(); // Function WBP_Modal_ReviewYourSettings.WBP_Modal_ReviewYourSettings_C.OnModalBackout // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_WBP_Modal_ReviewYourSettings(int32_t EntryPoint); // Function WBP_Modal_ReviewYourSettings.WBP_Modal_ReviewYourSettings_C.ExecuteUbergraph_WBP_Modal_ReviewYourSettings // (Final|UbergraphFunction) // @ game+0xda05cc
};
