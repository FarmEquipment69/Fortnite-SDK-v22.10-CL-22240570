...
struct UDownloadOnDemandAddProjectModal : UCommonActivatableWidget {
	...
	void UpdateLightningViolator(enum class ESlateVisibility InVisibility, struct FText& InText); // Function VKDownloadOnDemandUI.DownloadOnDemandAddProjectModal.UpdateLightningViolator // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void HandleDownloadLinkCodeTextChanged(struct FText& InMnemonic); // Function VKDownloadOnDemandUI.DownloadOnDemandAddProjectModal.HandleDownloadLinkCodeTextChanged // (Final|Native|Private|HasOutParms) // @ game+0x6bf3bd4
};
...
struct UDownloadOnDemandProjectAssetTile : UCommonButtonLegacy {
	...
	struct UDownloadOnDemandProjectAssetTileInitializer* Initializer; // 0x1078(0x08)
	char pad_1080[0x10]; // 0x1080(0x10)
	struct UImage* Image_Item; // 0x1090(0x08)
	struct UImage* Image_Spinner; // 0x1098(0x08)
	struct UCommonNumericTextBlock* NumericTextBlock_ItemCount; // 0x10a0(0x08)
...
struct UDownloadOnDemandProjectManagementTab : UUserWidget {
	...
	void UpdateProjectConfirmed(); // Function VKDownloadOnDemandUI.DownloadOnDemandProjectManagementTab.UpdateProjectConfirmed // (Final|Native|Protected|BlueprintCallable) // @ game+0x6bf3d3c
	void RemoveProjectConfirmed(); // Function VKDownloadOnDemandUI.DownloadOnDemandProjectManagementTab.RemoveProjectConfirmed // (Final|Native|Protected|BlueprintCallable) // @ game+0x6bf3c98
};

// Class VKDownloadOnDemandUI.DownloadOnDemandProjectTile
// Size: 0x1260 (Inherited: 0x1070)
struct UDownloadOnDemandProjectTile : UCommonButtonLegacy {
	char pad_1070[0x10]; // 0x1070(0x10)
	struct FSlateBrush SelectedHighlightBrush; // 0x1080(0xc0)
	struct FSlateBrush HoveredHighlightBrush; // 0x1140(0xc0)
	bool bIsSelected; // 0x1200(0x01)
	char pad_1201[0x7]; // 0x1201(0x07)
	struct UDownloadOnDemandProject* Project; // 0x1208(0x08)
	char pad_1210[0x10]; // 0x1210(0x10)
	struct UDownloadOnDemandProjectTileImage* ProjectTileImage_Preview; // 0x1220(0x08)
	struct UImage* Image_UpdatePending; // 0x1228(0x08)
	struct UImage* Image_AddProject; // 0x1230(0x08)
	struct UImage* Image_Spinner; // 0x1238(0x08)
	struct UImage* Image_Error; // 0x1240(0x08)
	struct USizeBox* SizeBox_Label; // 0x1248(0x08)
	struct UCommonTextBlock* TextBlock_Label; // 0x1250(0x08)
	struct UCommonBorder* Border_Highlight; // 0x1258(0x08)

	void UpdateLabel(bool bShowLabel); // Function VKDownloadOnDemandUI.DownloadOnDemandProjectTile.UpdateLabel // (Final|Native|Public|BlueprintCallable) // @ game+0x6bf3cbc
	void OnLabelUpdated(); // Function VKDownloadOnDemandUI.DownloadOnDemandProjectTile.OnLabelUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
