...
struct UGAT_CommandoActiveAbility_C : UGAT_ActiveAbility_Hero_C {
	...
	void K2_ActivateAbility(); // Function GAT_CommandoActiveAbility.GAT_CommandoActiveAbility_C.K2_ActivateAbility // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_GAT_CommandoActiveAbility(int32_t EntryPoint); // Function GAT_CommandoActiveAbility.GAT_CommandoActiveAbility_C.ExecuteUbergraph_GAT_CommandoActiveAbility // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
