...
struct ULockerArchivingTooltip_C : UUserWidget {
	...
	void SetText(struct FText& Text); // Function LockerArchivingTooltip.LockerArchivingTooltip_C.SetText // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void SetTooltipEnabled(bool bInEnabled); // Function LockerArchivingTooltip.LockerArchivingTooltip_C.SetTooltipEnabled // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void PreConstruct(bool IsDesignTime); // Function LockerArchivingTooltip.LockerArchivingTooltip_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ShowTooltip(); // Function LockerArchivingTooltip.LockerArchivingTooltip_C.ShowTooltip // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void HideTooltip(); // Function LockerArchivingTooltip.LockerArchivingTooltip_C.HideTooltip // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void SetTooltipStatus(bool bShouldShowTooltip); // Function LockerArchivingTooltip.LockerArchivingTooltip_C.SetTooltipStatus // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_LockerArchivingTooltip(int32_t EntryPoint); // Function LockerArchivingTooltip.LockerArchivingTooltip_C.ExecuteUbergraph_LockerArchivingTooltip // (Final|UbergraphFunction) // @ game+0xda05cc
	void OnDismissed__DelegateSignature(); // Function LockerArchivingTooltip.LockerArchivingTooltip_C.OnDismissed__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
