...
struct UShowdownTournamentPosterFront_C : UFortShowdownDetailView {
	...
	void GetTournamentDateText(struct FText& TournamentDate); // Function ShowdownTournamentPosterFront.ShowdownTournamentPosterFront_C.GetTournamentDateText // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void RefreshDataBP(); // Function ShowdownTournamentPosterFront.ShowdownTournamentPosterFront_C.RefreshDataBP // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void PreConstruct(bool IsDesignTime); // Function ShowdownTournamentPosterFront.ShowdownTournamentPosterFront_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void Construct(); // Function ShowdownTournamentPosterFront.ShowdownTournamentPosterFront_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void BndEvt__Image_PosterFront_K2Node_ComponentBoundEvent_1_onLoadingCompleted__DelegateSignature(); // Function ShowdownTournamentPosterFront.ShowdownTournamentPosterFront_C.BndEvt__Image_PosterFront_K2Node_ComponentBoundEvent_1_onLoadingCompleted__DelegateSignature // (BlueprintEvent) // @ game+0xda05cc
	void BP_ResetDetailView(); // Function ShowdownTournamentPosterFront.ShowdownTournamentPosterFront_C.BP_ResetDetailView // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_ShowdownTournamentPosterFront(int32_t EntryPoint); // Function ShowdownTournamentPosterFront.ShowdownTournamentPosterFront_C.ExecuteUbergraph_ShowdownTournamentPosterFront // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
