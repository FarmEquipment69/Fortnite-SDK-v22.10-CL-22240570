...
struct ADynamicUIDirectorBase : AActor {
	...
	void RemoveScene(struct UDynamicUIScene* Scene); // Function DynamicUI.DynamicUIDirectorBase.RemoveScene // (Final|Native|Public|BlueprintCallable) // @ game+0x63ed7c0
	struct APlayerController* GetOwningLocalPlayerController(); // Function DynamicUI.DynamicUIDirectorBase.GetOwningLocalPlayerController // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x63ed79c
	struct ULocalPlayer* GetOwningLocalPlayer(); // Function DynamicUI.DynamicUIDirectorBase.GetOwningLocalPlayer // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x63ed730
	void AddScene(struct UDynamicUIScene* Scene); // Function DynamicUI.DynamicUIDirectorBase.AddScene // (Final|Native|Public|BlueprintCallable) // @ game+0x237b3f4
};
...
struct UDynamicUIManager : UWorldSubsystem {
	...
	void RemoveScenes(struct TArray<struct UDynamicUIScene*> Scenes, struct APlayerController*& Player); // Function DynamicUI.DynamicUIManager.RemoveScenes // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x63edf38
	void RemoveSceneFromFirstLocalPlayer(struct UDynamicUIScene* Scene); // Function DynamicUI.DynamicUIManager.RemoveSceneFromFirstLocalPlayer // (Final|Native|Protected|BlueprintCallable) // @ game+0x63edbdc
	void RemoveScene(struct UDynamicUIScene* Scene, struct APlayerController*& Player); // Function DynamicUI.DynamicUIManager.RemoveScene // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x63ed840
	void AddSceneToFirstLocalPlayer(struct UDynamicUIScene* Scene); // Function DynamicUI.DynamicUIManager.AddSceneToFirstLocalPlayer // (Final|Native|Protected|BlueprintCallable) // @ game+0x63ed284
	void AddScenes(struct TArray<struct UDynamicUIScene*> Scenes, struct APlayerController*& Player); // Function DynamicUI.DynamicUIManager.AddScenes // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x63ed5ec
	void AddScene(struct UDynamicUIScene* Scene, struct APlayerController*& Player); // Function DynamicUI.DynamicUIManager.AddScene // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x63ecedc
};
...
struct UDynamicUITransitionableWidgetInterface : UInterface {
	...
	void BroadcastTransitionCompleted(); // Function DynamicUI.DynamicUITransitionableWidgetInterface.BroadcastTransitionCompleted // (Native|Protected|BlueprintCallable) // @ game+0x63ed71c
};
