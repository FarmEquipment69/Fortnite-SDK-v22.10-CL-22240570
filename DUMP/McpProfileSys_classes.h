...
struct UMcpProfile : UObject {
	...
	void UnlockProfileForWrite(struct FString Code, struct FDedicatedServerUrlContext& Context); // Function McpProfileSys.McpProfile.UnlockProfileForWrite // (Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms) // @ game+0xffff8008a2420000
	void QueryPublicProfile(struct FBaseUrlContext& Context); // Function McpProfileSys.McpProfile.QueryPublicProfile // (Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms) // @ game+0xffff8008a2420000
	void QueryProfile(struct FBaseUrlContext& Context); // Function McpProfileSys.McpProfile.QueryProfile // (Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms) // @ game+0xffff8008a2420000
	void LockProfileForWrite(struct FString Code, int32_t Timeout, struct FDedicatedServerUrlContext& Context); // Function McpProfileSys.McpProfile.LockProfileForWrite // (Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms) // @ game+0xffff8008a2420000
	void DeleteProfile(struct FClientUrlContext& Context); // Function McpProfileSys.McpProfile.DeleteProfile // (Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms) // @ game+0xffff8008a2420000
	void DeleteAllProfiles(struct FClientUrlContext& Context); // Function McpProfileSys.McpProfile.DeleteAllProfiles // (Final|Net|NetReliableNetRequest|Native|Event|Private|HasOutParms) // @ game+0xffff8008a2420000
};
