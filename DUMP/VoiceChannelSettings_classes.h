...
struct UVoiceChannelSettings_C : UFortVoiceSettingsDisplay {
	...
	void ExecuteUbergraph_VoiceChannelSettings(int32_t EntryPoint); // Function VoiceChannelSettings.VoiceChannelSettings_C.ExecuteUbergraph_VoiceChannelSettings // (Final|UbergraphFunction) // @ game+0xda05cc
};
