...
struct AGCN_Loop_Snow_Whiteout_C : AFortGameplayCueNotify_Loop {
	...
	void FadeinOut__FinishedFunc(); // Function GCN_Loop_Snow_Whiteout.GCN_Loop_Snow_Whiteout_C.FadeinOut__FinishedFunc // (BlueprintEvent) // @ game+0xda05cc
	void FadeinOut__UpdateFunc(); // Function GCN_Loop_Snow_Whiteout.GCN_Loop_Snow_Whiteout_C.FadeinOut__UpdateFunc // (BlueprintEvent) // @ game+0xda05cc
	void ReceiveDestroyed(); // Function GCN_Loop_Snow_Whiteout.GCN_Loop_Snow_Whiteout_C.ReceiveDestroyed // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnRemoval(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UParticleSystemComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents, struct UMatineeCameraShake* BurstCameraShakeInstance, struct ADecalActor* BurstDecalInstance); // Function GCN_Loop_Snow_Whiteout.GCN_Loop_Snow_Whiteout_C.OnRemoval // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	...
	void ExecuteUbergraph_GCN_Loop_Snow_Whiteout(int32_t EntryPoint); // Function GCN_Loop_Snow_Whiteout.GCN_Loop_Snow_Whiteout_C.ExecuteUbergraph_GCN_Loop_Snow_Whiteout // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
