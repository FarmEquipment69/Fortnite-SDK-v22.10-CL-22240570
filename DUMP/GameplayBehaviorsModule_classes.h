...
struct UGameplayBehavior : UObject {
	...
	void K2_TriggerBehavior(struct AActor* Avatar, struct UGameplayBehaviorConfig* Config, struct AActor* SmartObjectOwner); // Function GameplayBehaviorsModule.GameplayBehavior.K2_TriggerBehavior // (Final|Native|Public|BlueprintCallable) // @ game+0x71f2c0c
	void K2_OnTriggeredPawn(struct APawn* Avatar, struct UGameplayBehaviorConfig* Config, struct AActor* SmartObjectOwner); // Function GameplayBehaviorsModule.GameplayBehavior.K2_OnTriggeredPawn // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void K2_OnTriggeredCharacter(struct ACharacter* Avatar, struct UGameplayBehaviorConfig* Config, struct AActor* SmartObjectOwner); // Function GameplayBehaviorsModule.GameplayBehavior.K2_OnTriggeredCharacter // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void K2_OnTriggered(struct AActor* Avatar, struct UGameplayBehaviorConfig* Config, struct AActor* SmartObjectOwner); // Function GameplayBehaviorsModule.GameplayBehavior.K2_OnTriggered // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void K2_OnFinishedPawn(struct APawn* Avatar, bool bWasInterrupted); // Function GameplayBehaviorsModule.GameplayBehavior.K2_OnFinishedPawn // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void K2_OnFinishedCharacter(struct ACharacter* Avatar, bool bWasInterrupted); // Function GameplayBehaviorsModule.GameplayBehavior.K2_OnFinishedCharacter // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void K2_OnFinished(struct AActor* Avatar, bool bWasInterrupted); // Function GameplayBehaviorsModule.GameplayBehavior.K2_OnFinished // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	int32_t K2_GetNextActorIndexInSequence(int32_t CurrentIndex); // Function GameplayBehaviorsModule.GameplayBehavior.K2_GetNextActorIndexInSequence // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x71f2b5c
	void K2_EndBehavior(struct AActor* Avatar); // Function GameplayBehaviorsModule.GameplayBehavior.K2_EndBehavior // (Final|Native|Public|BlueprintCallable) // @ game+0x71f2ad8
	void K2_AbortBehavior(struct AActor* Avatar); // Function GameplayBehaviorsModule.GameplayBehavior.K2_AbortBehavior // (Final|Native|Public|BlueprintCallable) // @ game+0x71f2a54
};
...
struct UGameplayBehavior_AnimationBased : UGameplayBehavior {
	...
	void OnMontageFinished(struct UAnimMontage* Montage, bool bInterrupted, struct AActor* InAvatar); // Function GameplayBehaviorsModule.GameplayBehavior_AnimationBased.OnMontageFinished // (Final|Native|Protected) // @ game+0x71f2d18
};
