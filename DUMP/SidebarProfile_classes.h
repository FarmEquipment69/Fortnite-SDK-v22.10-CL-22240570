...
struct USidebarProfile_C : UFortSocialProfilePanel {
	...
	void OnStartProfileLoading(); // Function SidebarProfile.SidebarProfile_C.OnStartProfileLoading // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnFinishedProfileLoading(); // Function SidebarProfile.SidebarProfile_C.OnFinishedProfileLoading // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_SidebarProfile(int32_t EntryPoint); // Function SidebarProfile.SidebarProfile_C.ExecuteUbergraph_SidebarProfile // (Final|UbergraphFunction) // @ game+0xda05cc
};
