...
struct UMissedInvitesActionMenu_C : UFortMissedInvitesActionMenu {
	...
	struct FEventReply OnKeyUp(struct FGeometry MyGeometry, struct FKeyEvent InKeyEvent); // Function MissedInvitesActionMenu.MissedInvitesActionMenu_C.OnKeyUp // (BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnOpened(); // Function MissedInvitesActionMenu.MissedInvitesActionMenu_C.OnOpened // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_MissedInvitesActionMenu(int32_t EntryPoint); // Function MissedInvitesActionMenu.MissedInvitesActionMenu_C.ExecuteUbergraph_MissedInvitesActionMenu // (Final|UbergraphFunction) // @ game+0xda05cc
};
