...
struct UFortAthenaChromeWildlifeTelemetryData : UFortAthenaAITelemetryData {
	...
	void SetIsChromed(bool bInIsChromed); // Function ChromeWildlifeRuntime.FortAthenaChromeWildlifeTelemetryData.SetIsChromed // (Final|Native|Public|BlueprintCallable) // @ game+0x67b0144
};
