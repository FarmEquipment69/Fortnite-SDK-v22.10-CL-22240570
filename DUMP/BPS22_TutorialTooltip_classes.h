...
struct UBPS22_TutorialTooltip_C : UFortBattlePassTutorialTooltipS22 {
	...
	void PreConstruct(bool IsDesignTime); // Function BPS22_TutorialTooltip.BPS22_TutorialTooltip_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ShowTooltip(); // Function BPS22_TutorialTooltip.BPS22_TutorialTooltip_C.ShowTooltip // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void HideTooltip(); // Function BPS22_TutorialTooltip.BPS22_TutorialTooltip_C.HideTooltip // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_BPS22_TutorialTooltip(int32_t EntryPoint); // Function BPS22_TutorialTooltip.BPS22_TutorialTooltip_C.ExecuteUbergraph_BPS22_TutorialTooltip // (Final|UbergraphFunction) // @ game+0xda05cc
};
