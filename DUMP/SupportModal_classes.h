...
struct USupportModal_C : UAthenaItemShopTimerInfoModal {
	...
	void OnModalBackout(); // Function SupportModal.SupportModal_C.OnModalBackout // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void BP_OnActivated(); // Function SupportModal.SupportModal_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_SupportModal(int32_t EntryPoint); // Function SupportModal.SupportModal_C.ExecuteUbergraph_SupportModal // (Final|UbergraphFunction) // @ game+0xda05cc
};
