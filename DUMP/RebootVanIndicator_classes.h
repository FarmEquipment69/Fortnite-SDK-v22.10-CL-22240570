...
struct URebootVanIndicator_C : UAthenaRebootVanIndicator {
	...
	void Construct(); // Function RebootVanIndicator.RebootVanIndicator_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_RebootVanIndicator(int32_t EntryPoint); // Function RebootVanIndicator.RebootVanIndicator_C.ExecuteUbergraph_RebootVanIndicator // (Final|UbergraphFunction) // @ game+0xda05cc
};
