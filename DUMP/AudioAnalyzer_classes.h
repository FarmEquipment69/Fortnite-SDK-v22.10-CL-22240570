...
struct UAudioAnalyzer : UObject {
	...
	void StopAnalyzing(struct UObject* WorldContextObject); // Function AudioAnalyzer.AudioAnalyzer.StopAnalyzing // (Final|BlueprintCosmetic|Native|Public|BlueprintCallable) // @ game+0xa0295a8
	void StartAnalyzing(struct UObject* WorldContextObject, struct UAudioBus* AudioBusToAnalyze); // Function AudioAnalyzer.AudioAnalyzer.StartAnalyzing // (Final|BlueprintCosmetic|Native|Public|BlueprintCallable) // @ game+0xa0292cc
};
