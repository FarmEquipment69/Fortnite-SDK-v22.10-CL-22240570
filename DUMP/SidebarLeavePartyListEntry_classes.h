...
struct USidebarLeavePartyListEntry_C : UFortLeavePartyListEntry {
	...
	void BP_OnUnhovered(); // Function SidebarLeavePartyListEntry.SidebarLeavePartyListEntry_C.BP_OnUnhovered // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	...
	void BP_OnHovered(); // Function SidebarLeavePartyListEntry.SidebarLeavePartyListEntry_C.BP_OnHovered // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_SidebarLeavePartyListEntry(int32_t EntryPoint); // Function SidebarLeavePartyListEntry.SidebarLeavePartyListEntry_C.ExecuteUbergraph_SidebarLeavePartyListEntry // (Final|UbergraphFunction) // @ game+0xda05cc
};
