...
struct USettingsListEntry_ControllerButton_C : UFortSettingsListEntrySetting_ControllerButton {
	...
	void OnSettingAssigned(struct FText& ActionText); // Function SettingsListEntry_ControllerButton.SettingsListEntry_ControllerButton_C.OnSettingAssigned // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	...
	void ExecuteUbergraph_SettingsListEntry_ControllerButton(int32_t EntryPoint); // Function SettingsListEntry_ControllerButton.SettingsListEntry_ControllerButton_C.ExecuteUbergraph_SettingsListEntry_ControllerButton // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
