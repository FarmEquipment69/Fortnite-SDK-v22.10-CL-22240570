...
struct USidebarReferAFriendEntry_C : UFortReferFriendListEntry {
	...
	void BP_OnUnhovered(); // Function SidebarReferAFriendEntry.SidebarReferAFriendEntry_C.BP_OnUnhovered // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	...
	void BP_OnHovered(); // Function SidebarReferAFriendEntry.SidebarReferAFriendEntry_C.BP_OnHovered // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_SidebarReferAFriendEntry(int32_t EntryPoint); // Function SidebarReferAFriendEntry.SidebarReferAFriendEntry_C.ExecuteUbergraph_SidebarReferAFriendEntry // (Final|UbergraphFunction) // @ game+0xda05cc
};
