...
struct AGCNL_Zipline_Downhill_C : AFortGameplayCueNotify_Loop {
	...
	struct UMatineeCameraShake* matineeCamShake; // 0x970(0x08)
	...
	void cameraShakeTimer(); // Function GCNL_Zipline_Downhill.GCNL_Zipline_Downhill_C.cameraShakeTimer // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_GCNL_Zipline_Downhill(int32_t EntryPoint); // Function GCNL_Zipline_Downhill.GCNL_Zipline_Downhill_C.ExecuteUbergraph_GCNL_Zipline_Downhill // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
