...
struct UShowdownTournamentPosterBack_C : UFortShowdownDetailView {
	...
	void GetTournamentDateText(struct FText& TournamentDate); // Function ShowdownTournamentPosterBack.ShowdownTournamentPosterBack_C.GetTournamentDateText // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void RefreshDataBP(); // Function ShowdownTournamentPosterBack.ShowdownTournamentPosterBack_C.RefreshDataBP // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void EventColorize(); // Function ShowdownTournamentPosterBack.ShowdownTournamentPosterBack_C.EventColorize // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void EventPopulateEventWindowData(); // Function ShowdownTournamentPosterBack.ShowdownTournamentPosterBack_C.EventPopulateEventWindowData // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Construct(); // Function ShowdownTournamentPosterBack.ShowdownTournamentPosterBack_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_ShowdownTournamentPosterBack(int32_t EntryPoint); // Function ShowdownTournamentPosterBack.ShowdownTournamentPosterBack_C.ExecuteUbergraph_ShowdownTournamentPosterBack // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
