...
struct UCreativeVideoPlayerFullScreenWidget : UCommonActivatableWidget {
	...
	void OnSkipButtonActionProgress(float HeldPercent); // Function CreativeVideoPlayerUI.CreativeVideoPlayerFullScreenWidget.OnSkipButtonActionProgress // (Final|Native|Private) // @ game+0x67d23d0
	void OnSkipButtonActionComplete(); // Function CreativeVideoPlayerUI.CreativeVideoPlayerFullScreenWidget.OnSkipButtonActionComplete // (Final|Native|Private) // @ game+0x67d23bc
};
