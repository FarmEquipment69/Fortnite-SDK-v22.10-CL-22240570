...
struct AMASTER_TODM_C : AFortTimeOfDayManager {
	...
	void EmptyTransform(struct FTransform& Transform); // Function MASTER_TODM.MASTER_TODM_C.EmptyTransform // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0xda05cc
	void SetHeavySSAO(); // Function MASTER_TODM.MASTER_TODM_C.SetHeavySSAO // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void UserConstructionScript(); // Function MASTER_TODM.MASTER_TODM_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void FlashLightning__FinishedFunc(); // Function MASTER_TODM.MASTER_TODM_C.FlashLightning__FinishedFunc // (BlueprintEvent) // @ game+0xda05cc
	void FlashLightning__UpdateFunc(); // Function MASTER_TODM.MASTER_TODM_C.FlashLightning__UpdateFunc // (BlueprintEvent) // @ game+0xda05cc
	void New Storm Timeline__FinishedFunc(); // Function MASTER_TODM.MASTER_TODM_C.New Storm Timeline__FinishedFunc // (BlueprintEvent) // @ game+0xda05cc
	void New Storm Timeline__UpdateFunc(); // Function MASTER_TODM.MASTER_TODM_C.New Storm Timeline__UpdateFunc // (BlueprintEvent) // @ game+0xda05cc
	void New Storm Timeline__FireOffRain__EventFunc(); // Function MASTER_TODM.MASTER_TODM_C.New Storm Timeline__FireOffRain__EventFunc // (BlueprintEvent) // @ game+0xda05cc
	void StartStorm(); // Function MASTER_TODM.MASTER_TODM_C.StartStorm // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnStormStart(); // Function MASTER_TODM.MASTER_TODM_C.OnStormStart // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnStormEnd(); // Function MASTER_TODM.MASTER_TODM_C.OnStormEnd // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void LightningStrike(); // Function MASTER_TODM.MASTER_TODM_C.LightningStrike // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ReceiveBeginPlay(); // Function MASTER_TODM.MASTER_TODM_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void DisableLightAndFog(bool Enable); // Function MASTER_TODM.MASTER_TODM_C.DisableLightAndFog // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void EnableHDRRendering(); // Function MASTER_TODM.MASTER_TODM_C.EnableHDRRendering // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void UpdateSSAO(); // Function MASTER_TODM.MASTER_TODM_C.UpdateSSAO // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_MASTER_TODM(int32_t EntryPoint); // Function MASTER_TODM.MASTER_TODM_C.ExecuteUbergraph_MASTER_TODM // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
