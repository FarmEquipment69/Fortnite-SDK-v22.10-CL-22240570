...
struct UVirtualHeightfieldMeshComponent : UPrimitiveComponent {
	...
	void GatherHideFlags(bool& InOutHidePrimitivesInEditor, bool& InOutHidePrimitivesInGame); // Function VirtualHeightfieldMesh.VirtualHeightfieldMeshComponent.GatherHideFlags // (Final|Native|Protected|HasOutParms|Const) // @ game+0x7240b94
};
