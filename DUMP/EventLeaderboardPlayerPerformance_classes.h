...
struct UEventLeaderboardPlayerPerformance_C : UFortShowdownDetailView {
	...
	void RefreshDataBP(); // Function EventLeaderboardPlayerPerformance.EventLeaderboardPlayerPerformance_C.RefreshDataBP // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_EventLeaderboardPlayerPerformance(int32_t EntryPoint); // Function EventLeaderboardPlayerPerformance.EventLeaderboardPlayerPerformance_C.ExecuteUbergraph_EventLeaderboardPlayerPerformance // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
