...
struct UShowdownTournamentDetailsScoringRule_C : UCommonUserWidget {
	...
	void SetData(struct FFortShowdownScoringRuleInfo ScoreRule, struct FFortTournamentDisplayInfo TournamentDisplayInfo); // Function ShowdownTournamentDetailsScoringRule.ShowdownTournamentDetailsScoringRule_C.SetData // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
