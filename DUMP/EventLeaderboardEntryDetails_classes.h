...
struct UEventLeaderboardEntryDetails_C : UFortLeaderboardEntryDetails {
	...
	void Update Alt Leaderboard Tracked Stat(); // Function EventLeaderboardEntryDetails.EventLeaderboardEntryDetails_C.Update Alt Leaderboard Tracked Stat // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Set Stats Rows(enum class ETournamentDisplayType EventType); // Function EventLeaderboardEntryDetails.EventLeaderboardEntryDetails_C.Set Stats Rows // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Set Points Breakdown(enum class ETournamentDisplayType EventType); // Function EventLeaderboardEntryDetails.EventLeaderboardEntryDetails_C.Set Points Breakdown // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Set Leaderboard Key(struct FString LeaderboardInstanceId, struct FString LeaderboardGroupingId); // Function EventLeaderboardEntryDetails.EventLeaderboardEntryDetails_C.Set Leaderboard Key // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void SetTournamentValues(struct FString InTournamentId, struct FString InEventWindowId); // Function EventLeaderboardEntryDetails.EventLeaderboardEntryDetails_C.SetTournamentValues // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Show Details(struct UFortEventLeaderboardEntryData* EntryData, enum class ETournamentDisplayType EventType); // Function EventLeaderboardEntryDetails.EventLeaderboardEntryDetails_C.Show Details // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Construct(); // Function EventLeaderboardEntryDetails.EventLeaderboardEntryDetails_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void EventColorize(struct FFortTournamentDisplayInfo TournamentDisplayInfo); // Function EventLeaderboardEntryDetails.EventLeaderboardEntryDetails_C.EventColorize // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void EventIntro(); // Function EventLeaderboardEntryDetails.EventLeaderboardEntryDetails_C.EventIntro // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void LeaderboardEntryDoubleClicked(); // Function EventLeaderboardEntryDetails.EventLeaderboardEntryDetails_C.LeaderboardEntryDoubleClicked // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void ExecuteUbergraph_EventLeaderboardEntryDetails(int32_t EntryPoint); // Function EventLeaderboardEntryDetails.EventLeaderboardEntryDetails_C.ExecuteUbergraph_EventLeaderboardEntryDetails // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
	void ProfileSelectedFromSelector__DelegateSignature(); // Function EventLeaderboardEntryDetails.EventLeaderboardEntryDetails_C.ProfileSelectedFromSelector__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
