...
struct AGCN_RezIn_C : AFortGameplayCueNotify_BurstLatent {
	...
	void Spawn Drone VFX(); // Function GCN_RezIn.GCN_RezIn_C.Spawn Drone VFX // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Set Timelines' Playrates(); // Function GCN_RezIn.GCN_RezIn_C.Set Timelines' Playrates // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Spawn Teleport In VFX(); // Function GCN_RezIn.GCN_RezIn_C.Spawn Teleport In VFX // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Restore Character Materials(bool& Fully Completed); // Function GCN_RezIn.GCN_RezIn_C.Restore Character Materials // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Clean-Up Teleportation Light(); // Function GCN_RezIn.GCN_RezIn_C.Clean-Up Teleportation Light // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Spawn Teleportation Light(); // Function GCN_RezIn.GCN_RezIn_C.Spawn Teleportation Light // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Spawn Teleportation Drone(); // Function GCN_RezIn.GCN_RezIn_C.Spawn Teleportation Drone // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Stop Looping Audio(); // Function GCN_RezIn.GCN_RezIn_C.Stop Looping Audio // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void TFX_GlowCharacterMesh__FinishedFunc(); // Function GCN_RezIn.GCN_RezIn_C.TFX_GlowCharacterMesh__FinishedFunc // (BlueprintEvent) // @ game+0xda05cc
	void TFX_GlowCharacterMesh__UpdateFunc(); // Function GCN_RezIn.GCN_RezIn_C.TFX_GlowCharacterMesh__UpdateFunc // (BlueprintEvent) // @ game+0xda05cc
	void TFX_ResOutCharacterMesh__FinishedFunc(); // Function GCN_RezIn.GCN_RezIn_C.TFX_ResOutCharacterMesh__FinishedFunc // (BlueprintEvent) // @ game+0xda05cc
	void TFX_ResOutCharacterMesh__UpdateFunc(); // Function GCN_RezIn.GCN_RezIn_C.TFX_ResOutCharacterMesh__UpdateFunc // (BlueprintEvent) // @ game+0xda05cc
	void OnBurstGeneric(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UFXSystemComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents, struct UMatineeCameraShake* BurstCameraShakeInstance, struct ADecalActor* BurstDecalInstance); // Function GCN_RezIn.GCN_RezIn_C.OnBurstGeneric // (Event|Public|HasOutParms|BlueprintEvent|Const) // @ game+0xda05cc
	void Pre-Sequence Change(); // Function GCN_RezIn.GCN_RezIn_C.Pre-Sequence Change // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Set Additional Niagara Parameters on Spawned FX(struct UNiagaraComponent* Spawned Teleport In FX); // Function GCN_RezIn.GCN_RezIn_C.Set Additional Niagara Parameters on Spawned FX // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Set Additional Niagara Parameter on Drone FX(struct UNiagaraComponent* Drone FX); // Function GCN_RezIn.GCN_RezIn_C.Set Additional Niagara Parameter on Drone FX // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnCosmeticPart(struct AFortPlayerPawn* Pawn, struct UCustomCharacterPart* Part, struct USkeletalMeshComponent* MeshPart, enum class EFortCustomPartType PartType); // Function GCN_RezIn.GCN_RezIn_C.OnCosmeticPart // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_GCN_RezIn(int32_t EntryPoint); // Function GCN_RezIn.GCN_RezIn_C.ExecuteUbergraph_GCN_RezIn // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
