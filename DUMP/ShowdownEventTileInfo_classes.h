...
struct UShowdownEventTileInfo_C : UFortShowdownDetailView {
	...
	void RefreshDataBP(); // Function ShowdownEventTileInfo.ShowdownEventTileInfo_C.RefreshDataBP // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void EventAnimFocus(bool In); // Function ShowdownEventTileInfo.ShowdownEventTileInfo_C.EventAnimFocus // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void EventStyleSocket(); // Function ShowdownEventTileInfo.ShowdownEventTileInfo_C.EventStyleSocket // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void EventAnimHover(bool In); // Function ShowdownEventTileInfo.ShowdownEventTileInfo_C.EventAnimHover // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Construct(); // Function ShowdownEventTileInfo.ShowdownEventTileInfo_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void EventColorize(); // Function ShowdownEventTileInfo.ShowdownEventTileInfo_C.EventColorize // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_ShowdownEventTileInfo(int32_t EntryPoint); // Function ShowdownEventTileInfo.ShowdownEventTileInfo_C.ExecuteUbergraph_ShowdownEventTileInfo // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
	void MultiRoundSession__DelegateSignature(); // Function ShowdownEventTileInfo.ShowdownEventTileInfo_C.MultiRoundSession__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void SetDisplayInfo__DelegateSignature(struct FFortTournamentDisplayInfo DisplayInfo); // Function ShowdownEventTileInfo.ShowdownEventTileInfo_C.SetDisplayInfo__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void SetEventState__DelegateSignature(enum class EFortShowdownEventState EventState); // Function ShowdownEventTileInfo.ShowdownEventTileInfo_C.SetEventState__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
