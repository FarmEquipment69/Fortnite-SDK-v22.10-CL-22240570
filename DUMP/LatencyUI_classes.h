...
struct ULatencyWidget : UUserWidget {
	...
	void StopTimer(); // Function LatencyUI.LatencyWidget.StopTimer // (Final|Native|Protected|BlueprintCallable) // @ game+0x7230834
	void StartTimer(); // Function LatencyUI.LatencyWidget.StartTimer // (Final|Native|Protected|BlueprintCallable) // @ game+0x723081c
};
