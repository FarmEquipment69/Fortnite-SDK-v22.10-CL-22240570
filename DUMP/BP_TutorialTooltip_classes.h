...
struct UBP_TutorialTooltip_C : UFortBattlePassTutorialTooltip {
	...
	void PreConstruct(bool IsDesignTime); // Function BP_TutorialTooltip.BP_TutorialTooltip_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ShowTooltip(); // Function BP_TutorialTooltip.BP_TutorialTooltip_C.ShowTooltip // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void HideTooltip(); // Function BP_TutorialTooltip.BP_TutorialTooltip_C.HideTooltip // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_BP_TutorialTooltip(int32_t EntryPoint); // Function BP_TutorialTooltip.BP_TutorialTooltip_C.ExecuteUbergraph_BP_TutorialTooltip // (Final|UbergraphFunction) // @ game+0xda05cc
};
