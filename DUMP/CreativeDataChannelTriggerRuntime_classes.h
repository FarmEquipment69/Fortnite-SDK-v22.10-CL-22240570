...
struct ACreativeDataChannelTarget : AElectraDataChannelTarget {
	...
	void TestCreativeDataChannelTarget(struct FCreativeDataChannelEvents TestEvents); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTarget.TestCreativeDataChannelTarget // (Final|Native|Public|BlueprintCallable) // @ game+0x67e0490
	void OnRep_Events(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTarget.OnRep_Events // (Final|Native|Public) // @ game+0x21ce104
	void FireEvent(struct FName EventName); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTarget.FireEvent // (Event|Public|BlueprintEvent) // @ game+0xda05cc
};
...
struct ACreativeDataChannelTargetRL : AElectraDataChannelTarget {
	...
	void ReportServerStateStreamError(struct FString Error, struct FString UID, struct FString URL); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.ReportServerStateStreamError // (Final|Native|Public|BlueprintCallable) // @ game+0x4c6ba40
	void OnRep_VersionByte(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_VersionByte // (Final|Native|Public) // @ game+0x67e0458
	void OnRep_TeamNames(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_TeamNames // (Final|Native|Public) // @ game+0x67e03dc
	void OnRep_SeriesState(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_SeriesState // (Final|Native|Public) // @ game+0x67e03a4
	void OnRep_ScoreTotal(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_ScoreTotal // (Final|Native|Public) // @ game+0x67e0340
	void OnRep_ScoreTeam(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_ScoreTeam // (Final|Native|Public) // @ game+0x67e032c
	void OnRep_ScoreboardTimeLeft(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_ScoreboardTimeLeft // (Final|Native|Public) // @ game+0x67e0368
	void OnRep_ScoreboardBestOf(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_ScoreboardBestOf // (Final|Native|Public) // @ game+0x67e0354
	void OnRep_PlayerNames(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_PlayerNames // (Final|Native|Public) // @ game+0x67e0318
	void OnRep_PlayerCoords(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_PlayerCoords // (Final|Native|Public) // @ game+0x67e0304
	void OnRep_PlayerBoostCollected(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_PlayerBoostCollected // (Final|Native|Public) // @ game+0x67e02f0
	void OnRep_PlayerBoost(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_PlayerBoost // (Final|Native|Public) // @ game+0x67e02dc
	void OnRep_Overtime(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_Overtime // (Final|Native|Public) // @ game+0x67e02a4
	void OnRep_MediaStop(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_MediaStop // (Final|Native|Public) // @ game+0x67e026c
	void OnRep_MediaStart(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_MediaStart // (Final|Native|Public) // @ game+0x67e0258
	void OnRep_MatchState(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_MatchState // (Final|Native|Public) // @ game+0x67e0220
	void OnRep_FinaleState(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_FinaleState // (Final|Native|Public) // @ game+0x67e01e8
	void OnRep_BallCoords(); // Function CreativeDataChannelTriggerRuntime.CreativeDataChannelTargetRL.OnRep_BallCoords // (Final|Native|Public) // @ game+0x67e01d4
};
