...
struct UVKDebugMessagesBase : UFortHUDElementWidget {
	...
	void HandleGameStateInitialized(struct AFortGameState* GameState); // Function VKEditUI.VKDebugMessagesBase.HandleGameStateInitialized // (Final|Native|Protected) // @ game+0x6c003c0
	void BP_OnGameStateInitialized(struct AFortGameState* GameState); // Function VKEditUI.VKDebugMessagesBase.BP_OnGameStateInitialized // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
