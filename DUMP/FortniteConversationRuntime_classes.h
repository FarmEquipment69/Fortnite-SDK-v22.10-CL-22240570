...
struct UFortConversationContextCondition : UObject {
	...
	bool DoesContextPass(struct FConversationContext& Context); // Function FortniteConversationRuntime.FortConversationContextCondition.DoesContextPass // (Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x6554420
};
...
struct UFortConversationContextConditionHelpers : UBlueprintFunctionLibrary {
	...
	bool GetMessageForContext(struct FFortConversationNodeConditionalMessages& Messages, struct FConversationContext& Context, struct FText& OutText); // Function FortniteConversationRuntime.FortConversationContextConditionHelpers.GetMessageForContext // (Final|Native|Static|Private|HasOutParms|BlueprintCallable) // @ game+0x65547b8
};
...
struct UFortPlayerConversationComponent : UFortConversationParticipantComponent {
	...
	void RequestServerAbortConversation(); // Function FortniteConversationRuntime.FortPlayerConversationComponent.RequestServerAbortConversation // (Net|NetReliableNative|Event|Public|NetServer) // @ game+0x16d64c4
	void HandleWaponEquipped(struct AFortWeapon* NewWeapon, struct AFortWeapon* PrevWeapon); // Function FortniteConversationRuntime.FortPlayerConversationComponent.HandleWaponEquipped // (Final|Native|Private) // @ game+0x6549118
	void HandleViewTargetChanged(); // Function FortniteConversationRuntime.FortPlayerConversationComponent.HandleViewTargetChanged // (Final|Native|Private) // @ game+0x6554ad4
	void HandleFollowedPlayerChanged(struct AFortPlayerControllerSpectating* SpectatingPC, struct AFortPlayerState* FollowedPlayerState); // Function FortniteConversationRuntime.FortPlayerConversationComponent.HandleFollowedPlayerChanged // (Final|Native|Private) // @ game+0x6554a10
	void HandleDBNOChanged(struct AFortPawn* Pawn, bool bIsDBNO); // Function FortniteConversationRuntime.FortPlayerConversationComponent.HandleDBNOChanged // (Final|Native|Private) // @ game+0x655496c
	void ClientSpectatorOpenUI(); // Function FortniteConversationRuntime.FortPlayerConversationComponent.ClientSpectatorOpenUI // (Net|NetReliableNative|Event|Public|NetClient) // @ game+0x6554408
	void ClientSpectatorCloseUI(); // Function FortniteConversationRuntime.FortPlayerConversationComponent.ClientSpectatorCloseUI // (Net|NetReliableNative|Event|Public|NetClient) // @ game+0x65543f0
	void ClientReceiveConversationGiftUINotification(struct FGiftUINotificationInfo ConversationGiftUINotification); // Function FortniteConversationRuntime.FortPlayerConversationComponent.ClientReceiveConversationGiftUINotification // (Net|NetReliableNative|Event|Public|NetClient) // @ game+0x6554338
};
