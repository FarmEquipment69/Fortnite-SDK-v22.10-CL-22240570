...
struct USidebar_C : UFortSocialPanelView_Sidebar {
	...
	void BP_OnActivated(); // Function Sidebar.Sidebar_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_Sidebar(int32_t EntryPoint); // Function Sidebar.Sidebar_C.ExecuteUbergraph_Sidebar // (Final|UbergraphFunction) // @ game+0xda05cc
};
