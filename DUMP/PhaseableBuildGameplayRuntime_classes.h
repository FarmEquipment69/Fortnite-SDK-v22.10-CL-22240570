...
struct UFortPawnComponent_Phasing : UFortPawnComponent {
	...
	void UpdateTargetingBuild(); // Function PhaseableBuildGameplayRuntime.FortPawnComponent_Phasing.UpdateTargetingBuild // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void SetCurrentPhasingBuilding(struct ABuildingSMActor* CurrentPhasingBuilding); // Function PhaseableBuildGameplayRuntime.FortPawnComponent_Phasing.SetCurrentPhasingBuilding // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x4c68520
	void ServerTargetedBuildingSet(struct ABuildingActor* InTargetedBuilding); // Function PhaseableBuildGameplayRuntime.FortPawnComponent_Phasing.ServerTargetedBuildingSet // (Net|NetReliableNative|Event|Public|NetServer) // @ game+0x67a13ec
	void ServerTargetedBuildingHitResultSet(struct FHitResult InTargetedBuildingHitResult); // Function PhaseableBuildGameplayRuntime.FortPawnComponent_Phasing.ServerTargetedBuildingHitResultSet // (Net|NetReliableNative|Event|Public|NetServer) // @ game+0x67a135c
	void OnRep_TargetedBuilding(); // Function PhaseableBuildGameplayRuntime.FortPawnComponent_Phasing.OnRep_TargetedBuilding // (Final|Native|Protected) // @ game+0x26f6338
	void OnRep_PhasingBuildingInfo(); // Function PhaseableBuildGameplayRuntime.FortPawnComponent_Phasing.OnRep_PhasingBuildingInfo // (Final|Native|Protected) // @ game+0x4c684b0
	void OnIsTargetingBuild(bool bIsTargetingBuild); // Function PhaseableBuildGameplayRuntime.FortPawnComponent_Phasing.OnIsTargetingBuild // (Event|Public|BlueprintEvent) // @ game+0xda05cc
};
...
struct UPhaseableBuildComponent : UActorComponent {
	...
	bool TestNoASCCreation(); // Function PhaseableBuildGameplayRuntime.PhaseableBuildComponent.TestNoASCCreation // (Final|Native|Protected|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c685d0
	void OnHitByPawn(struct AFortPlayerPawn* Pawn, struct FHitResult& HitResult); // Function PhaseableBuildGameplayRuntime.PhaseableBuildComponent.OnHitByPawn // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnFullHealthReached(); // Function PhaseableBuildGameplayRuntime.PhaseableBuildComponent.OnFullHealthReached // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void HandleOnDamaged(struct AActor* DamagedActor, float Damage, struct AController* InstigatedBy, struct AActor* DamageCauser, struct FVector HitLocation, struct UPrimitiveComponent* HitComponent, struct FName BoneName, struct FVector Momentum); // Function PhaseableBuildGameplayRuntime.PhaseableBuildComponent.HandleOnDamaged // (Final|Native|Protected|HasDefaults) // @ game+0x4c68190
};
