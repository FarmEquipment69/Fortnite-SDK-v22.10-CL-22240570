...
struct USidebarPartyPortrait_C : UFortJoinablePartyPortrait {
	...
	void PreConstruct(bool IsDesignTime); // Function SidebarPartyPortrait.SidebarPartyPortrait_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_SidebarPartyPortrait(int32_t EntryPoint); // Function SidebarPartyPortrait.SidebarPartyPortrait_C.ExecuteUbergraph_SidebarPartyPortrait // (Final|UbergraphFunction) // @ game+0xda05cc
};
