...
struct UFeaturedCreativeContent_C : UFeaturedCreativeContent {
	...
	void SetFeaturedContentDetails(int32_t Index); // Function FeaturedCreativeContent.FeaturedCreativeContent_C.SetFeaturedContentDetails // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnSetupAds(struct TArray<struct FString>& MediaURLs, struct TArray<struct FCreativeAdData>& AdMetadata); // Function FeaturedCreativeContent.FeaturedCreativeContent_C.OnSetupAds // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	...
	void ExecuteUbergraph_FeaturedCreativeContent(int32_t EntryPoint); // Function FeaturedCreativeContent.FeaturedCreativeContent_C.ExecuteUbergraph_FeaturedCreativeContent // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
