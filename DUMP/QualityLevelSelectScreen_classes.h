...
struct UQualityLevelSelectScreen_C : UFortQualityLevelSelectScreen {
	...
	void Construct(); // Function QualityLevelSelectScreen.QualityLevelSelectScreen_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_QualityLevelSelectScreen(int32_t EntryPoint); // Function QualityLevelSelectScreen.QualityLevelSelectScreen_C.ExecuteUbergraph_QualityLevelSelectScreen // (Final|UbergraphFunction) // @ game+0xda05cc
};
