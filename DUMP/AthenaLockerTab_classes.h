...
struct UAthenaLockerTab_C : UAthenaCustomizationScreenBase {
	...
	void AnimShowRandomDisclaimerEnabled(bool Show); // Function AthenaLockerTab.AthenaLockerTab_C.AnimShowRandomDisclaimerEnabled // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void UpdatePresetButtonStyles(enum class ECommonInputType InputPin); // Function AthenaLockerTab.AthenaLockerTab_C.UpdatePresetButtonStyles // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void PlaySlotAnimationAndCenterSlot(); // Function AthenaLockerTab.AthenaLockerTab_C.PlaySlotAnimationAndCenterSlot // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void PlayEquippedLockerMusic_STW(); // Function AthenaLockerTab.AthenaLockerTab_C.PlayEquippedLockerMusic_STW // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void PlaySlotClickedAnimation(struct UAthenaCustomizationSlotButton_C* SlotToPlayAnimOn); // Function AthenaLockerTab.AthenaLockerTab_C.PlaySlotClickedAnimation // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void BeginPickingCustomization(struct UCommonButtonLegacy* WidgetToReturnFocusTo, struct FAthenaCustomizationParams CustomizationParams); // Function AthenaLockerTab.AthenaLockerTab_C.BeginPickingCustomization // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnBeginPickingCustomizationSlot(struct UAthenaCustomizationSlotSelectorButton* SlotButton); // Function AthenaLockerTab.AthenaLockerTab_C.OnBeginPickingCustomizationSlot // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnBeginSavingLoadouts(); // Function AthenaLockerTab.AthenaLockerTab_C.OnBeginSavingLoadouts // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnBeginPickingLoadouts(); // Function AthenaLockerTab.AthenaLockerTab_C.OnBeginPickingLoadouts // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void Construct(); // Function AthenaLockerTab.AthenaLockerTab_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void OnRefreshForNewLoadout(struct FString LoadoutName, bool bIsShuffleTile); // Function AthenaLockerTab.AthenaLockerTab_C.OnRefreshForNewLoadout // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void BP_OnActivated(); // Function AthenaLockerTab.AthenaLockerTab_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void TriggerRandomLoopingAnim(); // Function AthenaLockerTab.AthenaLockerTab_C.TriggerRandomLoopingAnim // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnPreviewActionButtonUpdated(struct FText& RowDisplayName); // Function AthenaLockerTab.AthenaLockerTab_C.OnPreviewActionButtonUpdated // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void BP_OnDeactivated(); // Function AthenaLockerTab.AthenaLockerTab_C.BP_OnDeactivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	...
	void ExecuteUbergraph_AthenaLockerTab(int32_t EntryPoint); // Function AthenaLockerTab.AthenaLockerTab_C.ExecuteUbergraph_AthenaLockerTab // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
	void OnBackToGameClicked__DelegateSignature(); // Function AthenaLockerTab.AthenaLockerTab_C.OnBackToGameClicked__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
