...
struct USidebarExitPopup_C : UFortSidebarExitPopup {
	...
	void RefreshButtonsVisual(bool IsTouch); // Function SidebarExitPopup.SidebarExitPopup_C.RefreshButtonsVisual // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnInputMethodChanged(enum class ECommonInputType NewInputType); // Function SidebarExitPopup.SidebarExitPopup_C.OnInputMethodChanged // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void UpdateNoEnabledButtonsText(bool bAllowLogout, bool bAllowQuit); // Function SidebarExitPopup.SidebarExitPopup_C.UpdateNoEnabledButtonsText // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void Construct(); // Function SidebarExitPopup.SidebarExitPopup_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_SidebarExitPopup(int32_t EntryPoint); // Function SidebarExitPopup.SidebarExitPopup_C.ExecuteUbergraph_SidebarExitPopup // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
