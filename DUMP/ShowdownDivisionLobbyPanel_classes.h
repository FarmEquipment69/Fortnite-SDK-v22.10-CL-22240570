...
struct UShowdownDivisionLobbyPanel_C : UFortDivisionLobbyPanel {
	...
	void RefreshDivisionData(); // Function ShowdownDivisionLobbyPanel.ShowdownDivisionLobbyPanel_C.RefreshDivisionData // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void InputTypeChanged(bool isGamepad); // Function ShowdownDivisionLobbyPanel.ShowdownDivisionLobbyPanel_C.InputTypeChanged // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void HandleCrossplayChanged(); // Function ShowdownDivisionLobbyPanel.ShowdownDivisionLobbyPanel_C.HandleCrossplayChanged // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void UpdateColors(); // Function ShowdownDivisionLobbyPanel.ShowdownDivisionLobbyPanel_C.UpdateColors // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void Refresh(); // Function ShowdownDivisionLobbyPanel.ShowdownDivisionLobbyPanel_C.Refresh // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void RefreshDataBP(); // Function ShowdownDivisionLobbyPanel.ShowdownDivisionLobbyPanel_C.RefreshDataBP // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void Construct(); // Function ShowdownDivisionLobbyPanel.ShowdownDivisionLobbyPanel_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	...
	void EventColorize(); // Function ShowdownDivisionLobbyPanel.ShowdownDivisionLobbyPanel_C.EventColorize // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void EventSwitchUI(enum class ECommonInputType bNewInputType); // Function ShowdownDivisionLobbyPanel.ShowdownDivisionLobbyPanel_C.EventSwitchUI // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_ShowdownDivisionLobbyPanel(int32_t EntryPoint); // Function ShowdownDivisionLobbyPanel.ShowdownDivisionLobbyPanel_C.ExecuteUbergraph_ShowdownDivisionLobbyPanel // (Final|UbergraphFunction) // @ game+0xda05cc
};
