...
struct UItemSeriesOrRarity_C : UUserWidget {
	...
	void UpdateItemDefinition(struct UFortItemDefinition* ItemDefinition); // Function ItemSeriesOrRarity.ItemSeriesOrRarity_C.UpdateItemDefinition // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
