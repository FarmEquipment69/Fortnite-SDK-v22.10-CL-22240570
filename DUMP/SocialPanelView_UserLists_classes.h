...
struct USocialPanelView_UserLists_C : UFortSocialPanelView_UserLists {
	...
	void OnSetVoiceChannelButtonText(struct FText& ButtonText); // Function SocialPanelView_UserLists.SocialPanelView_UserLists_C.OnSetVoiceChannelButtonText // (Event|Protected|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void Construct(); // Function SocialPanelView_UserLists.SocialPanelView_UserLists_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void PreConstruct(bool IsDesignTime); // Function SocialPanelView_UserLists.SocialPanelView_UserLists_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_SocialPanelView_UserLists(int32_t EntryPoint); // Function SocialPanelView_UserLists.SocialPanelView_UserLists_C.ExecuteUbergraph_SocialPanelView_UserLists // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
