...
struct AEntityFortniteStormSpawner : AActor {
	...
	void Stop(); // Function EntityFortnite.EntityFortniteStormSpawner.Stop // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void Start(float StartRadius, float BoundsRadius, struct TArray<struct FEntityFortniteStormPhase>& Phases); // Function EntityFortnite.EntityFortniteStormSpawner.Start // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void Pause(); // Function EntityFortnite.EntityFortniteStormSpawner.Pause // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	bool Exists(); // Function EntityFortnite.EntityFortniteStormSpawner.Exists // (Event|Public|BlueprintEvent|Const) // @ game+0xda05cc
};
