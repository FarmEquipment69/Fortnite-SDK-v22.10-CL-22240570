...
struct UMannequinAnalyticsComponent : UActorComponent {
	...
	void FireMannequinAnalytics_Interact(struct AFortPlayerController* Controller, enum class ECreativeMannequinAnalyticsInteractType InteractType, struct UFortItemDefinition* Character, struct UFortItemDefinition* BackBling); // Function MannequinRuntime.MannequinAnalyticsComponent.FireMannequinAnalytics_Interact // (Native|Public|BlueprintCallable|Const) // @ game+0x6828c54
};
