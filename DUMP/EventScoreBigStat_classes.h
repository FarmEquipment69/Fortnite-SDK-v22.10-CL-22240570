...
struct UEventScoreBigStat_C : UUserWidget {
	...
	void SetData(struct FText Label, int32_t Value, int32_t ValueContext, struct FText FormatterText, struct FFortTournamentDisplayInfo Tournament Display Info); // Function EventScoreBigStat.EventScoreBigStat_C.SetData // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
