...
struct UAthenaGiftingConfirmationScreen : UCommonActivatableWidget {
	...
	void OnPresentationModeChanged(enum class EGiftingPresentationMode NewMode); // Function GiftingUI.AthenaGiftingConfirmationScreen.OnPresentationModeChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void HandleTokenOfferPurchaseComplete(bool bSuccess, struct TArray<struct FPurchasedItemInfo>& PurchasedItems); // Function GiftingUI.AthenaGiftingConfirmationScreen.HandleTokenOfferPurchaseComplete // (Final|Native|Private|HasOutParms) // @ game+0x6907f10
	void HandleGiftSent(bool bSuccess, struct TArray<struct FString>& IneligibleAccounts, struct TArray<struct FString>& ErrorCodes); // Function GiftingUI.AthenaGiftingConfirmationScreen.HandleGiftSent // (Final|Native|Private|HasOutParms) // @ game+0x6907ba8
	void Dismiss(bool bGiftConfirmed); // Function GiftingUI.AthenaGiftingConfirmationScreen.Dismiss // (Final|Native|Private|BlueprintCallable) // @ game+0x6907b0c
};
...
struct UAthenaGiftingErrorsPanel : UCommonActivatableWidget {
	...
	void UpdateGiftEligibility(bool bStillGiftable); // Function GiftingUI.AthenaGiftingErrorsPanel.UpdateGiftEligibility // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UAthenaGiftingPriceWidget : UCommonUserWidget {
	...
	void SetPresentationMode(enum class EGiftingPricePresentationMode Mode); // Function GiftingUI.AthenaGiftingPriceWidget.SetPresentationMode // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UAthenaGiftingPurchaseButton : UFortHoldableButton {
	struct UAthenaGiftingPriceWidget* Widget_Price; // 0x10b0(0x08)
	struct UCommonTextBlock* Text_Title; // 0x10b8(0x08)
};
...
struct UAthenaGiftingPurchasePanel : UCommonActivatableWidget {
	...
	void PlayIntroAnimation(); // Function GiftingUI.AthenaGiftingPurchasePanel.PlayIntroAnimation // (Event|Public|BlueprintEvent) // @ game+0xda05cc
};
...
struct UAthenaGiftingScreen : UFortItemPreviewScreen {
	...
	void OnShowSearchWarningText(bool bShow); // Function GiftingUI.AthenaGiftingScreen.OnShowSearchWarningText // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnShownItemChanged(); // Function GiftingUI.AthenaGiftingScreen.OnShownItemChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnSetupFilterTabButton(struct UCommonButtonLegacy* Button, enum class EFilterType FilterType); // Function GiftingUI.AthenaGiftingScreen.OnSetupFilterTabButton // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnPresentationModeChanged(enum class EGiftingScreenPresentationMode Mode); // Function GiftingUI.AthenaGiftingScreen.OnPresentationModeChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnPartyListUpdated(bool bEmpty); // Function GiftingUI.AthenaGiftingScreen.OnPartyListUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnFriendSelectionChanged(); // Function GiftingUI.AthenaGiftingScreen.OnFriendSelectionChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnFilterChanged(enum class EFilterType FilterType); // Function GiftingUI.AthenaGiftingScreen.OnFilterChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
// Size: 0x1170 (Inherited: 0x1090)
struct UFortGiftingSocialUserListEntry : USocialListEntryBase {
	char pad_1090[0xb8]; // 0x1090(0xb8)
	struct UFortSocialAvatarIcon* Avatar_MemberIcon; // 0x1148(0x08)
	struct USocialNameTextBlock* Text_SocialName; // 0x1150(0x08)
	struct UCommonRichTextBlock* RichText_EligibilityStatus; // 0x1158(0x08)
	struct UCommonRichTextBlock* RichText_OwnedItems; // 0x1160(0x08)
	struct UAthenaGiftingPriceWidget* Widget_Price; // 0x1168(0x08)

	void SetPresentationMode(enum class ERecipientPresentationMode Mode); // Function GiftingUI.FortGiftingSocialUserListEntry.SetPresentationMode // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnUserItemSet(); // Function GiftingUI.FortGiftingSocialUserListEntry.OnUserItemSet // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnRecipientStatusUpdated(); // Function GiftingUI.FortGiftingSocialUserListEntry.OnRecipientStatusUpdated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void BP_OnTouchSelectionConfirmed(); // Function GiftingUI.FortGiftingSocialUserListEntry.BP_OnTouchSelectionConfirmed // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void BP_OnHighlightedStateChanged(bool bInIsHighlighted, bool bPlayAnimation); // Function GiftingUI.FortGiftingSocialUserListEntry.BP_OnHighlightedStateChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UFortGiftingUserSearchWidget : UCommonUserWidget {
	...
	void OnSearchCommit(bool bSearchStringShort); // Function GiftingUI.FortGiftingUserSearchWidget.OnSearchCommit // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void HandleSearchFriendsTextEntered(struct FText& Text, enum class ETextCommit CommitMethod); // Function GiftingUI.FortGiftingUserSearchWidget.HandleSearchFriendsTextEntered // (Final|Native|Private|HasOutParms) // @ game+0x6907da8
	void HandleSearchFriendsTextChanged(struct FText& Text); // Function GiftingUI.FortGiftingUserSearchWidget.HandleSearchFriendsTextChanged // (Final|Native|Private|HasOutParms) // @ game+0x6907cf4
};
...
struct UFortGiftingWrapOptionListEntry : UCommonButtonLegacy {
	...
	struct UFortGiftBoxItemDefinition* GiftBoxDefinition; // 0x1078(0x08)
	struct UCommonLazyImage* Image_Gift; // 0x1080(0x08)
