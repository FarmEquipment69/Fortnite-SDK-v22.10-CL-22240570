...
struct UBP_BattleStarModal_C : UFortBattlePassPurchaseResourcesWidget {
	...
	void Randomize stars hovering(); // Function BP_BattleStarModal.BP_BattleStarModal_C.Randomize stars hovering // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnPurchaseAmountChanged(int32_t NewAmount, int32_t LevelsLeft); // Function BP_BattleStarModal.BP_BattleStarModal_C.OnPurchaseAmountChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnTotalPriceChanged(int32_t NewPrice); // Function BP_BattleStarModal.BP_BattleStarModal_C.OnTotalPriceChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void BP_OnActivated(); // Function BP_BattleStarModal.BP_BattleStarModal_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnOfferUnavailable(); // Function BP_BattleStarModal.BP_BattleStarModal_C.OnOfferUnavailable // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void Construct(); // Function BP_BattleStarModal.BP_BattleStarModal_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void PreConstruct(bool IsDesignTime); // Function BP_BattleStarModal.BP_BattleStarModal_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void Update Disclaimer(); // Function BP_BattleStarModal.BP_BattleStarModal_C.Update Disclaimer // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void UpdatePageUnlockText(int32_t LevelsPurchase); // Function BP_BattleStarModal.BP_BattleStarModal_C.UpdatePageUnlockText // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnAmountChangeButtonClicked(); // Function BP_BattleStarModal.BP_BattleStarModal_C.OnAmountChangeButtonClicked // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void HoldActionProgress(bool IsHolding); // Function BP_BattleStarModal.BP_BattleStarModal_C.HoldActionProgress // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_BP_BattleStarModal(int32_t EntryPoint); // Function BP_BattleStarModal.BP_BattleStarModal_C.ExecuteUbergraph_BP_BattleStarModal // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
