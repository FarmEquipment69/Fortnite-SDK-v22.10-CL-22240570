...
struct UEventLeaderboardEventDetails_C : UFortShowdownDetailView {
	...
	void RefreshDataBP(); // Function EventLeaderboardEventDetails.EventLeaderboardEventDetails_C.RefreshDataBP // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_EventLeaderboardEventDetails(int32_t EntryPoint); // Function EventLeaderboardEventDetails.EventLeaderboardEventDetails_C.ExecuteUbergraph_EventLeaderboardEventDetails // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
