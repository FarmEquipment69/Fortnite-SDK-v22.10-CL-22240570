...
struct ULiveLinkComponentController : UActorComponent {
	...
	void SetSubjectRepresentation(struct FLiveLinkSubjectRepresentation InSubjectRepresentation); // Function LiveLinkComponents.LiveLinkComponentController.SetSubjectRepresentation // (Final|Native|Public|BlueprintCallable) // @ game+0x6f91514
	struct FLiveLinkSubjectRepresentation GetSubjectRepresentation(); // Function LiveLinkComponents.LiveLinkComponentController.GetSubjectRepresentation // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6f914f8
};
