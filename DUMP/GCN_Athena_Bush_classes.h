...
struct AGCN_Athena_Bush_C : AFortGameplayCueNotify_Loop {
	...
	void OpacityFade__FinishedFunc(); // Function GCN_Athena_Bush.GCN_Athena_Bush_C.OpacityFade__FinishedFunc // (BlueprintEvent) // @ game+0xda05cc
	void OpacityFade__UpdateFunc(); // Function GCN_Athena_Bush.GCN_Athena_Bush_C.OpacityFade__UpdateFunc // (BlueprintEvent) // @ game+0xda05cc
	void On Player Step(); // Function GCN_Athena_Bush.GCN_Athena_Bush_C.On Player Step // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnLoopingStart(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UParticleSystemComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents); // Function GCN_Athena_Bush.GCN_Athena_Bush_C.OnLoopingStart // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void OnRemoval(struct AActor* MyTarget, struct FGameplayCueParameters& Parameters, struct TArray<struct UParticleSystemComponent*>& ParticleComponents, struct TArray<struct UAudioComponent*>& AudioComponents, struct UMatineeCameraShake* BurstCameraShakeInstance, struct ADecalActor* BurstDecalInstance); // Function GCN_Athena_Bush.GCN_Athena_Bush_C.OnRemoval // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void ReceiveTick(float DeltaSeconds); // Function GCN_Athena_Bush.GCN_Athena_Bush_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_GCN_Athena_Bush(int32_t EntryPoint); // Function GCN_Athena_Bush.GCN_Athena_Bush_C.ExecuteUbergraph_GCN_Athena_Bush // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
