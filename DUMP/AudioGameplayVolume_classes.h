...
struct UAudioGameplayVolumeMutator : UAudioGameplayComponent {
	...
	void SetPriority(int32_t InPriority); // Function AudioGameplayVolume.AudioGameplayVolumeMutator.SetPriority // (Final|Native|Public|BlueprintCallable) // @ game+0x70c3cdc
};
...
struct UAttenuationVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetInteriorVolume(float Volume, float InterpolateTime); // Function AudioGameplayVolume.AttenuationVolumeComponent.SetInteriorVolume // (Final|Native|Public|BlueprintCallable) // @ game+0x70c3c08
	void SetExteriorVolume(float Volume, float InterpolateTime); // Function AudioGameplayVolume.AttenuationVolumeComponent.SetExteriorVolume // (Final|Native|Public|BlueprintCallable) // @ game+0x70c3b34
};
...
struct AAudioGameplayVolume : AVolume {
	...
	void SetEnabled(bool bEnable); // Function AudioGameplayVolume.AudioGameplayVolume.SetEnabled // (Final|Native|Public|BlueprintCallable) // @ game+0x70c3a9c
	void OnRep_bEnabled(); // Function AudioGameplayVolume.AudioGameplayVolume.OnRep_bEnabled // (Native|Protected) // @ game+0x679e2b8
	void OnListenerExit(); // Function AudioGameplayVolume.AudioGameplayVolume.OnListenerExit // (Native|Event|Public|BlueprintEvent) // @ game+0x24c3aa0
	void OnListenerEnter(); // Function AudioGameplayVolume.AudioGameplayVolume.OnListenerEnter // (Native|Event|Public|BlueprintEvent) // @ game+0x24c3a78
};
...
struct UFilterVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetInteriorLPF(float Volume, float InterpolateTime); // Function AudioGameplayVolume.FilterVolumeComponent.SetInteriorLPF // (Final|Native|Public|BlueprintCallable) // @ game+0x70c3c08
	void SetExteriorLPF(float Volume, float InterpolateTime); // Function AudioGameplayVolume.FilterVolumeComponent.SetExteriorLPF // (Final|Native|Public|BlueprintCallable) // @ game+0x70c3b34
};
...
struct UReverbVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetReverbSettings(struct FReverbSettings& NewReverbSettings); // Function AudioGameplayVolume.ReverbVolumeComponent.SetReverbSettings // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x70c3d68
};
...
struct USubmixOverrideVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetSubmixOverrideSettings(struct TArray<struct FAudioVolumeSubmixOverrideSettings>& NewSubmixOverrideSettings); // Function AudioGameplayVolume.SubmixOverrideVolumeComponent.SetSubmixOverrideSettings // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x70c3e2c
};
...
struct USubmixSendVolumeComponent : UAudioGameplayVolumeMutator {
	...
	void SetSubmixSendSettings(struct TArray<struct FAudioVolumeSubmixSendSettings>& NewSubmixSendSettings); // Function AudioGameplayVolume.SubmixSendVolumeComponent.SetSubmixSendSettings // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x70c3ed0
};
