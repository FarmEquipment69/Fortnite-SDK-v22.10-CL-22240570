...
struct AB_InteriorAudioManager_C : AFortInteriorAudioManager {
	...
	void OnComponentRemoved(struct UInteriorAudioComponent_C* Component); // Function B_InteriorAudioManager.B_InteriorAudioManager_C.OnComponentRemoved // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnComponentAdded(struct UInteriorAudioComponent_C* Component); // Function B_InteriorAudioManager.B_InteriorAudioManager_C.OnComponentAdded // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void UpdateAmbientAudio(struct FInteriorAudioScanResults& ScanResults); // Function B_InteriorAudioManager.B_InteriorAudioManager_C.UpdateAmbientAudio // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_B_InteriorAudioManager(int32_t EntryPoint); // Function B_InteriorAudioManager.B_InteriorAudioManager_C.ExecuteUbergraph_B_InteriorAudioManager // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
