...
struct UHISMBuilderSettings : UObject {
	...
	void SetOverriddenLightMapRes(int32_t Value); // Function Procedural.HISMBuilderSettings.SetOverriddenLightMapRes // (Final|Native|Public|BlueprintCallable) // @ game+0x720d3b4
	int32_t GetOverriddenLightMapRes(); // Function Procedural.HISMBuilderSettings.GetOverriddenLightMapRes // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x5f8abe4
};
...
struct UProceduralParameterModifier : UObject {
	...
	float GetContribution(); // Function Procedural.ProceduralParameterModifier.GetContribution // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d010
};
...
struct UProceduralGenerationContext : UObject {
	...
	struct AVolume* GetGenerationVolume(); // Function Procedural.ProceduralGenerationContext.GetGenerationVolume // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d118
	struct UProceduralGenerationComponent* GetGenerationComponent(); // Function Procedural.ProceduralGenerationContext.GetGenerationComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d0d0
};
...
struct AProceduralGenerationVolume : AVolume {
	...
	void Generate(); // Function Procedural.ProceduralGenerationVolume.Generate // (Final|Native|Public|BlueprintCallable) // @ game+0x720cfd0
	void ClearGeneratedContent(); // Function Procedural.ProceduralGenerationVolume.ClearGeneratedContent // (Final|Native|Public|BlueprintCallable) // @ game+0x720cf1c
};
...
struct UProceduralGeneratorContext : UObject {
	...
	bool OnGenerate(); // Function Procedural.ProceduralGeneratorContext.OnGenerate // (Native|Event|Public|BlueprintEvent) // @ game+0x27a7ea4
	void OnDrawVisualization(); // Function Procedural.ProceduralGeneratorContext.OnDrawVisualization // (Event|Public|BlueprintEvent|Const) // @ game+0xda05cc
	void OnClearGeneratedContent(); // Function Procedural.ProceduralGeneratorContext.OnClearGeneratedContent // (Native|Event|Public|BlueprintEvent) // @ game+0x132bc44
	void GetOrCreateGeneratorContext(struct UProceduralGenerator* Generator, struct UProceduralGeneratorContext*& Context); // Function Procedural.ProceduralGeneratorContext.GetOrCreateGeneratorContext // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x720d174
	struct TArray<struct UProceduralGeneratorContext*> GetGeneratedContexts(); // Function Procedural.ProceduralGeneratorContext.GetGeneratedContexts // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d030
	bool Generate(); // Function Procedural.ProceduralGeneratorContext.Generate // (Final|Native|Public|BlueprintCallable) // @ game+0x720cfec
	void ClearGeneratedContent(); // Function Procedural.ProceduralGeneratorContext.ClearGeneratedContent // (Final|Native|Public|BlueprintCallable) // @ game+0x720cf4c
};
...
struct UProceduralPointCloud : UObject {
	...
	struct TArray<struct FProceduralPointCloudPoint> GetPointsByTag(struct FName InTag); // Function Procedural.ProceduralPointCloud.GetPointsByTag // (Final|Native|Public|BlueprintCallable) // @ game+0x720d244
	void Empty(); // Function Procedural.ProceduralPointCloud.Empty // (Final|Native|Public|BlueprintCallable) // @ game+0x720cf60
};
...
struct UProceduralRotationMapModifier : UProceduralRotationModifier {
	...
	void SetYawMin(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetYawMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720d82c
	void SetYawMax(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetYawMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720d79c
	void SetRollMin(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetRollMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720d94c
	void SetRollMax(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetRollMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720d8bc
	void SetPitchMin(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetPitchMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720d4cc
	void SetPitchMax(float InValue); // Function Procedural.ProceduralRotationMapModifier.SetPitchMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720d43c
	float GetYawMin(); // Function Procedural.ProceduralRotationMapModifier.GetYawMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d38c
	float GetYawMax(); // Function Procedural.ProceduralRotationMapModifier.GetYawMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d378
	float GetRollMin(); // Function Procedural.ProceduralRotationMapModifier.GetRollMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d3a0
	float GetRollMax(); // Function Procedural.ProceduralRotationMapModifier.GetRollMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x278edf0
	float GetPitchMin(); // Function Procedural.ProceduralRotationMapModifier.GetPitchMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x278eddc
	float GetPitchMax(); // Function Procedural.ProceduralRotationMapModifier.GetPitchMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x23ceae8
};
...
struct UProceduralRotationNoiseModifier : UProceduralRotationModifier {
	...
	void SetRandomYawMin(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomYawMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720d82c
	void SetRandomYawMax(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomYawMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720d79c
	void SetRandomRollMin(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomRollMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720d70c
	void SetRandomRollMax(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomRollMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720d67c
	void SetRandomPitchMin(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomPitchMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720d5ec
	void SetRandomPitchMax(float InValue); // Function Procedural.ProceduralRotationNoiseModifier.SetRandomPitchMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720d55c
	float GetRandomYawMin(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomYawMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d38c
	float GetRandomYawMax(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomYawMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d378
	float GetRandomRollMin(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomRollMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x23f6eb8
	float GetRandomRollMax(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomRollMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d364
	float GetRandomPitchMin(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomPitchMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x278edf0
	float GetRandomPitchMax(); // Function Procedural.ProceduralRotationNoiseModifier.GetRandomPitchMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x278eddc
};
...
struct UProceduralScaleMapModifier : UProceduralScaleModifier {
	...
	void SetRemapScaleMin(float InValue); // Function Procedural.ProceduralScaleMapModifier.SetRemapScaleMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720d70c
	void SetRemapScaleMax(float InValue); // Function Procedural.ProceduralScaleMapModifier.SetRemapScaleMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720d67c
	float GetRemapScaleMin(); // Function Procedural.ProceduralScaleMapModifier.GetRemapScaleMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x23f6eb8
	float GetRemapScaleMax(); // Function Procedural.ProceduralScaleMapModifier.GetRemapScaleMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720d364
};
...
struct UProceduralScaleNoiseModifier : UProceduralScaleModifier {
	...
	void SetScaleMin(float InValue); // Function Procedural.ProceduralScaleNoiseModifier.SetScaleMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720e178
	void SetScaleMax(float InValue); // Function Procedural.ProceduralScaleNoiseModifier.SetScaleMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720e0e8
	float GetScaleMin(); // Function Procedural.ProceduralScaleNoiseModifier.GetScaleMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x5f8abe4
	float GetScaleMax(); // Function Procedural.ProceduralScaleNoiseModifier.GetScaleMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x23f6eb8
};
...
struct UProceduralScatterSettings : UObject {
	...
	void SetSourcePointDistanceMin(float InValue); // Function Procedural.ProceduralScatterSettings.SetSourcePointDistanceMin // (Final|Native|Public|BlueprintCallable) // @ game+0x720e2a0
	void SetSourcePointDistanceMax(float InValue); // Function Procedural.ProceduralScatterSettings.SetSourcePointDistanceMax // (Final|Native|Public|BlueprintCallable) // @ game+0x720e208
	float GetSourcePointDistanceMin(); // Function Procedural.ProceduralScatterSettings.GetSourcePointDistanceMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720e0d0
	float GetSourcePointDistanceMax(); // Function Procedural.ProceduralScatterSettings.GetSourcePointDistanceMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x720e0b8
};
...
struct UProceduralSurfaceHeightMap : UProceduralFloatDataMap {
	...
	void SetHeightRangeMin(float InValue); // Function Procedural.ProceduralSurfaceHeightMap.SetHeightRangeMin // (Final|Native|Public|BlueprintCallable) // @ game+0x722ed28
	void SetHeightRangeMax(float InValue); // Function Procedural.ProceduralSurfaceHeightMap.SetHeightRangeMax // (Final|Native|Public|BlueprintCallable) // @ game+0x722ec90
	float GetValue(float InHeight); // Function Procedural.ProceduralSurfaceHeightMap.GetValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x722ebfc
	float GetHeightRangeMin(); // Function Procedural.ProceduralSurfaceHeightMap.GetHeightRangeMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6473574
	float GetHeightRangeMax(); // Function Procedural.ProceduralSurfaceHeightMap.GetHeightRangeMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x643c224
};
...
struct UProceduralSurfaceSlopeAngleMap : UProceduralFloatDataMap {
	...
	void SetSlopeAngleRangeMin(float InValue); // Function Procedural.ProceduralSurfaceSlopeAngleMap.SetSlopeAngleRangeMin // (Final|Native|Public|BlueprintCallable) // @ game+0x722ed28
	void SetSlopeAngleRangeMax(float InValue); // Function Procedural.ProceduralSurfaceSlopeAngleMap.SetSlopeAngleRangeMax // (Final|Native|Public|BlueprintCallable) // @ game+0x722ec90
	float GetValue(float InSlopeAngle); // Function Procedural.ProceduralSurfaceSlopeAngleMap.GetValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x722ebfc
	float GetSlopeAngleRangeMin(); // Function Procedural.ProceduralSurfaceSlopeAngleMap.GetSlopeAngleRangeMin // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6473574
	float GetSlopeAngleRangeMax(); // Function Procedural.ProceduralSurfaceSlopeAngleMap.GetSlopeAngleRangeMax // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x643c224
};
