...
struct UVerseFortniteHUDWidgetBase : UFortHUDElementWidget {
	...
	void OnUpdateVisibleState(bool bEnabled); // Function VerseFortniteFrameworkUI.VerseFortniteHUDWidgetBase.OnUpdateVisibleState // (Event|Public|BlueprintEvent) // @ game+0xda05cc
};
...
struct UHUDCountDownWidget : UVerseFortniteHUDWidgetBase {
	...
	void OnStartCountDown(float SecondsRemaining, int32_t CurrentRound); // Function VerseFortniteFrameworkUI.HUDCountDownWidget.OnStartCountDown // (Event|Public|BlueprintEvent) // @ game+0xda05cc
};
...
struct UVerseFortniteActivatableWidgetBase : UCommonActivatableWidget {
	...
	void OnEnabledChanged(bool bEnabled); // Function VerseFortniteFrameworkUI.VerseFortniteActivatableWidgetBase.OnEnabledChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
};
...
struct UHUDGameOverWidgetBase : UVerseFortniteActivatableWidgetBase {
	...
	void HandleGameOverStateChanged(struct UHUDGameOverComponentBase* GameOverComponent); // Function VerseFortniteFrameworkUI.HUDGameOverWidgetBase.HandleGameOverStateChanged // (Final|Native|Private) // @ game+0x63a35d8
	enum class EGameOverMessageType GetGameOverType(); // Function VerseFortniteFrameworkUI.HUDGameOverWidgetBase.GetGameOverType // (Final|Native|Public|BlueprintCallable|BlueprintPure) // @ game+0x63a35c0
};
...
struct UHUDScoreboardWidgetBase : UVerseFortniteHUDWidgetBase {
	...
	void OnUpdateScores(); // Function VerseFortniteFrameworkUI.HUDScoreboardWidgetBase.OnUpdateScores // (Final|Native|Protected) // @ game+0x63a3718
	void OnUpdateRounds(uint32_t CurrentRound, uint32_t NumberOfRounds); // Function VerseFortniteFrameworkUI.HUDScoreboardWidgetBase.OnUpdateRounds // (Final|Native|Protected) // @ game+0x63a3658
};
...
struct UHUDSimpleMessageWidget : UVerseFortniteHUDWidgetBase {
	...
	void OnUpdateMessage(struct FString NewMessage); // Function VerseFortniteFrameworkUI.HUDSimpleMessageWidget.OnUpdateMessage // (Event|Public|BlueprintEvent) // @ game+0xda05cc
};
...
struct UVerseFortniteButton : UCommonButtonBase {
	struct FName ButtonActionName; // 0x1020(0x04)
