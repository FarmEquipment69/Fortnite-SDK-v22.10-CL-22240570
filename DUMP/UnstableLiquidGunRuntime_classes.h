...
struct AFortLiquidGunProjectile : AFortProjectileBase {
	struct UMeshComponent* AttachMeshComponent; // 0xa20(0x08)
	...
	bool SplineCollisionTest(struct FHitResult& OutHit); // Function UnstableLiquidGunRuntime.FortLiquidGunProjectile.SplineCollisionTest // (Final|Native|Protected|HasOutParms|BlueprintCallable) // @ game+0x4c72920
	void SetDetachmentReason(enum class ELiquidRibbonDetachmentReason InDetachmentReason); // Function UnstableLiquidGunRuntime.FortLiquidGunProjectile.SetDetachmentReason // (Final|Native|Public|BlueprintCallable) // @ game+0x4c72880
	enum class ELiquidRibbonDetachmentReason GetDetachmentReason(); // Function UnstableLiquidGunRuntime.FortLiquidGunProjectile.GetDetachmentReason // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c72860
};
...
struct ALiquidRibbonManager : AActor {
	...
	void SetNiagaraData(struct UNiagaraComponent* NiagaraComponent, struct TArray<struct FVector>& Positions, struct TArray<int32_t>& RibbonIDs, struct TArray<bool>& RibbonVisibilities, struct TArray<float>& FlashIntensities, struct TArray<int32_t>& RibbonSizes); // Function UnstableLiquidGunRuntime.LiquidRibbonManager.SetNiagaraData // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x68ed25c
	struct FVector GetPointOnSegment(float T, struct FLiquidRibbonSplineSegment& Segment); // Function UnstableLiquidGunRuntime.LiquidRibbonManager.GetPointOnSegment // (Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const) // @ game+0x68ed12c
	struct FLiquidRibbonSplineDetachment GetOrAddDetachment(int32_t RibbonID, struct FLiquidRibbonSplineSegment& Segment); // Function UnstableLiquidGunRuntime.LiquidRibbonManager.GetOrAddDetachment // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x68ed00c
	int32_t GetFirstVisiblePointIndex(); // Function UnstableLiquidGunRuntime.LiquidRibbonManager.GetFirstVisiblePointIndex // (Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x68ecfe4
	void CalculateSplinePointsAndSetNiagaraData(struct TArray<struct AFortLiquidGunProjectile*>& Projectiles, bool bAttachSplineToMuzzle, struct UNiagaraComponent* NiagaraComponent, struct TArray<struct FVector>& OutAllPositions, struct TArray<int32_t>& OutRibbonIDs, struct TArray<bool>& OutRibbonVisibilities, struct TArray<float>& OutFlashIntensities, struct TArray<int32_t>& OutRibbonSizes); // Function UnstableLiquidGunRuntime.LiquidRibbonManager.CalculateSplinePointsAndSetNiagaraData // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x68ecc64
	struct TArray<struct FLiquidRibbonSplineSegment> CalculateSegments(struct TArray<struct FVector>& Points, float Tension); // Function UnstableLiquidGunRuntime.LiquidRibbonManager.CalculateSegments // (Final|Native|Public|HasOutParms|BlueprintCallable) // @ game+0x68ecb54
	float CalculatePointSize(int32_t SegmentIndex, int32_t PointIndex); // Function UnstableLiquidGunRuntime.LiquidRibbonManager.CalculatePointSize // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x68eca64
	float CalculatePointFlashIntensity(int32_t PointSize); // Function UnstableLiquidGunRuntime.LiquidRibbonManager.CalculatePointFlashIntensity // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x68ec9bc
};
