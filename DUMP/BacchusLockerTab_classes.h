...
struct UBacchusLockerTab_C : UAthenaCustomizationScreenBase {
	...
	void AnimShowRandomDisclaimerEnabled(bool Show); // Function BacchusLockerTab.BacchusLockerTab_C.AnimShowRandomDisclaimerEnabled // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void UpdatePresetButtonStyles(enum class ECommonInputType InputPin); // Function BacchusLockerTab.BacchusLockerTab_C.UpdatePresetButtonStyles // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void PlaySlotAnimationAndCenterSlot(); // Function BacchusLockerTab.BacchusLockerTab_C.PlaySlotAnimationAndCenterSlot // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void PlayEquippedLockerMusic_STW(); // Function BacchusLockerTab.BacchusLockerTab_C.PlayEquippedLockerMusic_STW // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void PlaySlotClickedAnimation(struct UAthenaCustomizationSlotButton_C* SlotToPlayAnimOn); // Function BacchusLockerTab.BacchusLockerTab_C.PlaySlotClickedAnimation // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void BeginPickingCustomization(struct UCommonButtonLegacy* WidgetToReturnFocusTo, struct FAthenaCustomizationParams CustomizationParams); // Function BacchusLockerTab.BacchusLockerTab_C.BeginPickingCustomization // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnBeginPickingCustomizationSlot(struct UAthenaCustomizationSlotSelectorButton* SlotButton); // Function BacchusLockerTab.BacchusLockerTab_C.OnBeginPickingCustomizationSlot // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnBeginSavingLoadouts(); // Function BacchusLockerTab.BacchusLockerTab_C.OnBeginSavingLoadouts // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnBeginPickingLoadouts(); // Function BacchusLockerTab.BacchusLockerTab_C.OnBeginPickingLoadouts // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void Construct(); // Function BacchusLockerTab.BacchusLockerTab_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xda05cc
	void (enum class ECommonInputType bNewInputType); // Function BacchusLockerTab.BacchusLockerTab_C. // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void BP_OnDeactivated(); // Function BacchusLockerTab.BacchusLockerTab_C.BP_OnDeactivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void OnRefreshForNewLoadout(struct FString LoadoutName, bool bIsShuffleTile); // Function BacchusLockerTab.BacchusLockerTab_C.OnRefreshForNewLoadout // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void BP_OnActivated(); // Function BacchusLockerTab.BacchusLockerTab_C.BP_OnActivated // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void TriggerRandomLoopingAnim(); // Function BacchusLockerTab.BacchusLockerTab_C.TriggerRandomLoopingAnim // (BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_BacchusLockerTab(int32_t EntryPoint); // Function BacchusLockerTab.BacchusLockerTab_C.ExecuteUbergraph_BacchusLockerTab // (Final|UbergraphFunction|HasDefaults) // @ game+0xda05cc
};
