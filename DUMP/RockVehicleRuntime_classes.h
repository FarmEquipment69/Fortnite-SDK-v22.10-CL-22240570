...
struct UFortCheatManager_RockVehicle : UChildCheatManager {
	...
	void RockVehicleSetVelocity(float X, float Y, float Z); // Function RockVehicleRuntime.FortCheatManager_RockVehicle.RockVehicleSetVelocity // (Final|Exec|Native|Public) // @ game+0x4c8bd60
	void RockVehicleSetRotation(float Pitch, float Yaw, float Roll); // Function RockVehicleRuntime.FortCheatManager_RockVehicle.RockVehicleSetRotation // (Final|Exec|Native|Public) // @ game+0x4c8bd60
	void RockVehicleSetLocation(float X, float Y, float Z); // Function RockVehicleRuntime.FortCheatManager_RockVehicle.RockVehicleSetLocation // (Final|Exec|Native|Public) // @ game+0x4c8bd60
	void RockVehicleSetBalboaVelocity(float X, float Y, float Z); // Function RockVehicleRuntime.FortCheatManager_RockVehicle.RockVehicleSetBalboaVelocity // (Final|Exec|Native|Public) // @ game+0x4c8bd60
};

// Class RockVehicleRuntime.RockVehicle
// Size: 0x1b90 (Inherited: 0x1990)
struct ARockVehicle : AFortAthenaSKVehicle {
	float InputSwivelPitch; // 0x1990(0x04)
	float InputSwivelYaw; // 0x1994(0x04)
	char bInputReverseCamera : 1; // 0x1998(0x01)
	char bHasDoubleJumped : 1; // 0x1998(0x01)
	char bHasDodged : 1; // 0x1998(0x01)
	char pad_1998_3 : 5; // 0x1998(0x01)
	bool bFreeLookCamera; // 0x1999(0x01)
	char pad_199A[0x6]; // 0x199a(0x06)
	struct FMulticastInlineDelegate OnFreeCamToggled; // 0x19a0(0x10)
	bool bPitchSafetyActive; // 0x19b0(0x01)
	struct FRockRuntimeConfigOverrides RockRuntimeConfigs; // 0x19b1(0x04)
	char pad_19B5[0x3]; // 0x19b5(0x03)
	struct FMulticastInlineDelegate OnSpringImpact; // 0x19b8(0x10)
	char pad_19C8[0x58]; // 0x19c8(0x58)
	struct TArray<struct URockVehicleAbility*> VehicleAbilities; // 0x1a20(0x10)
	struct TArray<struct TSoftClassPtr<UObject>> VehicleAbilityTickOrder; // 0x1a30(0x10)
	struct AFortVehicleAudioController* CachedVehicleAudioController; // 0x1a40(0x08)
	struct URockVehicleAbility_Supersonic* SupersonicAbility; // 0x1a48(0x08)
	struct URockVehicleAnimInstance* RockAnimInstance; // 0x1a50(0x08)
	struct FFortAthenaVehicleInputState PendingDriverInputState; // 0x1a58(0x40)
	struct FFortAthenaVehicleInputState PrevDriverInputState; // 0x1a98(0x40)
	struct FVector EnterExitImpulse; // 0x1ad8(0x18)
	char pad_1AF0[0xa0]; // 0x1af0(0xa0)

	void ServerSetLegacyDamageValues(bool bDamageFriendlyVehicles, bool bDamageOtherVehicles, bool bDamageOwnVehicle, bool bDamageAllowedFromOtherVehicle); // Function RockVehicleRuntime.RockVehicle.ServerSetLegacyDamageValues // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x4c8be90
	void RockFreeCamToggledDelegate__DelegateSignature(bool bFreeCam); // DelegateFunction RockVehicleRuntime.RockVehicle.RockFreeCamToggledDelegate__DelegateSignature // (MulticastDelegate|Public|Delegate) // @ game+0xda05cc
	void OnSpringImpact__DelegateSignature(struct FName Socket, float ImpactSpeed, struct FHitResult& OutHit); // DelegateFunction RockVehicleRuntime.RockVehicle.OnSpringImpact__DelegateSignature // (MulticastDelegate|Public|Delegate|HasOutParms) // @ game+0xda05cc
	float GetThrottleState(); // Function RockVehicleRuntime.RockVehicle.GetThrottleState // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8ba50
	struct FFortAthenaVehicleInputState GetDriverInput(); // Function RockVehicleRuntime.RockVehicle.GetDriverInput // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8b970
	struct FRockRuntimeConfigOverrides GetCurrentRockRuntimeConfigOverrides(); // Function RockVehicleRuntime.RockVehicle.GetCurrentRockRuntimeConfigOverrides // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8b950
};
...
struct URockVehicleAbility : UActorComponent {
	...
	struct ARockVehicle* GetVehicle(); // Function RockVehicleRuntime.RockVehicleAbility.GetVehicle // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8ba90
	float GetInactiveSeconds(); // Function RockVehicleRuntime.RockVehicleAbility.GetInactiveSeconds // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8b9d0
	float GetActiveSeconds(); // Function RockVehicleRuntime.RockVehicleAbility.GetActiveSeconds // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8b930
};
...
struct URockVehicleBoostTank : UActorComponent {
	...
	void OnRep_SecondsRemaining(float PrevValue); // Function RockVehicleRuntime.RockVehicleBoostTank.OnRep_SecondsRemaining // (Final|Native|Protected) // @ game+0x4c8bbc0
	bool IsBoostFull(); // Function RockVehicleRuntime.RockVehicleBoostTank.IsBoostFull // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8bb80
	bool HasBoost(); // Function RockVehicleRuntime.RockVehicleBoostTank.HasBoost // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8bb50
	void GiveBoost(float Seconds); // Function RockVehicleRuntime.RockVehicleBoostTank.GiveBoost // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x4c8bab0
	float GetPercentRemaining(); // Function RockVehicleRuntime.RockVehicleBoostTank.GetPercentRemaining // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8ba20
	float GetMaxBoostInSeconds(); // Function RockVehicleRuntime.RockVehicleBoostTank.GetMaxBoostInSeconds // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4c8ba00
};
...
struct URockVehicleAbility_GroundTrails : URockVehicleAbility {
	...
	void OnSurfaceChanged(enum class EPhysicalSurface NewSurface); // Function RockVehicleRuntime.RockVehicleAbility_GroundTrails.OnSurfaceChanged // (Final|Native|Protected|BlueprintCallable) // @ game+0x4c8bc70
};
...
struct ARockVehicleAudioController : AFortVehicleAudioController {
	...
	void SetSurfaceTypeParam(float NewSurfaceParam); // Function RockVehicleRuntime.RockVehicleAudioController.SetSurfaceTypeParam // (Final|Native|Public|BlueprintCallable) // @ game+0x4ca09b0
	void SetBoosting(bool bNewBoosting); // Function RockVehicleRuntime.RockVehicleAudioController.SetBoosting // (Final|Native|Public|BlueprintCallable) // @ game+0x4ca0910
	void OnInAirUpdated(bool bNewInAir); // Function RockVehicleRuntime.RockVehicleAudioController.OnInAirUpdated // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	struct UAudioMotorModelComponent* GetMotorSimComponent(); // Function RockVehicleRuntime.RockVehicleAudioController.GetMotorSimComponent // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x4ca08f0
};
...
// Size: 0xc98 (Inherited: 0x798)
struct URockVehicleConfigs : UFortPhysicsVehicleConfigs {
	struct FRockVehicleAxleConfig FrontAxle; // 0x798(0x34)
	struct FRockVehicleAxleConfig BackAxle; // 0x7cc(0x34)
	struct FRockVehicleDriveConfig Drive; // 0x800(0x460)
	struct FRockVehicleDemoConfig DemolitionConfiguration; // 0xc60(0x28)
	float MaxLinearSpeed; // 0xc88(0x04)
	float SupersonicSpeed; // 0xc8c(0x04)
	float MaxAngularSpeed; // 0xc90(0x04)
...
struct UStreamingRadioPlayerComponent_Rock : UStreamingRadioPlayerComponent {
	...
	void VehicleExploded(struct AController* LastDamageInstigator, struct AFortAthenaVehicle* Vehicle); // Function RockVehicleRuntime.StreamingRadioPlayerComponent_Rock.VehicleExploded // (Final|Native|Protected) // @ game+0x4ca0a50
};
