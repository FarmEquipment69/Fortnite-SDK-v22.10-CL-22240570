...
struct UCustomizableObjectPopulation : UObject {
	...
	bool RegeneratePopulation(int32_t Seed, struct TArray<struct UCustomizableObjectInstance*>& OutInstances, int32_t NumInstancesToGenerate); // Function CustomizableObjectPopulation.CustomizableObjectPopulation.RegeneratePopulation // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x7319078
	int32_t GeneratePopulation(struct TArray<struct UCustomizableObjectInstance*>& OutInstances, int32_t NumInstancesToGenerate); // Function CustomizableObjectPopulation.CustomizableObjectPopulation.GeneratePopulation // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x7318ebc
};
