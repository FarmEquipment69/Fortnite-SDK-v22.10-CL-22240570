...
struct UMANG_PatrolLayerAnimBP_C : UFortPatrolAnimLayer {
	...
	void CharacterSkeletalControlPostLegIK(struct FPoseLink InPosePostLegIK, struct FPoseLink& CharacterSkeletalControlPostLegIK); // Function MANG_PatrolLayerAnimBP.MANG_PatrolLayerAnimBP_C.CharacterSkeletalControlPostLegIK // (HasOutParms|BlueprintCallable) // @ game+0xda05cc
	void FullBodyOverride(struct FPoseLink PassThroughFullBodyPose, struct FPoseLink& FullBodyOverride); // Function MANG_PatrolLayerAnimBP.MANG_PatrolLayerAnimBP_C.FullBodyOverride // (HasOutParms|BlueprintCallable) // @ game+0xda05cc
	void AnimGraph(struct FPoseLink& AnimGraph); // Function MANG_PatrolLayerAnimBP.MANG_PatrolLayerAnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_MANG_PatrolLayerAnimBP(int32_t EntryPoint); // Function MANG_PatrolLayerAnimBP.MANG_PatrolLayerAnimBP_C.ExecuteUbergraph_MANG_PatrolLayerAnimBP // (Final|UbergraphFunction) // @ game+0xda05cc
};
