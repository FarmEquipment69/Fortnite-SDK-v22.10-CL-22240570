...
struct UAnimNotifyState_TriggerAnimInputEvent_C : UAnimNotifyState {
	...
	struct FString GetNotifyName(); // Function AnimNotifyState_TriggerAnimInputEvent.AnimNotifyState_TriggerAnimInputEvent_C.GetNotifyName // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // @ game+0xda05cc
	bool Received_NotifyEnd(struct USkeletalMeshComponent* MeshComp, struct UAnimSequenceBase* Animation, struct FAnimNotifyEventReference& EventReference); // Function AnimNotifyState_TriggerAnimInputEvent.AnimNotifyState_TriggerAnimInputEvent_C.Received_NotifyEnd // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // @ game+0xda05cc
	bool Received_NotifyBegin(struct USkeletalMeshComponent* MeshComp, struct UAnimSequenceBase* Animation, float TotalDuration, struct FAnimNotifyEventReference& EventReference); // Function AnimNotifyState_TriggerAnimInputEvent.AnimNotifyState_TriggerAnimInputEvent_C.Received_NotifyBegin // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // @ game+0xda05cc
};
