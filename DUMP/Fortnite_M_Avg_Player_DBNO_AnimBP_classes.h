...
struct UFortnite_M_Avg_Player_DBNO_AnimBP_C : UFortDBNOAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function Fortnite_M_Avg_Player_DBNO_AnimBP.Fortnite_M_Avg_Player_DBNO_AnimBP_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	...
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function Fortnite_M_Avg_Player_DBNO_AnimBP.Fortnite_M_Avg_Player_DBNO_AnimBP_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_Fortnite_M_Avg_Player_DBNO_AnimBP(int32_t EntryPoint); // Function Fortnite_M_Avg_Player_DBNO_AnimBP.Fortnite_M_Avg_Player_DBNO_AnimBP_C.ExecuteUbergraph_Fortnite_M_Avg_Player_DBNO_AnimBP // (Final|UbergraphFunction) // @ game+0xda05cc
};
