...
struct UFortMediaSubtitlesPlayer : UObject {
	...
	void Stop(); // Function SubtitlesWidgets.FortMediaSubtitlesPlayer.Stop // (Final|Native|Public|BlueprintCallable) // @ game+0x6927da8
	void SetSubtitles(struct UOverlays* Subtitles); // Function SubtitlesWidgets.FortMediaSubtitlesPlayer.SetSubtitles // (Final|Native|Public|BlueprintCallable) // @ game+0x6927d2c
	void Play(); // Function SubtitlesWidgets.FortMediaSubtitlesPlayer.Play // (Final|Native|Public|BlueprintCallable) // @ game+0x6927d18
	void BindToMediaPlayer(struct UMediaPlayer* InMediaPlayer); // Function SubtitlesWidgets.FortMediaSubtitlesPlayer.BindToMediaPlayer // (Final|Native|Public|BlueprintCallable) // @ game+0x6927be0
};
...
struct USubtitleDisplay : UWidget {
	...
	bool HasSubtitles(); // Function SubtitlesWidgets.SubtitleDisplay.HasSubtitles // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x6927cd8
};
