...
struct ULoadoutSaveConfirmation_C : UFortLoadoutSaveConfirmation {
	...
	void Toggle Save as New Visibility(bool CanSaveAsNew); // Function LoadoutSaveConfirmation.LoadoutSaveConfirmation_C.Toggle Save as New Visibility // (Public|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnCanSaveAsNew(bool bCanSaveAsNew); // Function LoadoutSaveConfirmation.LoadoutSaveConfirmation_C.OnCanSaveAsNew // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	void ExecuteUbergraph_LoadoutSaveConfirmation(int32_t EntryPoint); // Function LoadoutSaveConfirmation.LoadoutSaveConfirmation_C.ExecuteUbergraph_LoadoutSaveConfirmation // (Final|UbergraphFunction) // @ game+0xda05cc
};
