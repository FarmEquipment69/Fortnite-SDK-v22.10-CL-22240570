...
struct URejoinWindow_C : UFortRejoinWindowBase {
	...
	void OnRequestRejoinRetry__DelegateSignature(); // Function RejoinWindow.RejoinWindow_C.OnRequestRejoinRetry__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
	void OnRequestAbandon__DelegateSignature(); // Function RejoinWindow.RejoinWindow_C.OnRequestAbandon__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0xda05cc
};
