...
struct USidewaysCheatManager : UChildCheatManager {
	...
	void SetSidewaysState(enum class ESidewaysState SidewaysState); // Function SidewaysCodeRuntime.SidewaysCheatManager.SetSidewaysState // (Final|BlueprintAuthorityOnly|Exec|Native|Public) // @ game+0x6759234
};
...
struct USidewaysLibrary : UBlueprintFunctionLibrary {
	...
	struct USidewaysStateComponent* GetSidewaysStateComponent(struct AActor* Owner); // Function SidewaysCodeRuntime.SidewaysLibrary.GetSidewaysStateComponent // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x67590c4
};
...
struct ASidewaysPlayspace : AFortPlayspace {
	...
	void RefreshActorsInSideways(); // Function SidewaysCodeRuntime.SidewaysPlayspace.RefreshActorsInSideways // (Final|Native|Public|BlueprintCallable) // @ game+0x67591d8
	void NotifySizeChanged(); // Function SidewaysCodeRuntime.SidewaysPlayspace.NotifySizeChanged // (Final|Native|Public|BlueprintCallable) // @ game+0x6759144
};
...
struct USidewaysStateComponent : UGameFrameworkComponent {
	...
	void SetSidewaysState(enum class ESidewaysState NewState, struct ASidewaysPlayspace* NewSidewaysPlayspace); // Function SidewaysCodeRuntime.SidewaysStateComponent.SetSidewaysState // (Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable) // @ game+0x6759298
	void OnRep_SidewaysState(enum class ESidewaysState LastSidewaysState); // Function SidewaysCodeRuntime.SidewaysStateComponent.OnRep_SidewaysState // (Final|Native|Protected) // @ game+0x6759158
	void OnRep_SidewaysPlayspace(struct ASidewaysPlayspace* NewSidewaysPlayspace); // Function SidewaysCodeRuntime.SidewaysStateComponent.OnRep_SidewaysPlayspace // (Final|Native|Protected) // @ game+0x63cc0dc
	void HandleSidewaysStateChanged(struct ASidewaysPlayspace* NewSidewaysPlayspace, enum class ESidewaysState OldState, enum class ESidewaysState NewState); // Function SidewaysCodeRuntime.SidewaysStateComponent.HandleSidewaysStateChanged // (Event|Protected|BlueprintEvent) // @ game+0xda05cc
	enum class ESidewaysState GetSidewaysState(); // Function SidewaysCodeRuntime.SidewaysStateComponent.GetSidewaysState // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x1fab678
};
